...
<Steps>
  ...
  <Step title="Enable Token Exchange Grant">
    Enable the Token Exchange Grant for your Auth0 Application. Go to **Applications > [YourApplication] > Settings > Advanced > Grant Types** and enable the **Token Exchange** grant type.
  </Step>
  ...
  <Step title="Configure Google Social Connection">
    ...
    <Frame>
      <img src="/ai/docs/img/social-connection.png" alt="Social Connection" width="700" />
    </Frame>
