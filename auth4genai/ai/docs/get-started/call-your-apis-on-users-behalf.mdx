...
<Steps>
  ...
  <Step title="Create Application">
   ...
   <Step title="Complete User Authentication quickstart">
    To complete this quickstart, you need to use the same application you built in the [User authentication](/ai/docs/get-started/user-authentication) quickstart.
  </Step>
