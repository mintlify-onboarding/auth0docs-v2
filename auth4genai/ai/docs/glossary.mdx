...
- Execute: Fetch access tokens, make tool calls, and more. To learn more, read [Call Other's APIs on the user's behalf](/ai/docs/get-started/call-others-apis-on-users-behalf).
- Remember and adapt: Stores context across interactions for better responses in the future.

With [Auth0 SDKs](/ai/docs/sdks/overview), you can easily integrate with popular agentic frameworks, including [Genkit](https://firebase.google.com/docs/genkit), [LangChain](https://www.langchain.com/), [Vercel AI](https://ai-sdk.dev/docs/introduction), and [LlamaIndex](https://www.llamaindex.ai/).
...
With [Auth0 SDKs](/ai/docs/sdks/overview), you can easily implement RAG in LLMs:
...
- To start building with Auth for GenAI, read the [Get started](/ai/docs/get-started/overview) quickstarts.
