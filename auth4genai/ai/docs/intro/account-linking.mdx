...
<Frame>
  ...
  flow](/ai/docs/img/client_initiated_account_linking.png)
</Frame>
...
For a detailed guide on implementing this flow, please refer to the [Client-Initiated Account Linking Guide](/ai/docs/guides/client-initiated-account-linking).
...
<Columns cols={2}>
  <Card
    ...
    href="/ai/docs/guides/client-initiated-account-linking"
    icon="link"
    horizontal
  />
</Columns>
