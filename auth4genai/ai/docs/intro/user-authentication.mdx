...
<Frame>
  <img src="/ai/docs/img/universal_login.png" alt="Universal login screen" />
</Frame>
...
<Columns>
  <Card
    ...
    iconType="solid"
    horizontal
    href="https://github.com/auth0-samples/auth0-ai-samples/tree/main/authenticate-users/next-js"
  />
  <Card
