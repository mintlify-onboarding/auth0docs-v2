...
<Tabs>
  <Tab title="Node.js" icon="node-js">
    <Card title="Prerequisites" icon="user-shield" iconType="solid">
      ...
      <Steps>
        <Step title="Create an Auth0 Account and a Dev Tenant">
          ...
          <Columns cols={2}>
            <Card title="Create Account" icon="user-shield" iconType="solid" horizontal href="https://auth0.auth0.com/u/login/identifier?state=hKFo2SBlc2U2V0dmMnBiOEpUZjNyRnZlLWJpM3lkTE0wNThITqFur3VuaXZlcnNhbC1sb2dpbqN0aWTZIDhjZXU5TE5lWFdyUlF0aGRrXzRFenFqNEJCZk9oUXNto2NpZNkgekVZZnBvRnpVTUV6aWxoa0hpbGNXb05rckZmSjNoQUk"/>
          </Columns>
        </Step>
        ...
        <Step title="Enable Guardian Push" icon="android" iconType="solid">
        ...
        <Step title="Enroll your user to use Auth0 Guardian" icon="android" iconType="solid">
    ...
    **Note:** Your application’s client secret is masked for you. To get the client secret value, click the copy button on the code sample.
    ...
    ```ts ./src/lib/tools/buy.ts expandable wrap
    ...
    ```ts ./src/index.ts expandable wrap
  ...
  <Tab title="Fast API" icon="https://mintlify-assets.b-cdn.net/auth0/FastAPI.svg">
  Coming soon...
  </Tab>
</Tabs>
