...
## How it works
### LLM Context Files
You can provide raw text files (llms.txt), individual markdown pages, or URLs for the AI to read. This is a great way to provide targeted information for a specific task. To enable your AI tools to index and search the documentation, use the following files:
...
### Auth0 MCP Server
The Auth0 MCP Server allows authenticated AI agents to perform actions in your Auth0 tenant, such as creating applications, configuring connections, and more. To learn more, read the [Auth0 MCP server documentation.](https://auth0.com/docs/get-started/auth0-mcp-server)
