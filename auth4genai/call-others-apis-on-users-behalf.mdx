...
<Tabs>
  <Tab title="Next.js" icon="https://mintlify-assets.b-cdn.net/auth0/next-js.svg">
    ...
    ```ts ./src/lib/google.ts wrap highlight={2,6,10}
    ...
    ```ts ./src/lib/tools/google-calendar-view.ts wrap highlight={4,17}
    import { tool } from 'ai';
    import { z } from 'zod';
    import { google } from 'googleapis';
    ...
    ```ts ./src/app/api/chat/route.ts wrap highlight={4,16}
