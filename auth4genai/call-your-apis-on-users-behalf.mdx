...
```tsx ./src/lib/tools/user-info.ts wrap
import { tool } from "ai";
import { z } from "zod";
...
```tsx ./src/app/api/chat/route.ts wrap
...
```tsx ./src/app/chat/page.tsx wrap
"use client";
