...
With [Auth0 SDKs](/sdks), you can easily integrate with popular agentic frameworks, including [Genkit](https://firebase.google.com/docs/genkit), [LangChain](https://www.langchain.com/), [Vercel AI](https://sdk.vercel./introduction), and [LlamaIndex](https://www.llamaindex.ai/).
