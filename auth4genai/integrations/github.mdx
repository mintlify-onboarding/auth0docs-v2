...
<Steps>
  <Step title="Set up app in Github">
    <ol>
      ...
      <li>
        Set up a new OAuth app via [GitHub Developer Settings: OAuth
        Apps](https://github.com/settings/developers#oauth-apps)
      </li>
      <li>
  ...
  <Step title="Configure the GitHub Social Connection in Auth0">
    <ol>
      ...
      <li>
        In **Permissions**, select all the required scopes. When you get an
        access token for the GitHub social connection, it will contain the
        appropriate scopes so you can use it to call the required GitHub APIs.
      </li>
      <li>
