...
<Steps>
  ...
  <Step title="Enable Token Vault">
    In **Advanced**, toggle **Enable Token Vault**. This allows the connection to retrieve and store access tokens for third-party APIs securely. To learn more, read [Configure Token Vault](https://auth0.com/docs/secure/tokens/token-vault/configure-token-vault).
  </Step>
