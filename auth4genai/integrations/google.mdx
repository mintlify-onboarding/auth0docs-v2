...
You need to enable your desired Google APIs for your OAuth 2.0 Client. 

<Steps>
  <Step title="Enable Google APIs">
    Navigate to the [Google API Library](https://console.cloud.google.com/apis/library). Then, search for your Google APIs: 
    <ul>
      <li>Search for the Google Calendar API and click **Enable**.</li>
      <li>Search for the Google Docs API and click **Enable**.</li>
    </ul>
  </Step>
</Steps>
