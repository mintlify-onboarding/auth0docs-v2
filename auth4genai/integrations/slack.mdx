...
<Steps>
  <Step title="Set up app in Slack">
    1. Sign up for a [Slack Developer account](https://slack.com/signin) 2. If
    you haven't already, create a [Slack App](https://api.slack.com/apps/new)
  </Step>
  <Step title="Configure for Auth0">
    1. Once your app is created, copy and paste the Client ID and Client Secret
    into the Auth0 configuration screen. 2. Next, click on OAuth & Permissions
    in the Features menu on the left. Use the following settings when
    configuring your app: - Redirect URI: `https://YOUR_DOMAIN/login/callback`
  </Step>
</Steps>
