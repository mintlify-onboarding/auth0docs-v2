...
Upon successful authentication, an access token is issued to your application.
</Step>
...
The API validates the access token. If valid, it processes the request on behalf of the user and returns the response to the AI agent.
</Step>
...
<Columns>
<Card title="Call Your APIs On User's Behalf" icon="key" iconType="solid" horizontal href="/intro/call-your-apis-on-users-behalf"/>
</Columns>

- **Sample Apps:**

<Columns>
<Card title="Next.js" icon="github" iconType="solid" horizontal href="https://github.com/auth0-samples/auth0-ai-samples/tree/main/call-apis-on-users-behalf/your-api-next-js"/>
