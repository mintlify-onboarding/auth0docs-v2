...
- **Guides:**
  <Columns cols={2}>
  <Card title="Check Google Calendar Availability" href="/how-tos/check-google-calendar-availability" icon="google" horizontal/>
  <Card title="List GitHub Repositories" href="/how-tos/list-github-repositories" icon="github" horizontal/>
  <Card title="List Slack Channels" href="/how-tos/list-slack-channels" icon="slack" horizontal/>
  <Card title="Get Salesforce Opportunities" href="/how-tos/get-salesforce-opportunities" icon="salesforce" horizontal/>
  </Columns>
- **Sample Apps:**
