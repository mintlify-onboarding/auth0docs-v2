...
<Columns>
<Card href="/get-started/user-authentication" title="User Authentication for Next.js" icon="js" iconType="solid" horizontal />
<Card href="/get-started/user-authentication" title="User Authentication for FastAPI" icon="python" iconType="solid" horizontal />
