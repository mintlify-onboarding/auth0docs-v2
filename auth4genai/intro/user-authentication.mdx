...
description: "Robust user authentication is essential for Generative AI applications and AI agents. It ensures security, protects data, and controls access to AI models and features."
...
You can use Auth0 to authorize calls to your own APIs on behalf of logged-in users. The Auth0 SDKs make this easy. [Learn more](/ai/docs/intro/call-your-apis-on-users-behalf).
...
<Columns>
<Card href="/ai/docs/intro/user-authentication" title="User Authentication for Next.js" icon="js" iconType="solid" horizontal />
<Card href="/ai/docs/intro/user-authentication" title="User Authentication for FastAPI" icon="python" iconType="solid" horizontal />
...
<Columns>
<Card title="Next.js" icon="github" iconType="solid" horizontal href="https://github.com/auth0-samples/auth0-ai-samples/tree/main/authenticate-users/next-js"/>
