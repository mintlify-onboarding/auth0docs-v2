...
* Verify the access token with `jose` against your tenant JWKS, enforcing issuer, audience, and RS256
  ...
  Custom Token Exchange is currently in Early Access for Enterprise customers only and it is available under the Early Access program. Go to the [Early Access section](/mcp/intro/overview#early-access) to learn how to gain access.
...
* Learn more about [Calling Your APIs on Users Behalf](/mcp/intro/call-your-apis-on-users-behalf).