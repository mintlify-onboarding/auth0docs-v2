...
import DownloadOrCloneButton from "/snippets/download-quickstart/DownloadOrCloneButton.jsx";
...
<DownloadOrCloneButton
  category="auth-for-mcp"
  framework="fastmcp-mcp-customtokenexchange-js"
  label="Download sample"
  githubRepo="auth0-samples/auth0-ai-samples"
  codespacesUrl="https://github.com/codespaces/new?hide_repo_select=true&ref=main&repo=auth0-samples%2Fauth0-ai-samples"
  stackblitzUrl="https://stackblitz.com/github/auth0-samples/auth0-ai-samples"
/>
...
```javascript expandable wrap lines highlight={23-25,28-33}
 mcpServer.addTool({
    name: "greet",
    description:
      "Greet a user with personalized authentication information retrieved from an upstream API using Custom Token Exchange.",
...
```javascript expandable wrap lines highlight={1,9}
