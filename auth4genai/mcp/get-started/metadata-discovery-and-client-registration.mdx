...
Learn how to use Auth0 to enable Dynamic Client Registration for your MCP Server.
...
<Steps>
  ...
  <Step title="Enable your Tenant to use the Resource Parameter Compatibility Profile">
      ...
      Resource Parameter Compatibility Profile is available under the Early Access program. Go to the [Early Access section](/mcp/intro/overview#limited-early-access) to learn how to gain access.
...
When you perform the Quick OAuth Flow button, MCP Inspector performs all the steps in the OAuth Flow Progress section as outlined in the [MCP authorization flow with Auth0](?tab=t.f7kbkzagcdu9#heading=h.h1bjhse8ecf7). 
