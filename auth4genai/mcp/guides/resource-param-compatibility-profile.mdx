...
*RFC 8707 requires the `resource` parameter to [be an absolute URI](https://www.rfc-editor.org/rfc/rfc8707.html#name-resource-parameter), to conform with RFC 8707 we recommend defining your resource server identifiers (API identifiers) in [URI format](https://datatracker.ietf.org/doc/html/rfc3986).*
...
* Resource Parameter Compatibility **enabled**:  
  ...
  *Note: If passing the resource parameter to an upstream IdP, Resource Parameter Compatibility Profile should not be enabled.*
