...
3. In the left navigation menu, click on **Authentication**.
4. Optionally, if you are not using DCR, enter the **Client ID** and **Client Secret** you obtained when you registered your application.
5. Click **Connect**.
