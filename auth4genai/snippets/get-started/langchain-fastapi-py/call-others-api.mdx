...
Set up the Auth0 AI SDK for a [Google social connection](/guides/google-sign-in-and-auth). This allows you to get access tokens for a Google social connection using [Token Vault](https://auth0.com/docs/secure/tokens/token-vault):
