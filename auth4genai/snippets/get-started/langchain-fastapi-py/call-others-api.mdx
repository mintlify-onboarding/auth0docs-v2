...
- `auth0-ai`: [Auth0 AI SDK](https://github.com/auth0-lab/auth0-ai-python) for secure AI applications.
...
Visit the URL `http://localhost:5173` in your browser and interact with the AI agent. If you are already logged in, make sure to log out and log in again using Google. Then, ask your AI Agent to list the upcoming events in your Google Calendar!
