...
Start the application with `npm run all:dev`. Then, navigate to `http://localhost:3000`. If you are already logged in, make sure to log out and log in again using Google. Then, ask your AI Agent to fetch emails from your Gmail account!
