...
To implement, install the Auth0 AI Components for Next.js to get the required UI components:
...
Handle the interrupts from the AI Agent and call the tool from your AI app to get calendar events. Update your chat route, typically at `/src/app/api/chat/route.ts` similar to this example:
