...
Sign up for your application to create a new user account. You will then see a welcome message with your user name. You can sign in with that account on future visits.
...
In the root directory of your project, create or add to your `.env.local` file the following content:
