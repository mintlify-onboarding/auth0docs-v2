    ...
    In the root directory of your project, create the `.env` file and add the following variables:
    ...
    To get the user ID, navigate to **User Management** > **Users** and click on a user. The user ID should look like `auth0|123456789`.
