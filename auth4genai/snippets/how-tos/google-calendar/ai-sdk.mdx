...
```typescript lines  ./src/lib/tools/checkUsersCalendar.ts wrap highlight={4-6,10,19,26-28,46-48}
...
```typescript lines ./src/app/api/chat/route.ts wrap highlight={3-4,10,13,27,29}
...
```tsx lines ./src/components/chat.tsx wrap highlight={4-6,10-14,25-34}
"use client";
