...
```typescript lines ./src/agent/tools/checkUsersCalendar.ts wrap highlight={4-6,10,19,26-28.46-48}
...
```typescript lines ./src/agent/chat.ts wrap highlight={1-2,52-54,63-66}
...
```tsx lines ./src/components/chat.tsx wrap highlight={4-6,17-18,33-42}
"use client";
