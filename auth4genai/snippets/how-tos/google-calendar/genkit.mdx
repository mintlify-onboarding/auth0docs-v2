...
```typescript lines ./src/lib/tools/checkUsersCalendar.ts wrap highlight={3-5,11,24,31-33,51-53}
...
```typescript lines ./src/app/api/chat/route.ts wrap highlight={4-5,47}
...
```tsx lines ./src/components/chat.tsx wrap highlight={4-5, 120-141}
"use client";
