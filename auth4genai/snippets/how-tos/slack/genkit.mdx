...
```typescript ./src/lib/tools/listChannels.ts wrap highlight={2-4,11,18,22,34-36}
import { z } from "zod";
...
```typescript ./src/app/api/chat/route.ts wrap highlight={4-5,47}
...
```tsx ./src/components/chat.tsx wrap highlight={4-5,120-141}
"use client";
