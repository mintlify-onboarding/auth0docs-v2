...
```python lines ./src/lib/auth0-ai.py wrap
...
```python lines ./src/lib/tools/check_availability.py wrap highlight={7-8,15,19,34,38}
...
```python lines ./src/lib/agent.py wrap highlight={8,15,37,42}
