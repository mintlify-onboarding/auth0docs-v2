...
```typescript lines ./src/lib/tools/checkUsersCalendar.ts wrap
...
```typescript lines ./src/lib/agent.ts wrap
...
```typescript lines ./src/app/api/langgraph/[..._path]/route.ts wrap
...
```tsx lines ./src/components/chat.tsx wrap
