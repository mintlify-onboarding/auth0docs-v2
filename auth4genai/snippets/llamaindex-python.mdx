...
```python lines ./src/lib/tools/check_availability.py wrap highlight={7-8,14,18,33,37}
...
```python lines ./src/lib/agent.ts wrap highlight={3,13}
...
```python lines ./src/app.py wrap highlight={3-5,19-20}
