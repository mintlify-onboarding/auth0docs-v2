...
```typescript lines ./src/lib/tools/listRepositories.ts wrap highlight={5-7,11,15,23,42-44}
...
```typescript lines ./src/app/api/chat/route.ts wrap highlight={2-5,15,35}
...
```tsx lines ./src/components/chat.tsx wrap highlight={4-6,28-38}
"use client";
