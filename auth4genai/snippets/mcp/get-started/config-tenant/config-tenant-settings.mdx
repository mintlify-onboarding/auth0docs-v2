...
<AccordionGroup>
  ...
  <Accordion title="2. Add roles and permissions (optional)">
...
# Example for a basic user role
    ...
    Save the IDs from the output (they start with `rol_`), as you'll need them for the next step.

### Assign permissions to roles

    After creating roles, assign the API permissions to them:
