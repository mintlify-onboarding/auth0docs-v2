...
```ts lines ./src/lib/tools/checkUsersCalendar.ts expandable wrap
import { tool } from "ai";
import { z } from 'zod';
...
```tsx lines ./src/app/api/chat/route.ts expandable wrap
import { z } from 'zod';
...
```tsx lines ./src/app/page.tsx expandable wrap
'use client';
