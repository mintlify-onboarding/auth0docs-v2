...
```typescript ./src/lib/tools/listChannels.ts wrap highlight={2-4,8,14,18,30-32}
...
```typescript ./src/app/api/chat/route.ts wrap highlight={3-4,10,13,27,29}
...
```tsx ./src/components/chat.tsx wrap highlight={4-6,10-14,25-34}
"use client";
