...
```typescript ./src/agent/tools/listRepositories.ts wrap highlight={2-4,8,14,18,30-32}
...
```typescript ./src/agent/chat.ts wrap highlight={1-2,52-54,63-66}
...
```tsx ./src/components/chat.tsx wrap highlight={4-6,17-18,33-42}
"use client";
