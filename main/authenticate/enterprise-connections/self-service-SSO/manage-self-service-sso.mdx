...
<<<<<<< HEAD:main/authenticate/enterprise-connections/self-service-SSO/manage-self-service-sso.mdx
...
>>>>>>> upstream/main:main/docs/authenticate/enterprise-connections/self-service-SSO/manage-self-service-sso.mdx
