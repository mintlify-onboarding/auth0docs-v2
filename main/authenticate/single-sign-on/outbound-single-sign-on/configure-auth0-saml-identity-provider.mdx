---
description: Describes how to configure Auth0 to serve as a SAML identity provider
...
---
You can use Auth0 as the <Tooltip tip="Identity Provider (IdP): Service that stores and manages digital identities." cta="View Glossary" href="/glossary?term=identity+provider">identity provider</Tooltip> in <Tooltip tip="Identity Provider (IdP): Service that stores and manages digital identities." cta="View Glossary" href="/glossary?term=SAML">SAML</Tooltip> configurations with SAML 2.0.
...
Some of the following integrations make use of the [SAML2 Web App addon](/authenticate/protocols/saml/saml-sso-integrations/enable-saml2-web-app-addon).
...
You can manually configure a SAML <Tooltip tip="Single Sign-On (SSO): Service that, after a user logs into one applicaton, automatically logs that user in to other applications." cta="View Glossary" href="/glossary?term=SSO">SSO</Tooltip> integration with the SAML2 Web App addon in the <Tooltip tip="Auth0 Dashboard: Auth0's main product to configure your services." cta="View Glossary" href="/glossary?term=Auth0+Dashboard">Auth0 Dashboard</Tooltip>. You can configure the SAML addon using the instructions on the screen along with the information available on the service provider's settings.
