...
New features and breaking changes were released to triggers in the Login Flow. To learn about these changes, read [Login Flow: Releases](/releases).
...
To learn more about these changes and see code examples, read [Login Flow: Releases](/releases).
