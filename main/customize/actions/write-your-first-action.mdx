...
---
This guide will walk you through how to create and deploy your first Action using the <Tooltip tip="Auth0 Dashboard: Auth0's main product to configure your services." cta="View Glossary" href="/glossary?term=Auth0+Dashboard">Auth0 Dashboard</Tooltip>. When you finish, you should understand the basic functionality that you will use with all Actions and you will be familiar with the programming model. What you will learn constitutes the foundation of writing any Action, regardless of its purpose or the flow.
...
2. Select the [Login flow](/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger) and drag `my-slack-action` into the flow.
...
The Action is now running for real user traffic within your tenant. If you’d like a more robust testing environment, consider [setting up multiple Auth0 environments](/get-started/auth0-overview/create-tenants/set-up-multiple-environments).
...
Now that you’ve written your first Action, check out [Explore Flows and Triggers](/customize/actions/explore-triggers) to learn how to perform some common tasks with Actions.