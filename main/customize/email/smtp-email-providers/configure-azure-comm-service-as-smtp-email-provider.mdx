...
* Configure your firewall to accept traffic from Auth0. For more information, read [Auth0 IP Address for Allow List](/secure/security-guidance/data-security/allowlist).
