...
Event delivery will automatically retry. To learn more, review [Best Practices](/customize/events/event-testing-observability-and-failure-recovery#batch-redelivery-of-failed-events).
