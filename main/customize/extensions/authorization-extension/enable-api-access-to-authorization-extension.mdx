...
To access the API, you'll need to [ask for and obtain the appropriate token](/get-started/authentication-and-authorization-flow/client-credentials-flow/call-your-api-using-the-client-credentials-flow).
