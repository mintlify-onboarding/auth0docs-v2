...
You can update Hooks using the Dashboard or <Tooltip tip="Management API: A product to allow customers to perform administrative tasks." cta="View Glossary" href="/glossary?term=Management+API">Management API</Tooltip>.

You can also import and export hooks using the [Deploy Command-Line Interface (CLI) tool](/deploy-monitor/deploy-cli-tool).
