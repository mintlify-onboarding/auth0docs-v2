...
[Learn more about integration use cases](/customize/integrations/marketplace-partners/defining-an-integration-use-case)

#### Introduction to Integration

Explore Auth0 extensibility and all the different ways that Auth0 can be customized.

[Learn more about integrating](/customize/integrations/marketplace-partners/introduction-to-integrating-with-auth0)
...
[Learn how to build an Action Integration](/customize/integrations/marketplace-partners/actions-integrations-for-partners)
...
[Learn how to build a Social Connection](/customize/integrations/marketplace-partners/social-connections-for-partners)

#### SSO Integrations

<Tooltip tip="Single Sign-On (SSO): Service that, after a user logs into one applicaton, automatically logs that user in to other applications." cta="View Glossary" href="/glossary?term=SSO">SSO</Tooltip> Integrations use an Auth0 identity to log in, via <Tooltip tip="Single Sign-On (SSO): Service that, after a user logs into one applicaton, automatically logs that user in to other applications." cta="View Glossary" href="/glossary?term=SAML">SAML</Tooltip>, to an external service.

[Learn how to build an SSO Integration](/customize/integrations/marketplace-partners/sso-integrations-for-partners)
...
Enterprise connections are a way for customers to authenticate users in an external federated <Tooltip tip="Identity Provider (IdP): Service that stores and manages digital identities." cta="View Glossary" href="/glossary?term=identity+provider">identity provider</Tooltip> using OIDC.
