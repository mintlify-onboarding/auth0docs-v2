...
Enable ACUL for the Login ID screen using a test [Auth0 Management API Explorer Token](/secure/tokens/access-tokens/management-api-access-tokens/get-management-api-access-tokens-for-testing), the [Custom Domain](/customize/custom-domains) address, and the local assets as HTML head tags.
...
To learn more about enabling ACUL, read [Deploy and Host Advanced Customizations](/customize/login-pages/advanced-customizations/getting-started/deploy-and-host-advanced-customizations).

## Step 4. Render the ACUL Login ID screen

Start your development application or the [Auth0 SDK sample application](/quickstart/spa/react/interactive) on your `localhost` to render the ACUL Login ID screen.

To learn more about the available screens, review [ACUL Screens](/customize/login-pages/advanced-customizations/reference).
