...
The Reset Password screen class is part of the [Identifier First Authentication](/authenticate/login/auth0-universal-login/identifier-first) flow and resets the user's password.
...
The Reset Password Email screen class is part of the [Identifier First Authentication](/authenticate/login/auth0-universal-login/identifier-first) flow and sends the user email instructions to reset their password.
...
The Reset Password Error screen class is part of the [Identifier First Authentication](/authenticate/login/auth0-universal-login/identifier-first) flow and sends the user back to your application.
...
The Reset Password Request screen class is part of the [Identifier First Authentication](/authenticate/login/auth0-universal-login/identifier-first) flow and prompts the user for an email to send reset password instructions.
...
The Reset Password Success screen class is part of the [Identifier First Authentication](/authenticate/login/auth0-universal-login/identifier-first) flow and confirms the password change and returns the user to your application.
