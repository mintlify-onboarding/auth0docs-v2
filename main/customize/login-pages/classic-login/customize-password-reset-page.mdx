...
* For tenant administrators resetting other users' passwords: [Change Users' Passwords](/authenticate/database-connections/password-change)
* For individuals resetting their own passwords: [Reset Auth0 Account Password](/troubleshoot/customer-support/reset-account-passwords)
...
The password reset page is enabled for all Auth0 users by default and does not require customization. However, you can enable [advanced customization](/customize/login-pages/classic-login/customization-classic) if you wish to update the branding and other elements of the password reset page.

To enable advanced customization from the <Tooltip tip="Auth0 Dashboard: Auth0's main product to configure your services." cta="View Glossary" href="/glossary?term=Auth0+Dashboard">Auth0 Dashboard</Tooltip>:
...
* [Customize Classic Login Pages](/customize/login-pages/classic-login/customization-classic)
...
* [Self Change Password Errors](/troubleshoot/authentication-issues/self-change-password-errors)