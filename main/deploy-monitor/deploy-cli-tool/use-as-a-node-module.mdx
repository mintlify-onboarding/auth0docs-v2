...
For a comprehensive list of configuration settings, please read [Configure the Deploy CLI](/deploy-monitor/deploy-cli-tool/configure-the-deploy-cli).
...
Options: `yaml` or `directory`. Determines the file format of the exported resource configuration files. To learn more, read [Available Resource Configuration Formats](/deploy-monitor/deploy-cli-tool/available-resource-configuration-formats).
...
Object. Configures behavior of utility. To learn more, read [Configure the Deploy CLI](/deploy-monitor/deploy-cli-tool/configure-the-deploy-cli).

#### config_file

Path. Specifies the user-defined configuration file (`config.json`). To learn more, read [Configure the Deploy CLI](/deploy-monitor/deploy-cli-tool/configure-the-deploy-cli).
