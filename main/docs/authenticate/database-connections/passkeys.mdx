...
If you have Multiple Custom Domains enabled on your tenant, Auth0 maintains a one-to-one relationship between a domain and the passkey for that domain. Uers with a passkey-enabled database will be able to sign up and log in with a passkey, tied to the specific domain it was created on. 
