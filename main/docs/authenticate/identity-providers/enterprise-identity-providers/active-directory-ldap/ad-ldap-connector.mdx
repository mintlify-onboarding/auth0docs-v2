...
To learn more, see [Configure AD/LDAP Connector Authentication with Kerberos](/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector/configure-ad-ldap-connector-with-kerberos) and [Configure AD/LDAP Connector Authenticator with Client Certificates](/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector/configure-ad-ldap-connector-client-certificates).
