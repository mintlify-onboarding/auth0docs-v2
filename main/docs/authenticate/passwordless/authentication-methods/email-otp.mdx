...
---
You can configure a <Tooltip tip="Passwordless: Form of authentication that does not rely on a password as the first factor." cta="View Glossary" href="/glossary?term=Passwordless">Passwordless</Tooltip> connection to send a one-time password (OTP) to a user through email to complete authentication.
...
If the user is logged in through an [Organization](/manage-users/organizations/organizations-overview), the following parameters are also available:
