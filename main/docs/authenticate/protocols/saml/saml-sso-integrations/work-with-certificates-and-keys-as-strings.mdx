...
When working with certificates or keys in rules or <Tooltip tip="Management API: A product to allow customers to perform administrative tasks." cta="View Glossary" href="/glossary?term=Management+API">Management API</Tooltip> v2 requests, you will most likely require a string representation of the file.
