...
---
To learn more about the supported SCIM management operations and how to use them, go to the [Auth0 Management API Explorer](https://auth0.com/docs/api/management/v2) and expand the **Connections** tab. The <Tooltip tip="Management API: A product to allow customers to perform administrative tasks." cta="View Glossary" href="/glossary?term=management+API">management API</Tooltip> can enable, update, and remove the SCIM configuration for a selected connection, as well as create and delete SCIM tokens.
...
6. Select **Update**.
7. Follow the instructions in [Management API Access Tokens](/secure/tokens/access-tokens/management-api-access-tokens) to learn how to get tokens and call the [Auth0 Management API v2](https://auth0.com/docs/api/management/v2/connections/post-scim-configuration) endpoints.