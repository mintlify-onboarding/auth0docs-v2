...
</Tab><Tab title="TypeScript import">
...
To learn more about writing Actions, see [Write Your First Action](main/docs/customize/actions/write-your-first-action.mdx).
