...
<span>Transaction using the Device <Tooltip tip="Authorization grant (or workflow) specified in the OAuth 2.0 framework." cta="View Glossary" href="/glossary?term=Authorization+Flow">Authorization Flow</Tooltip>.</span>
</li>
<li>
