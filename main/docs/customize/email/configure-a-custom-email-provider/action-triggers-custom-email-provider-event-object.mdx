---
description: Learn about the custom-email-provider Action trigger's event object,
...
<code>client_id</code> <em>String</em>.
            <span>The <Tooltip tip="Identification value given to your registered resource from Auth0." cta="View Glossary" href="/glossary?term=client+ID">client ID</Tooltip> of the application the user is logging in to.</span>
</li>
<li>
...
<code>picture</code> <em>Optional string</em>.
            <span>URL pointing to the
              <a href="/manage-users/user-accounts/change-user-picture">user's profile picture</a>.</span>
</li>
<li>
...
* [Configure a Custom Email Provider](/customize/email/configure-a-custom-email-provider)
* [Write Your First Action](/customize/actions/write-your-first-action)
* [Understand How Auth0 Actions Work](/customize/actions/actions-overview)
* [Action Coding Guidelines](/customize/actions/action-coding-guidelines)
* [Actions Limitations](/customize/actions/limitations)