...
SMTP makes it easy to set up test services that allow you to test that your setup is working without spamming your users. To learn more, see [Set Up Test SMTP Servers](/customize/email/configure-test-smtp-email-servers).
