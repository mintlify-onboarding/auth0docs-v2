...
To learn more, read [Auth0 Rules](/customize/rules).
...
To learn more, read [Create Custom Claims.](/secure/tokens/json-web-tokens/create-custom-claims)
...
For more details, review [Manage Metadata with Rules](/manage-users/user-accounts/metadata/manage-metadata-rules).
