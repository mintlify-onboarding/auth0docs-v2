...
To learn more about Write Hooks, read [Delegated Administration: Write Hook](/customize/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-write-hook).
...
* **blocked_for**: Whether or not the user has <Tooltip tip="Attack Protection: Features that Auth0 provides to detect and mitigate attacks, including brute-force protection, suspicious IP throttling, breached password detection, bot detection, and adaptive multi-factor authentication." cta="View Glossary" href="/glossary?term=attack+protection">attack protection</Tooltip> blocks
