...
---
Once you create a form, you can render it with [Actions](/customize/actions) using the `api.prompt.render()` method:
...
In the [Actions Code editor](/customize/actions/write-your-first-action#create-an-action), you can define the business logic to decide when and how to render the Form.
...
* [Event Object](/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/post-login-event-object): Learn about the Event objects and properties.
* [API object](/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/post-login-api-object): Learn about the API objects and methods.
...
Make sure that the field `ID` referenced in the second argument is available client-side in your [nodes and components](/customize/forms/nodes-and-components); otherwise, the value will not populate.
...
You can use the `{{vars.*}}` property to reference shared variables in your Forms and its linked Flows. To learn more, read [Variables](/customize/forms/variables).
...
* You cannot [redirect](/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/redirect-with-actions) a user and render a form in the same Action. If you need to use both, consider using different Actions.
...
* The `api.prompt.render()` method is available in the following triggers:
  ...
  + [post-login](/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger/post-login-api-object)
  + [post-challenge](/customize/actions/explore-triggers/password-reset-triggers/post-challenge-trigger/post-challenge-api-object)