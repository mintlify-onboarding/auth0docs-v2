---
description: Learn how to create Hook Secrets using the Dashboard and Management
...
You can create multiple Hook Secrets for any [Hook](/customize/hooks) using the Dashboard or <Tooltip tip="Management API: A product to allow customers to perform administrative tasks." cta="View Glossary" href="/glossary?term=Management+API">Management API</Tooltip>.

Hook Secrets may also be imported and exported using the [Deploy Command-Line Interface (CLI) Tool](/deploy-monitor/deploy-cli-tool).
