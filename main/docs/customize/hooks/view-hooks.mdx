...
To see configured hooks, you can view them using the Dashboard or retrieve a list of them using the <Tooltip tip="Management API: A product to allow customers to perform administrative tasks." cta="View Glossary" href="/glossary?term=Management+API">Management API</Tooltip>.
