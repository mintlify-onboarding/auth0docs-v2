...
1. Log in to AWS, and go to the [IAM console](https://console.aws.amazon.com/iam). Using the left-hand navigation menu, select **Identity Providers**. Click **Create Provider**. Set the following parameters:
   ...
   <tr>
   <td>Provider Type</td>
   <td>The type of provider. Set as <Tooltip tip="Standardized protocol allowing two parties to exchange authentication information without a password." cta="View Glossary" href="/glossary?term=%60SAML%60">`SAML`</Tooltip></td>
   </tr>
   <tr>
   <td>Provider Name</td>
