...
By the end of this flow, you'll have a customized <Tooltip tip="Passwordless: Form of authentication that does not rely on a password as the first factor." cta="View Glossary" href="/glossary?term=Passwordless">Passwordless</Tooltip> login screen with the option for email or SMS.

To learn more, read the [Getting Started guide](/customize/login-pages/advanced-customizations/getting-started) and visit the [SDK reference guide](/customize/login-pages/advanced-customizations/getting-started/sdk-quickstart).
...
For more information about screens that can be customized, read [Advanced Customization JS SDK Reference](/customize/login-pages/advanced-customizations/reference).