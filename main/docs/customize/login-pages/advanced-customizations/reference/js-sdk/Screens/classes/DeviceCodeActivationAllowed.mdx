...
- Implements [`DeviceCodeActivationAllowedMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/DeviceCodeActivationAllowedMembers)
...
- Returns `DeviceCodeActivationAllowed`
...
- Implementation of [`DeviceCodeActivationAllowedMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/DeviceCodeActivationAllowedMembers).[`branding`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/DeviceCodeActivationAllowedMembers#branding)
