...
- Implements [`MfaDetectBrowserCapabilitiesMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/MfaDetectBrowserCapabilitiesMembers)
...
- Returns `MfaDetectBrowserCapabilities`
...
- Implementation of [`MfaDetectBrowserCapabilitiesMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/MfaDetectBrowserCapabilitiesMembers).[`branding`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/MfaDetectBrowserCapabilitiesMembers#branding)
