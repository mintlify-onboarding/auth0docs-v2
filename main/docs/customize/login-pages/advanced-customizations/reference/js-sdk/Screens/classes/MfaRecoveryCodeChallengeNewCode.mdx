...
- Implements [`MfaRecoveryCodeChallengeNewCodeMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/MfaRecoveryCodeChallengeNewCodeMembers)
...
- Returns `MfaRecoveryCodeChallengeNewCode`
