...
- Implements [`MfaWebAuthnEnrollmentSuccessMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/MfaWebAuthnEnrollmentSuccessMembers)
...
- Implementation of [`MfaWebAuthnEnrollmentSuccessMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/MfaWebAuthnEnrollmentSuccessMembers).[`branding`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/MfaWebAuthnEnrollmentSuccessMembers#branding)
