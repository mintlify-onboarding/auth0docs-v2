...
- Implements [`PhoneIdentifierEnrollmentMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/PhoneIdentifierEnrollmentMembers)
...
- Returns `PhoneIdentifierEnrollment`
...
- Implementation of [`PhoneIdentifierEnrollmentMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/PhoneIdentifierEnrollmentMembers).[`user`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/PhoneIdentifierEnrollmentMembers#user)
