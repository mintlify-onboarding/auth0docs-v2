...
- Implements [`ResetPasswordMfaEmailChallengeMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/ResetPasswordMfaEmailChallengeMembers)
...
- Returns `ResetPasswordMfaEmailChallenge`
