...
- Implements [`ResetPasswordMfaOtpChallengeMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/ResetPasswordMfaOtpChallengeMembers)
...
- Returns `ResetPasswordMfaOtpChallenge`
