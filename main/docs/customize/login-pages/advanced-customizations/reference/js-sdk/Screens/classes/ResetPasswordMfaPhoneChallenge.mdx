...
- Implements [`ResetPasswordMfaPhoneChallengeMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/ResetPasswordMfaPhoneChallengeMembers)
...
- Returns `ResetPasswordMfaPhoneChallenge`
