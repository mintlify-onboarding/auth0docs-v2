...
- Implements [`ResetPasswordMfaSmsChallengeMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/ResetPasswordMfaSmsChallengeMembers)
...
- Returns `ResetPasswordMfaSmsChallenge`
...
- Implementation of [`ResetPasswordMfaSmsChallengeMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/ResetPasswordMfaSmsChallengeMembers).[`branding`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/ResetPasswordMfaSmsChallengeMembers#branding)
