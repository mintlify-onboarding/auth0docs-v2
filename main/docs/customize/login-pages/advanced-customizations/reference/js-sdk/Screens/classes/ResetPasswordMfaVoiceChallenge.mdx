...
- Implements [`ResetPasswordMfaVoiceChallengeMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/ResetPasswordMfaVoiceChallengeMembers)
...
- Returns `ResetPasswordMfaVoiceChallenge`
