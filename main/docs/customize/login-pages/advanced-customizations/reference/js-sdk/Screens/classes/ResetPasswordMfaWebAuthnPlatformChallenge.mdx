...
- Implements [`ResetPasswordMfaWebAuthnPlatformChallengeMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/ResetPasswordMfaWebAuthnPlatformChallengeMembers)
...
- Returns `ResetPasswordMfaWebAuthnPlatformChallenge`
