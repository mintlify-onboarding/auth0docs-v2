...
- Implements [`ResetPasswordMfaWebAuthnRoamingChallengeMembers`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/ResetPasswordMfaWebAuthnRoamingChallengeMembers)
...
- Returns `ResetPasswordMfaWebAuthnRoamingChallenge`
