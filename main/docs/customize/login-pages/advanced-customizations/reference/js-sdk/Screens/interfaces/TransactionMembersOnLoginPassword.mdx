...
- Returns [`PasswordPolicy`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/PasswordPolicy) \| `null`
...
- Returns [`UsernamePolicy`](/docs/customize/login-pages/advanced-customizations/reference/js-sdk/Screens/interfaces/UsernamePolicy) \| `null`
</ParamField>