...
Defined in: [interfaces/models/untrusted-data.ts:14](https://github.com/auth0/universal-login/blob/41ce742a4ee4c4f52541f94813d5a46ef3da573d/packages/auth0-acul-js/interfaces/models/untrusted-data.ts#L14)
...
<ParamField body='submittedFormData' type='key'>
{/*> **submittedFormData**: \{\[`key`: `string`\]: `string` \| `number` \| `boolean` \| `null` \| `undefined`; \} \| `null`*/}

Defined in: [interfaces/models/untrusted-data.ts:15](https://github.com/auth0/universal-login/blob/41ce742a4ee4c4f52541f94813d5a46ef3da573d/packages/auth0-acul-js/interfaces/models/untrusted-data.ts#L15)
</ParamField>