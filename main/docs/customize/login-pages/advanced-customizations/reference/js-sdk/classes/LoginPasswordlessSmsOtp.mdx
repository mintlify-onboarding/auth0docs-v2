...
<ParamField path="submitOTP" type={<span>Promise&lt;void&gt;</span>} required>
  LoginPasswordlessSmsOtp from '@auth0/auth0-acul-js/login-passwordless-sms-otp'; const loginPasswordlessSmsOtp = new LoginPasswordlessSmsOtp(); loginPasswordlessSmsOtp.submitOTP();
</ParamField>

<ParamField path="resendOTP" type={<span>Promise&lt;void&gt;</span>} required>
  LoginPasswordlessSmsOtp from '@auth0/auth0-acul-js/login-passwordless-sms-otp'; const loginPasswordlessSmsOtp = new LoginPasswordlessSmsOtp(); loginPasswordlessSmsOtp.resendOTP();
</ParamField>
