...
description: "MFA Begin Enroll Options screen implementation class Handles the selection and enrollment of MFA factors"
---

<RequestExample>

```typescript Basic Usage lines
...
<ParamField path="enroll" type={<span>Promise&lt;void&gt;</span>}>
  ...
  <Expandable title="parameters">
    <ParamField path="payload" type={<span><a href="/docs/customize/login-pages/advanced-customizations/reference/js-sdk/interfaces/MfaEnrollOptions">MfaEnrollOptions</a></span>} required>
    </ParamField>
  </Expandable>
</ParamField>
...
**File:** [src/screens/mfa-begin-enroll-options/index.ts](https://github.com/auth0/universal-login/blob/master/packages/auth0-acul-js/src/screens/mfa-begin-enroll-options/index.ts)
