...
<ParamField path="selectMfaEmail" type={<span>Promise&lt;void&gt;</span>}>
  Selects an enrolled email address from the list

  <Expandable title="parameters">
    <ParamField path="payload" type={<span><a href="/docs/customize/login-pages/advanced-customizations/reference/js-sdk/interfaces/SelectMfaEmailOptions">SelectMfaEmailOptions</a></span>} required>
    </ParamField>
  </Expandable>
</ParamField>
