...
<ParamField path="continue" type={<span>Promise&lt;void&gt;</span>}>
  ...
  <Expandable title="parameters">
    <ParamField path="payload" type={<span><a href="/docs/customize/login-pages/advanced-customizations/reference/js-sdk/interfaces/MfaRecoveryCodeEnrollmentContinueOptions">MfaRecoveryCodeEnrollmentContinueOptions</a></span>} required>
    </ParamField>
  </Expandable>
</ParamField>
