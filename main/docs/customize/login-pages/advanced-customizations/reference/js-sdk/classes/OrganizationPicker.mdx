...
<ParamField path="selectOrganization" type={<span>Promise&lt;void&gt;</span>}>
  Submits the selected organization ID.

  <Expandable title="parameters">
    <ParamField path="payload" type={<span><a href="/docs/customize/login-pages/advanced-customizations/reference/js-sdk/interfaces/SelectOrganizationOptions">SelectOrganizationOptions</a></span>} required>
    </ParamField>
  </Expandable>
</ParamField>

<ParamField path="skipOrganizationSelection" type={<span>Promise&lt;void&gt;</span>}>
