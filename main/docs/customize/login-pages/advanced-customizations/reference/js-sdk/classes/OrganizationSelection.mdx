...
<ParamField path="continueWithOrganizationName" type={<span>Promise&lt;void&gt;</span>}>
  Continues with the selected organization name.

  <Expandable title="parameters">
    <ParamField path="payload" type={<span><a href="/docs/customize/login-pages/advanced-customizations/reference/js-sdk/interfaces/ContinueWithOrganizationNameOptions">ContinueWithOrganizationNameOptions</a></span>} required>
    </ParamField>
  </Expandable>
</ParamField>
