...
<ParamField path="continuePasskeyEnrollment" type={<span>Promise&lt;void&gt;</span>} required>
  PasskeyEnrollment from '@auth0/auth0-acul-js/passkey-enrollment'; const passkeyEnrollment = new PasskeyEnrollment(); passkeyEnrollment.continuePasskeyEnrollment();
</ParamField>

<ParamField path="abortPasskeyEnrollment" type={<span>Promise&lt;void&gt;</span>} required>
  PasskeyEnrollment from '@auth0/auth0-acul-js/passkey-enrollment'; const passkeyEnrollment = new PasskeyEnrollment(); passkeyEnrollment.abortPasskeyEnrollment();
</ParamField>
