...
<ParamField path="continuePasskeyEnrollment" type={<span>Promise&lt;void&gt;</span>} required>
  PasskeyEnrollmentLocal from '@auth0/auth0-acul-js/passkey-enrollment-local'; const passkeyEnrollment = new PasskeyEnrollmentLocal(); passkeyEnrollment.continuePasskeyEnrollment();
</ParamField>

<ParamField path="abortPasskeyEnrollment" type={<span>Promise&lt;void&gt;</span>} required>
  PasskeyEnrollmentLocal from '@auth0/auth0-acul-js/passkey-enrollment-local'; const passkeyEnrollment = new PasskeyEnrollmentLocal(); passkeyEnrollment.abortPasskeyEnrollment();
</ParamField>
