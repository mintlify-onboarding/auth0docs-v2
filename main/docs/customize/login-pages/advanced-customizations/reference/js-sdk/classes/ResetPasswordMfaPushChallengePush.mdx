...
<ParamField path="resendPushNotification" type={<span>Promise&lt;void&gt;</span>}>
...
<ParamField path="enterCodeManually" type={<span>Promise&lt;void&gt;</span>}>
...
<ParamField path="pollingManager" type={<span><a href="/docs/customize/login-pages/advanced-customizations/reference/js-sdk/interfaces/MfaPushPollingControl">MfaPushPollingControl</a></span>}>
  ...
  <Expandable title="parameters">
    <ParamField path="options" type={<span>MfaPollingOptions</span>} required>
    </ParamField>
  </Expandable>
</ParamField>
