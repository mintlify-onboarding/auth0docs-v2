...
**File:** [src/screens/reset-password-success/index.ts](https://github.com/auth0/universal-login/blob/master/packages/auth0-acul-js/src/screens/reset-password-success/index.ts)
