...
<ParamField path="signup" type={<span>Promise&lt;void&gt;</span>} required>
  methods handles signup-id related configuration. It allows to signup new users via different identifiers.
</ParamField>
...
<ParamField path="pickCountryCode" type={<span>Promise&lt;void&gt;</span>} required>
  SignupId from "@auth0/auth0-acul-js/signup-id"; const signupIdManager = new SignupId(); signupIdManager.pickCountryCode();
</ParamField>
