...
description: "Interface describing the members of the Device Code Activation Denied screen."
---
...
**File:** [interfaces/screens/device-code-activation-denied.ts](https://github.com/auth0/universal-login/blob/master/packages/auth0-acul-js/interfaces/screens/device-code-activation-denied.ts)
