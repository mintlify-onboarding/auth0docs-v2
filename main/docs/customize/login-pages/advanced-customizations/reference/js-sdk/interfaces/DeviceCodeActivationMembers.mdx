...
description: "Interface describing the members of the Device Code Activation screen."
---
...
**File:** [interfaces/screens/device-code-activation.ts](https://github.com/auth0/universal-login/blob/master/packages/auth0-acul-js/interfaces/screens/device-code-activation.ts)
