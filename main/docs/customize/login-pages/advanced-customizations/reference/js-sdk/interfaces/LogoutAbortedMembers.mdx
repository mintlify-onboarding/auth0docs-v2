...
description: "Interface defining the available methods and properties for the logout-aborted screen"
---
...
**File:** [interfaces/screens/logout-aborted.ts](https://github.com/auth0/universal-login/blob/master/packages/auth0-acul-js/interfaces/screens/logout-aborted.ts)
