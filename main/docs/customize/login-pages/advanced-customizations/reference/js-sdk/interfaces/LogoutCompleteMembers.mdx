...
description: "Interface defining the available methods and properties for the logout-complete screen"
---
...
**File:** [interfaces/screens/logout-complete.ts](https://github.com/auth0/universal-login/blob/master/packages/auth0-acul-js/interfaces/screens/logout-complete.ts)
