...
description: "Interface defining the available methods and properties for the mfa-country-codes screen"
---
...
<ParamField path="screen" type={<span><a href="/docs/customize/login-pages/advanced-customizations/reference/js-sdk/interfaces/ScreenMembersOnMfaCountryCodes">ScreenMembersOnMfaCountryCodes</a></span>} required>
</ParamField>

<ParamField path="selectCountryCode" type={<span>Promise&lt;void&gt;</span>} required>
  Selects a country code from the available options
</ParamField>
