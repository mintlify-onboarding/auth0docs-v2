...
description: "Interface defining the available methods and properties for the organization-selection screen."
---
...
<ParamField path="screen" type={<span><a href="/docs/customize/login-pages/advanced-customizations/reference/js-sdk/interfaces/ScreenMembersOnOrganizationSelection">ScreenMembersOnOrganizationSelection</a></span>} required>
  The screen properties.
</ParamField>
