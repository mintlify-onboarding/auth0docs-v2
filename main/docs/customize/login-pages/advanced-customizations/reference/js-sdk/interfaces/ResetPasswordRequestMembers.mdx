...
<ParamField path="screen" type={<span><a href="/docs/customize/login-pages/advanced-customizations/reference/js-sdk/interfaces/ScreenMembersOnResetPasswordRequest">ScreenMembersOnResetPasswordRequest</a></span>} required>
</ParamField>

<ParamField path="transaction" type={<span><a href="/docs/customize/login-pages/advanced-customizations/reference/js-sdk/interfaces/TransactionMembersOnResetPasswordRequest">TransactionMembersOnResetPasswordRequest</a></span>} required>
</ParamField>

<ParamField path="resetPassword" type={<span>Promise&lt;void&gt;</span>} required>
</ParamField>

<ParamField path="backToLogin" type={<span>Promise&lt;void&gt;</span>} required>
</ParamField>
