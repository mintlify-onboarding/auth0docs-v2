...
> **useMfaPolling**(`options?`): [`MfaPollingResult`](../../Types/interfaces/MfaPollingResult)

Defined in: [packages/auth0-acul-react/src/hooks/utility/polling-manager.ts:106](https://github.com/WriteChoiceMigration/universal-login/blob/79e6cc195f7925469d498589518d9c044e7ab14f/packages/auth0-acul-react/src/hooks/utility/polling-manager.ts#L106)
...
[`MfaPollingOptions`](../../Types/type-aliases/MfaPollingOptions)

[MfaPollingOptions](../../Types/type-aliases/MfaPollingOptions) specifying the polling interval,
                 success callback (`onCompleted`), and optional error handler (`onError`).

## Returns

[`MfaPollingResult`](../../Types/interfaces/MfaPollingResult)

object [MfaPollingResult](../../Types/interfaces/MfaPollingResult) containing:
...
- The `onError` callback receives an [ULError](../../Types/interfaces/Error) object
