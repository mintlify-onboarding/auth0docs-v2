...
description: "The Accept Invitation screen module provides access to the Accept Invitation flow."
---
...
<ParamField body="useAcceptInvitation" type="AcceptInvitationMembers">
  Provides access to the Accept Invitation context and functionality.
</ParamField>

<ParamField body="acceptInvitation" type="Function">
...
**File:** [src/screens/accept-invitation.tsx](https://github.com/auth0/universal-login/blob/master/packages/auth0-acul-react/src/screens/accept-invitation.tsx)
