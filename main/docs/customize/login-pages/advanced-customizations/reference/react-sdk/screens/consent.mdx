---
title: "Consent"
description: "The Consent screen module provides access to the Consent flow."
---
...
<ParamField body="useConsent" type="ConsentMembers">
  Provides access to the Consent context and functionality.
</ParamField>
