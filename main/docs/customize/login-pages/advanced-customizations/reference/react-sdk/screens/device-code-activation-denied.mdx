...
description: "The Device Code Activation Denied screen module provides access to the Device Code Activation Denied flow."
---
...
<ParamField body="useDeviceCodeActivationDenied" type="DeviceCodeActivationDeniedMembers">
  Provides access to the Device Code Activation Denied context and functionality.
</ParamField>
