...
description: "The Device Code Activation screen module provides access to the Device Code Activation flow."
---
...
<ParamField body="useDeviceCodeActivation" type="DeviceCodeActivationMembers">
  Provides access to the Device Code Activation context and functionality.
</ParamField>
...
**File:** [src/screens/device-code-activation.tsx](https://github.com/auth0/universal-login/blob/master/packages/auth0-acul-react/src/screens/device-code-activation.tsx)
