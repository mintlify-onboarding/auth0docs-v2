...
description: "The Email Verification Result screen module provides access to the Email Verification Result flow."
---
...
<ParamField body="useEmailVerificationResult" type="EmailVerificationResultMembers">
  Provides access to the Email Verification Result context and functionality.
</ParamField>
