...
description: "The Login Email Verification screen module provides access to the Login Email Verification flow."
---
...
<ParamField body="useLoginEmailVerification" type="LoginEmailVerificationMembers">
  Provides access to the Login Email Verification context and functionality.
</ParamField>

<ParamField body="continueWithCode" type="Function">
