...
description: "The Login Password screen module provides access to the Login Password flow."
---
...
<ParamField body="useLoginPassword" type="LoginPasswordMembers">
  Provides access to the Login Password context and functionality.
</ParamField>
...
**File:** [src/screens/login-password.tsx](https://github.com/auth0/universal-login/blob/master/packages/auth0-acul-react/src/screens/login-password.tsx)
