...
description: "The Login Passwordless Sms Otp screen module provides access to the Login Passwordless Sms Otp flow."
---
...
<ParamField body="useLoginPasswordlessSmsOtp" type="LoginPasswordlessSmsOtpMembers">
  Provides access to the Login Passwordless Sms Otp context and functionality.
</ParamField>

<ParamField body="submitOTP" type="Function">
  Function exported from this screen module.
</ParamField>

<ParamField body="resendOTP" type="Function">
  Function exported from this screen module.
</ParamField>
