...
description: "The Logout Aborted screen module provides access to the Logout Aborted flow."
---
...
<ParamField body="useLogoutAborted" type="LogoutAbortedMembers">
  Provides access to the Logout Aborted context and functionality.
</ParamField>
