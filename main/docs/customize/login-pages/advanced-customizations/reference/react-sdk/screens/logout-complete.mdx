...
description: "The Logout Complete screen module provides access to the Logout Complete flow."
---
...
<ParamField body="useLogoutComplete" type="LogoutCompleteMembers">
  Provides access to the Logout Complete context and functionality.
</ParamField>
