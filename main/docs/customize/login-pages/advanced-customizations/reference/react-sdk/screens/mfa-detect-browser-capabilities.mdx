...
description: "The Mfa Detect Browser Capabilities screen module provides access to the Mfa Detect Browser Capabilities flow."
---
...
<ParamField body="useMfaDetectBrowserCapabilities" type="MfaDetectBrowserCapabilitiesMembers">
  Provides access to the Mfa Detect Browser Capabilities context and functionality.
</ParamField>

<ParamField body="detectCapabilities" type="Function">
  Interface defining the available methods and properties for the mfa-detect-browser-capabilities screen / export interface MfaDetectBrowserCapabilitiesMembers extends BaseMembers { Picks an authenticator based on browser capabilities

  **Parameter:** The options containing browser capability flags
</ParamField>
