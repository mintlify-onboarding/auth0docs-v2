...
description: "The Mfa Enroll Result screen module provides access to the Mfa Enroll Result flow."
---
...
<ParamField body="useMfaEnrollResult" type="MfaEnrollResultMembers">
  Provides access to the Mfa Enroll Result context and functionality.
</ParamField>
