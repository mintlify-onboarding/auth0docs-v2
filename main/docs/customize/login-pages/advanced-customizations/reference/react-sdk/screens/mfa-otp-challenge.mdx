...
description: "The Mfa Otp Challenge screen module provides access to the Mfa Otp Challenge flow."
---
...
<ParamField body="useMfaOtpChallenge" type="MfaOtpChallengeMembers">
  Provides access to the Mfa Otp Challenge context and functionality.
</ParamField>
