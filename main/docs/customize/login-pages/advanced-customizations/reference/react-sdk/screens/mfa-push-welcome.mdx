...
description: "The Mfa Push Welcome screen module provides access to the Mfa Push Welcome flow."
---
...
<ParamField body="useMfaPushWelcome" type="MfaPushWelcomeMembers">
  Provides access to the Mfa Push Welcome context and functionality.
</ParamField>
...
**File:** [src/screens/mfa-push-welcome.tsx](https://github.com/auth0/universal-login/blob/master/packages/auth0-acul-react/src/screens/mfa-push-welcome.tsx)
