...
description: "The Mfa Sms Challenge screen module provides access to the Mfa Sms Challenge flow."
---
...
<ParamField body="useMfaSmsChallenge" type="MfaSmsChallengeMembers">
  Provides access to the Mfa Sms Challenge context and functionality.
</ParamField>
...
<ParamField body="pickSms" type="Function">
  Function exported from this screen module.
</ParamField>
...
**File:** [src/screens/mfa-sms-challenge.tsx](https://github.com/auth0/universal-login/blob/master/packages/auth0-acul-react/src/screens/mfa-sms-challenge.tsx)
