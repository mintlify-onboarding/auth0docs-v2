---
title: "Mfa Sms List"
description: "The Mfa Sms List screen module provides access to the Mfa Sms List flow."
---
...
<ParamField body="useMfaSmsList" type="MfaSmsListMembers">
  Provides access to the Mfa Sms List context and functionality.
</ParamField>

<ParamField body="selectPhoneNumber" type="Function">
  Function exported from this screen module.
</ParamField>

<ParamField body="backAction" type="Function">
  Function exported from this screen module.
</ParamField>
