...
description: "The Mfa Webauthn Change Key Nickname screen module provides access to the Mfa Webauthn Change Key Nickname flow."
---
...
<ParamField body="useMfaWebAuthnChangeKeyNickname" type="MfaWebAuthnChangeKeyNicknameMembers">
  Provides access to the Mfa Webauthn Change Key Nickname context and functionality.
</ParamField>

<ParamField body="continueWithNewNickname" type="Function">
