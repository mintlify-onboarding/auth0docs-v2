...
description: "The Mfa Webauthn Platform Enrollment screen module provides access to the Mfa Webauthn Platform Enrollment flow."
---
...
<ParamField body="useMfaWebAuthnPlatformEnrollment" type="MfaWebAuthnPlatformEnrollmentMembers">
  Provides access to the Mfa Webauthn Platform Enrollment context and functionality.
</ParamField>

<ParamField body="submitPasskeyCredential" type="Function">
...
<ParamField body="snoozeEnrollment" type="Function">
  Function exported from this screen module.
</ParamField>

<ParamField body="refuseEnrollmentOnThisDevice" type="Function">
  Function exported from this screen module.
</ParamField>
