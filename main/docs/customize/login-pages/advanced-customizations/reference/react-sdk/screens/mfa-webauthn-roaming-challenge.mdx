...
description: "The Mfa Webauthn Roaming Challenge screen module provides access to the Mfa Webauthn Roaming Challenge flow."
---
...
<ParamField body="useMfaWebAuthnRoamingChallenge" type="MfaWebAuthnRoamingChallengeMembers">
  Provides access to the Mfa Webauthn Roaming Challenge context and functionality.
</ParamField>
...
<ParamField body="reportWebAuthnError" type="Function">
  Function exported from this screen module.
</ParamField>
