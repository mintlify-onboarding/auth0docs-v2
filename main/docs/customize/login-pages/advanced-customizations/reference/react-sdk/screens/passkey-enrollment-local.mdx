...
description: "The Passkey Enrollment Local screen module provides access to the Passkey Enrollment Local flow."
---
...
<ParamField body="usePasskeyEnrollmentLocal" type="PasskeyEnrollmentLocalMembers">
  Provides access to the Passkey Enrollment Local context and functionality.
</ParamField>

<ParamField body="continuePasskeyEnrollment" type="Function">
  Function exported from this screen module.
</ParamField>

<ParamField body="abortPasskeyEnrollment" type="Function">
  Function exported from this screen module.
</ParamField>
