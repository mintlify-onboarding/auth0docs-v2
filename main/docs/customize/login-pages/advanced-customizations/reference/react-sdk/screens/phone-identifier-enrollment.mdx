...
description: "The Phone Identifier Enrollment screen module provides access to the Phone Identifier Enrollment flow."
---
...
<ParamField body="usePhoneIdentifierEnrollment" type="PhoneIdentifierEnrollmentMembers">
  Provides access to the Phone Identifier Enrollment context and functionality.
</ParamField>

<ParamField body="continuePhoneEnrollment" type="Function">
