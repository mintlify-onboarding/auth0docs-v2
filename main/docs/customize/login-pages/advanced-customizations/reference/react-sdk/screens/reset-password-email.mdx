...
description: "The Reset Password Email screen module provides access to the Reset Password Email flow."
---
...
<ParamField body="useResetPasswordEmail" type="ResetPasswordEmailMembers">
  Provides access to the Reset Password Email context and functionality.
</ParamField>

<ParamField body="resendEmail" type="Function">
