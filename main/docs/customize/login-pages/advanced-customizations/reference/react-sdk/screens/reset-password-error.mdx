...
description: "The Reset Password Error screen module provides access to the Reset Password Error flow."
---
...
<ParamField body="useResetPasswordError" type="ResetPasswordErrorMembers">
  Provides access to the Reset Password Error context and functionality.
</ParamField>
