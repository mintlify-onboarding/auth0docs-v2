...
description: "The Reset Password Mfa Sms Challenge screen module provides access to the Reset Password Mfa Sms Challenge flow."
---
...
<ParamField body="useResetPasswordMfaSmsChallenge" type="ResetPasswordMfaSmsChallengeMembers">
  Provides access to the Reset Password Mfa Sms Challenge context and functionality.
</ParamField>

<ParamField body="continueMfaSmsChallenge" type="Function">
...
<ParamField body="getACall" type="Function">
  Function exported from this screen module.
</ParamField>
