...
description: "The Reset Password Mfa Webauthn Platform Challenge screen module provides access to the Reset Password Mfa Webauthn Platform Challenge flow."
---
...
<ParamField body="useResetPasswordMfaWebAuthnPlatformChallenge" type="ResetPasswordMfaWebAuthnPlatformChallengeMembers">
  Provides access to the Reset Password Mfa Webauthn Platform Challenge context and functionality.
</ParamField>

<ParamField body="continueWithPasskey" type="Function">
  Function exported from this screen module.
</ParamField>

<ParamField body="reportBrowserError" type="Function">
  Function exported from this screen module.
</ParamField>
