...
description: "The Reset Password Request screen module provides access to the Reset Password Request flow."
---
...
<ParamField body="useResetPasswordRequest" type="ResetPasswordRequestMembers">
  Provides access to the Reset Password Request context and functionality.
</ParamField>

<ParamField body="resetPassword" type="Function">
  Function exported from this screen module.
</ParamField>

<ParamField body="backToLogin" type="Function">
  Function exported from this screen module.
</ParamField>
