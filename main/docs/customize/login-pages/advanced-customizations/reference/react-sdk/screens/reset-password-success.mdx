...
description: "The Reset Password Success screen module provides access to the Reset Password Success flow."
---
...
<ParamField body="useResetPasswordSuccess" type="ResetPasswordSuccessMembers">
  Provides access to the Reset Password Success context and functionality.
</ParamField>
...
**File:** [src/screens/reset-password-success.tsx](https://github.com/auth0/universal-login/blob/master/packages/auth0-acul-react/src/screens/reset-password-success.tsx)
