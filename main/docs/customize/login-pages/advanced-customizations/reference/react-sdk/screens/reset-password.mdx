...
description: "The Reset Password screen module provides access to the Reset Password flow."
---
...
<ParamField body="useResetPassword" type="ResetPasswordMembers">
  Provides access to the Reset Password context and functionality.
</ParamField>
...
**File:** [src/screens/reset-password.tsx](https://github.com/auth0/universal-login/blob/master/packages/auth0-acul-react/src/screens/reset-password.tsx)
