---
title: "Signup Id"
description: "The Signup Id screen module provides access to the Signup Id flow."
---
...
<ParamField body="useSignupId" type="SignupIdMembers">
  Provides access to the Signup Id context and functionality.
</ParamField>

<ParamField body="signup" type="Function">
  Function exported from this screen module.
</ParamField>

<ParamField body="federatedSignup" type="Function">
  Function exported from this screen module.
</ParamField>
