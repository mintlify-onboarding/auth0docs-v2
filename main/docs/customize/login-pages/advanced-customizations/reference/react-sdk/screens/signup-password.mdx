...
description: "The Signup Password screen module provides access to the Signup Password flow."
---
...
<ParamField body="useSignupPassword" type="SignupPasswordMembers">
  Provides access to the Signup Password context and functionality.
</ParamField>
...
**File:** [src/screens/signup-password.tsx](https://github.com/auth0/universal-login/blob/master/packages/auth0-acul-react/src/screens/signup-password.tsx)
