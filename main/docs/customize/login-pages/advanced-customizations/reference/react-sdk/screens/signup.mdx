---
title: "Signup"
description: "The Signup screen module provides access to the Signup flow."
---
...
<ParamField body="useSignup" type="SignupMembers">
  Provides access to the Signup context and functionality.
</ParamField>
