...
You can configure global variables for rules using Auth0's Dashboard. To learn more, see [Auth0 Rules](/customize/rules).
...
* [Create Rules](/customize/rules/create-rules)