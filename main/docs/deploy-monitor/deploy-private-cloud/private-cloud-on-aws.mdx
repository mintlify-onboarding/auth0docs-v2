...
To view the currently scheduled change freeze periods, read [Change Freeze Policy](/troubleshoot/customer-support/operational-policies/change-freeze-policy).
...
* Stay within our [published production rate limits](/troubleshoot/customer-support/operational-policies/rate-limit-policy).
...
For more information on load testing in Private Cloud, see [Environment request limits (Private Cloud Only)](/troubleshoot/customer-support/operational-policies/rate-limit-policy#environment-request-limits-private-cloud-only-).
...
For the information that we require, see our [Penetration Testing Policy](/troubleshoot/customer-support/operational-policies/penetration-testing-policy).
...
Renewal of Auth0-issued certificates for <Tooltip tip="Custom Domain: Third-party domain with a specialized, or vanity, name." cta="View Glossary" href="/glossary?term=custom+domains">custom domains</Tooltip> is managed by Auth0.

Renewal of customer-managed certificates for [custom domains](/customize/custom-domains) (in the format \*.\<CustomerName>.com) is the customer’s responsibility to manage and obtain.

## Reporting and monitoring

Auth0 provides logs that are accessible via the Dashboard or the [log streaming endpoint](/customize/log-streams).

## Support

You can reach out to the Auth0 [Support](https://support.auth0.com/) team with any questions or concerns you might have. To help expedite your request, please provide as much information as possible in the [Support ticket you open](/troubleshoot/customer-support/open-and-manage-support-tickets).