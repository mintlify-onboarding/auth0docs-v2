...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Chaîne</td>
      <td>
        Valeur à définir comme nouveau mot de passe de l’utilisateur dans la base de données externe. Cette valeur est
        envoyée en clair à la fonction et <a href="#Encryption">doit être cryptée</a> avant d’être envoyée à la base de
        données externe.
      </td>
    </tr>
    <tr>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Facultatif</td>
      <td>
        Indique que l’opération de modification du mot de passe a réussi. Si la propriété `last_password_reset` est
        présente, elle sera mise à jour dans le profil de l’utilisateur.
      </td>
    </tr>
  </tbody>
</table>
