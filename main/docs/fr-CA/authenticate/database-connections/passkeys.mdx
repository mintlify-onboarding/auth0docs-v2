...
1. L’utilisateur est invité à saisir son adresse courriel.
   ...
   <Frame>
     ![](/docs/images/fr-ca/cdy7uua7fh8z/5SlpzscSseNOuJlvhOgBqr/eb6dfb214032d7e5416eb28a813247f8/Login_Screen_-_Email_First.png)
   </Frame>

2. L’utilisateur saisit son adresse courriel.

   <Frame>
     ![](/docs/images/fr-ca/cdy7uua7fh8z/3r5pFsWx6SkYOHSHglRwzG/635b78ac99f0a5cb8c7530554c2e2d46/Login_Screen_-_Email_Only.png)
   </Frame>

3. Invite l’utilisateur à créer une clé d’identification.

   <Frame>
     ![](/docs/images/fr-ca/cdy7uua7fh8z/7vZK4q4iUtxyld1Os6og4s/2873e782372e7fee5d2ae7d7b8fb4fe4/Passkeys_-_UL_-_French.png)
   </Frame>
...
4. Si l’utilisateur sélectionne **Create a passkey (Créer une clé d’identification)**, le flux du navigateur (ou du système d’exploitation) est déclenché pour créer une clé d’identification.
   ...
   <Frame>
     ![](/docs/images/fr-ca/cdy7uua7fh8z/IsWmSXNHc2fvRuEgn5DpK/c4962a8e75291fcbaca1f8247bf64b8e/Create_Passkey.png)
   </Frame>
   ...
   - Si l’utilisateur sélectionne **Continue (Continuer)**, il est invité à s’authentifier avec les informations d’identification de son appareil.
     ...
     <Frame>
       ![](/docs/images/fr-ca/cdy7uua7fh8z/6OJlPQrWBhgO8izXXoKbOw/dfecdf84ab3e0318904c5796a600b773/Chrome_popup.png)
     </Frame>
   ...
   - Si l’utilisateur sélectionne **Try another way (Essayer autrement)**, il est invité à créer une clé d’identification sur un autre appareil.
     ...
     <Frame>
       ![](/docs/images/fr-ca/cdy7uua7fh8z/2yXrkVbYLxxp6MXnrZLqVN/d51cf0f2ca9beb7e68fc2544f99ab3ff/QR_Code_-_FR.png)
     </Frame>
...
1. Invite l’utilisateur à fournir une adresse courriel ou une clé d’identification.
   ...
   <Frame>
     ![](/docs/images/fr-ca/cdy7uua7fh8z/3qqI3Uo1z1yQhvb7boQ0cx/2042df807eff1234946e043d5a4cd7e1/Login_Screen_w_Passkey_button.png)
   </Frame>
...
2. L’utilisateur peut utiliser le remplissage automatique ou sélectionner **Continue with a passkey (Continuer avec une clé d’identification)**.
   ...
   <Frame>
     ![](/docs/images/fr-ca/cdy7uua7fh8z/3zvWl2rpxzJ5klloIihRYB/09b17a2745d30abbe505d32523b5aeee/Login_Screen_w_Passkey_button_and_email.png)
   </Frame>

<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/tC4UZmYFgo7Zjt9kviP9j/5cc43e7a77ce4bbcb3447b76ae50e30b/Browser_popup_-_FR.png)
</Frame>
