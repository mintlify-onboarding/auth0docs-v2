...
<Frame>
  ![Password
  Options](/docs/images/fr-ca/cdy7uua7fh8z/1vqXxz0OD7hNLYLwrZZzIe/69da978ea21345366682968a270058a0/2025-02-25_10-33-44.png)
</Frame>
...
```json lines
{
  ...
  "strategy": "auth0",
  "name": "MySQL",
  "enabled_clients": ["smTzlgPEdqGV0i070t6kPhmG98787987", "ztIyxRuiK7Pr2VTzEGvRqxfuh7DgePbF"]
}
```
