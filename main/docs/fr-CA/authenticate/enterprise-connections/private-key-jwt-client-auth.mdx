...
<Frame>
  ![A diagram mapping the Private Key JWT Client Authentication flow.
  ](/docs/images/fr-ca/cdy7uua7fh8z/4JOxbdG7aweqpDHCJ8VOZq/aea18936c0cbdbfbb39d0cd79af3987e/Client_Assertion_JWT_-_Diagram.png)
</Frame>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Set this property to `private_key_jwt`. <br />
        <br /> <strong>Notes:</strong>
        <ul>
          <li> By default, this property is set to `client_secret_post`. </li>
          <li>
    ...
    <tr>
      ...
      <td>
        Set this property to `RS256`. <br />
        <br /> <strong>Notes:</strong> <ul>
          <li>This feature does not currently support additional algorithms.</li>
          <li>Omitting this property will default its value to `RS256`.</li>
        </ul>
      </td>
    </tr>
  </tbody>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      <td>`token_endpoint_auth_method`</td>
      <td>
        Set this property to `private_key_jwt`.
        <br />
        <br /> <b>Notes:</b>{" "}
        <ul>
          <li>
