...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      <td>
        <strong>Peut recevoir des demandes facultatives d’Entra ID?</strong>
      </td>
      <td>Non</td>
      <td>Oui</td>
      <td>Oui</td>
    ...
    <tr>
      <td>
        <strong>Prise en charge de la déconnexion unique fédérée (“Déconnexion unique” or SLO)</strong>
      </td>
      <td>Oui</td>
      <td>Non</td>
      <td>Oui</td>
    ...
    <tr>
      <td>
        <strong>Recevoir des groupes ID</strong>
      </td>
    ...
    <tr>
      <td>
        <strong>Recevoir un profil étendu</strong>
      </td>
      <td>Oui</td>
      <td>Non</td>
      <td>Non</td>
