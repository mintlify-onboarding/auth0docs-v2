...
<Frame>
  ![Diagram of the Sign In with Apple Authentication
  Flow](/docs/images/fr-ca/cdy7uua7fh8z/I7xtPQoqoAFiHQiT2p7p5/8646a5231491dfbe64bd6a825ccc8ce7/apple-siwa-authn-flow.png)
</Frame>
...
2. Faites défiler jusqu’au bas de la page et sélectionnez **Show Advanced Settings (Afficher les paramètres avancés)** et sélectionnez l’affichage **Device Settings (Réglages de l’appareil)** Sous **Native Social Login (Connexion sociale native)**, activez la bascule **Native Social Login (Activer la connexion avec Apple)**.
   ...
   <Frame>
     ![Application Client Settings: Advanced Device
     Settings](/docs/images/fr-ca/cdy7uua7fh8z/2xkQ13r9yCb4GBZdeczZjJ/a3f16a07411d8008d62c66c76d3794a2/Native_App_-_Device_Settings_-_French.png)
   </Frame>
...
6. Sur l’onglet **Settings (Réglages)**, renseignez les champs suivants :
   ...
   - **ID de clé**
     ...
     <Frame>
       ...
       Settings](/docs/images/fr-ca/cdy7uua7fh8z/3mTTVYnrwbVYnUx5Mzy0V9/4701f5d75f87256673f01bd10ec7c9a3/Apple_Connection.png)
     </Frame>
