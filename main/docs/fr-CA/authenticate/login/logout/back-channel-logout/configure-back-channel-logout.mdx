...
5. Quand vous aurez terminé, sélectionnez **Save Changes (Enregistrer les modifications)**.
   ...
   <Frame>
     ...
     Settings](/docs/images/fr-ca/cdy7uua7fh8z/19uQRkVswdmaO8gHTVTXCc/7a95b6aaf756f308fd289d996a77e2c1/Back_Channel_Logout_-_FR_.png)
   </Frame>
...
6. Quand vous aurez terminé, sélectionnez **Save Changes (Enregistrer les modifications)**.
   ...
   <Frame>
     ![Auth0 Dashboard > Applications >
     Settings](/docs/images/fr-ca/cdy7uua7fh8z/5SlrBhwrNbJx0Wdw2kQ19t/21c47557293714368c47ece7ad1f3cc3/Back_Channel_Logout_-_FR_.png)
   </Frame>
