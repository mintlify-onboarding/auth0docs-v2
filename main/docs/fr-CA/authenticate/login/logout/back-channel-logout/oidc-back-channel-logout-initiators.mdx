...
<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/2GwtCTwecxYONxL1DbewxO/e3ceaf196490d36bb62a9a44f574a856/OIDC_Back-Channel_Logout_Initiators_Diagram.png)
</Frame>
...
<table class="table">
  <thead>
    <tr>
      ...
      <th>
        <strong>Valeurs prises en charge</strong>
      </th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td>
        `rp-logout`, `idp-logout`, `password-changed`, `session-expired`, `session-revoked`, `account-deleted`,
...
<Frame>
  ![Dashboard > Applications > Application
  Settings](/docs/images/fr-ca/cdy7uua7fh8z/vgN0wudP38zgRZNL59Mhy/8de2d7fd6fabe28b1f33f1f4337a057a/Backchannel_Logout_Settings.png)
</Frame>
