...
Vous trouverez toutes les options disponibles pour configurer WS-Fed dans la zone <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Paramètres avancés</AuthLink> de votre application.
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      <td>`wfresh=0`</td>
      <td>
        Si l’utilisateur doit se réauthentifier, même s’il existe une session en place (`0` nécessite une
        réauthentification)
      </td>
    </tr>
  </tbody>
...
<Frame>
  ![Protocoles WS-Fed Importation Fédération Fichier de métadonnées Écran de connexion
  ADFS](/docs/images/fr-ca/cdy7uua7fh8z/35pGg8AnNcx2ZIfQIixt1J/347e75c1394bd51055614eceb448396c/ADFS_-_FR.png)
</Frame>
