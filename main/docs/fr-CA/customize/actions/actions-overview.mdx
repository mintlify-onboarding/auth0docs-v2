...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Se déclenche de manière asynchrone après la création d’un utilisateur. Ne fonctionne pas avec les connexions
        sociales.
      </td>
    </tr>
    <tr>
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        processus du défi-réponse. N’exécute pas de connexion sociale.
      </td>
    </tr>
  </tbody>
</table>
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>
        Se déclenche après la modification du mot de passe. Ne s’exécute pas pour les connexions via les réseaux
        sociaux.
      </td>
    </tr>
    <tr>
