...
<Frame>
  ![Diagram showing the Actions Login
  Flow.](/docs/images/fr-ca/cdy7uua7fh8z/2SkfIOm4fFOJ8N0GNJwam8/77230cdb4411b2383751b037fb56fe29/2024-09-30_10-01-42.png)
</Frame>
...
exports.onExecutePostLogin = async (event, api) => {
  ...
  const skipMFA = event.authentication?.methods.some((method) => method.name === "passkey");
