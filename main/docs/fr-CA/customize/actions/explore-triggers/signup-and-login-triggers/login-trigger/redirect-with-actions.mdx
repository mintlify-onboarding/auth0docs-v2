...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      <td>`exp`</td>
      <td>
        Heure d’expiration (en secondes) spécifiée avec le paramètre `expiresInSeconds`. Doit être aussi court que
        possible pour éviter la réutilisation du jeton. La valeur par défaut est 900 secondes (15 minutes).
      </td>
    </tr>
    <tr>
      <td>`ip`</td>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      <td>`state`</td>
      <td>
        Paramètre d’état envoyé au site distant dans le cadre de la redirection. Doit être inclus dans le jeton pour
        éviter les attaques par réinsertion.
      </td>
    </tr>
    <tr>
      <td>`other`</td>
