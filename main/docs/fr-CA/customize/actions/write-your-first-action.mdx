...
<Frame>
  ![Actions Code Editor (Éditeur de code
  d’actions)](/docs/images/fr-ca/cdy7uua7fh8z/12Q8OEuDI39eWuWsrVVwN0/1ecddcb21d855995eed671ccfd5246fb/2025-02-28_13-26-02.png)
</Frame>
...
<Frame>
  ![Éditeur de code d’actions - Votre secret a été ajouté dans la section
  Secrets.](/docs/images/fr-ca/cdy7uua7fh8z/4FyFtKRSIYuigxE9U8TkEJ/947a4d9da30cba20b58f96c28df2aac2/2025-02-28_11-47-54.png)
</Frame>
...
3. Sélectionnez **Créer**, et la dépendance doit être ajoutée à l’action :
   ...
   <Frame>
     ![Éditeur de code d’actions : votre dépendance a été
     ajoutée.](/docs/images/fr-ca/cdy7uua7fh8z/Jmzvgydo204pBLikzuDJy/1197887ddc5c7565be8bb0f5778c8af8/2025-02-28_11-47-54.png)
   </Frame>
...
1. Sélectionnez l’icône Test (triangle) dans la barre latérale. Dans la section Payload (Charge utile), vous verrez des données JSON modifiables relatives au déclencheur que vous avez sélectionné lors de la création de l’action.
   ...
   <Frame>
     ![Éditeur de code d’actions : panneau Test
     Runner](/docs/images/fr-ca/cdy7uua7fh8z/4MSu8EfpMLNJpcYtrwP7Jf/e5b26302688a0ed46c296d036a9b9958/2025-02-28_11-43-18.png)
   </Frame>
...
<Frame>
  ![Actions : Historique des
  versions](/docs/images/fr-ca/cdy7uua7fh8z/53sn70cXoxUHibc3Bmk7Og/b0951ca10ae4d1faf5346f2b23e2d56f/2025-02-28_11-39-05.png)
</Frame>
...
2. Sélectionnez le [Déclencheur de connexion](/docs/fr-CA/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger) et faites glisser `my-slack-action` dans le flux.
   ...
   <Frame>
     ![Flux d’actions : flux
     Connexion](/docs/images/fr-ca/cdy7uua7fh8z/6hU7sKWtGzSx9Z8dhsXbvp/323287b26e5e5e3a4daf2acdb20b7304/Login_Action_-_FR.png)
   </Frame>
...
<Frame>
  ![Journaux des locataires : vue Détails de
  l’action](/docs/images/fr-ca/cdy7uua7fh8z/61k82wmsXSb9M3wOExM4jH/58834c0e20b6e89656e14c9ff37ccfce/Action_Logs_-_FR.png)
</Frame>
