   ...
   <table class="table">
     ...
     <tbody>
       ...
       <tr>
         ...
         <td>
           Sélectionnez l’option <strong>Edge CName</strong>, puis sélectionnez votre nom de domaine personnalisé dans
           la liste.
         </td>
       </tr>
     </tbody>
   ...
   <table class="table">
     ...
     <tbody>
       ...
       <tr>
         ...
         <td>
           Sélectionnez <strong>Ignorer</strong>, saisissez <strong>cname-api-key</strong> comme nom, puis saisissez la
           clé API CNAME fournie par Auth0 comme valeur.
         </td>
       </tr>
     </tbody>
   </table>
