...
<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/5PvLzDdJEAbPoEbpLylw1D/445d308335e1bd8f442b0098565699c5/Custom_Email_Provider_-_French.png)
</Frame>
...
<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/7El50nFDBDQG90i99iJEoe/25fd352c1c65d3c92bf152eaeaaa2619/Custom_Email_Provider.png)
</Frame>
...
exports.onExecuteCustomEmailProvider = async (event, api) => {
  ...
  try {
    ...
    if (statusCode === 200) {
      ...
      api.notification.retry(`Internal Server Error received from Messaging Proxy. Status code: ${statusCode}.`);
      return;
    }
  } catch (error) {
