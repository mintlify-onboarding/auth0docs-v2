...
<Frame>
  ![Dashboard > Forms >
  Flows](/docs/images/fr-ca/cdy7uua7fh8z/3B8DRhXO2wGqeqSFb8KbQv/0a61cdbbb7f1d290950a2ddb9857aac3/Contex-variable.png)
</Frame>
...
<Frame>
  ...
  Form](/docs/images/fr-ca/cdy7uua7fh8z/4D42A6ww4XvFxweoxh04Rd/016c2ed9d25bc2267ed3ed31bf8b2bf6/form-fields-variable.png)
</Frame>
...
<Frame>
  ![Dashboard > Actions > Forms >
  Flows](/docs/images/fr-ca/cdy7uua7fh8z/6jYtEdYqSGXm3DDv0mxQ0o/2d48012629745e07137bf6ba42f4d829/flow-output-variable.png)
</Frame>
...
<Frame>
  ![Dashboard > Actions > Forms >
  Flows](/docs/images/fr-ca/cdy7uua7fh8z/4571ExRTHL0KZKJKX9pNwj/abb631b8608a6356b0e5b3784cf8b02f/flow-shared-variable.png)
</Frame>
...
<Frame>
  ![Dashboard > Actions > Forms >
  Flows](/docs/images/fr-ca/cdy7uua7fh8z/1gyox33XJEtdkT43NppblT/0e878cc5ae2bde11b4207e105bbac6c5/flow-helper-functions.png)
</Frame>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Renvoie une section d’un tableau de valeurs ou d’une chaîne de caractères entre les indices de début et de fin.
      </td>
    ...
    <tr>
      ...
      <td>
        Renvoie une section d’une valeur entre les indices de début et de fin. En savoir plus sur les{" "}
        <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/substring#differences_between_substring_and_slice">
          différences entre les fonctions slice et substring
        </a>
      </td>
    ...
    <tr>
      ...
      <td>
        Renvoie une nouvelle chaîne dans laquelle toutes les correspondances d’un modèle sont remplacées par un
        substitut.
      </td>
    ...
    <tr>
      ...
      <td>
        Renvoie une nouvelle chaîne dans laquelle toutes les correspondances d’un modèle sont remplacées par un
        substitut. Si le motif est une chaîne, seule la première occurrence sera remplacée.
      </td>
    ...
    <tr>
      ...
      <td>
        Renvoie le premier indice auquel un élément donné peut être trouvé dans le tableau, ou -1 s’il n’est pas
        présent.
      </td>
    ...
    <tr>
      ...
      <td>
        Renvoie un tableau fusionné, un objet ou concatène une chaîne de caractères en fonction du type de données de
        base.
      </td>
      <td>
...
<Frame>
  ![Dashboard > Actions > Forms >
  Flows](/docs/images/fr-ca/cdy7uua7fh8z/3SKnDuaMzSImxZtDDAoZaz/9ea800fad29ef71d1ded3c72b87660a4/Autocomplete-flows.png)
</Frame>

<Frame>
  ![Dashboard > Actions > Forms >
  Form](/docs/images/fr-ca/cdy7uua7fh8z/2kjRKozVgrd2a7UJXOANaN/ee5452d7210cd2f13b0e97763f11c82a/Autocomplete-forms.png)
</Frame>
