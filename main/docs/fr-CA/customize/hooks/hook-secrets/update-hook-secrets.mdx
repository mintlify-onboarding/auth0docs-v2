  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        `update:hooks`. Pour en savoir plus, veuillez consulter [Jetons d’accès à Management API]
        (/api/gestion/v2/jetons).
      </td>
    </tr>
    <tr>
      <td>`HOOK_ID`</td>
    ...
    <tr>
      ...
      <td>
        Nom du secret que vous souhaitez mettre à jour pour le crochet spécifié. Ce point de terminaison accepte un
        objet de paires clé-valeur.
      </td>
    </tr>
    <tr>
      <td>`HOOK_SECRET_VALUE`</td>
      <td>
        Valeur du secret que vous souhaitez mettre à jour pour le crochet spécifié. Ce point de terminaison accepte un
        objet de paires clé-valeur.
      </td>
    </tr>
  </tbody>
