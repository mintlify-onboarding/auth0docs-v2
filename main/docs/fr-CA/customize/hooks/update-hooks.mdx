...
3. Saisissez un nouveau nom po](/docs/images/ et cliquez sur **Renommer**.
   ...
   <Frame>
     ![Auth0 Rename
     Hooks](/docs/images/fr-ca/cdy7uua7fh8z/2Xp8Z3uYGoGZrF5EGXLPLQ/6c68c77f97133b2066219a68540b1e73/Screen_Shot_2021-05-19_at_12.08.00_PM.png)
   </Frame>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      <td>`HOOK_SCRIPT`</td>
      <td>
        Script qui contient le code pour l’appel. Il doit correspondre à ce que vous entreriez en créant un nouvel appel
        en utilisant Dashboard.
      </td>
    </tr>
  </tbody>
</table>
