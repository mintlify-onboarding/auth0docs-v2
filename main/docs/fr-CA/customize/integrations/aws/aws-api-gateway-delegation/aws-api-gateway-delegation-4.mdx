...
Assurez-vous d’ajuster le code ci-dessus avec les valeurs correctes pour votre intégration. Les champs sont **Princial ARN**, **Rôle ARN**, et **Client Secret**. 4. **Enregistrer** les modifications.
