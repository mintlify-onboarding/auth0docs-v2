   ...
   <table class="table">
     ...
     <tbody>
       <tr>
         ...
         <td>
           Le type de fournisseur. Défini comme{" "}
           <Tooltip
       ...
       <tr>
         ...
         <td>
           Téléverser le fichier contenant les métadonnées Auth0, qui se trouve dans{" "}
           <strong>
             Dashboard (Tableau de bord) &gt; Applications (Applications) &gt; Application Settings (Paramètres
             d’application) &gt; Advanced Settings (Paramètres avancés) &gt; Endpoints (Points de terminaison) &gt; SAML
             Metadata (Métadonnées SAML) URL
           </strong>
         </td>
       </tr>
     </tbody>
