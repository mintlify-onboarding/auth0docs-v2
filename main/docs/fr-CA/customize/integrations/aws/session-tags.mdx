...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>1</td>
      <td>
        Clé : `CostCenter`, Valeur : `marketing`.
        <br />
    ...
    <tr>
      <td>2</td>
      <td>
        Clé: `CostCenter`, Valeur : `engineering`.
        <br />
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>
        Nom du fournisseur d’identité que vous avez créé dans les prérequis, par exemple `auth0SamlProvider`.
        Sélectionnez{" "}
        <strong>
          Allow programmatic and AWS Management Console access (Autoriser l’accès programmatique et l’accès à la console
          de gestion AWS)
        </strong>
        .
      </td>
