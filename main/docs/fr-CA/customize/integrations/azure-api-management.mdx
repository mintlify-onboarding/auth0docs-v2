   ...
   <table class="table">
     ...
     <tbody>
       ...
       <tr>
         ...
         <td>
           Reportez-vous à{" "}
           <a href="https://{yourDomain}/.well-known/openid-configuration">Point de terminaison de découverte OIDC</a>{" "}
           de votre locataire et ajoutez le paramètre `audience`. Par exemple : `https://{yourDomain}
