...
3. Configurer les paramètres suivants :
   ...
   <Frame>
     ![Dashboard Monitoring Streams Custom Webhook Settings
     Tab](/docs/images/fr-ca/cdy7uua7fh8z/5vJVD09aqSF0xEZZFk6wh2/e6469041b2dd1e4f1b142961ca0a12ab/custom-webhook-settings.png)
   </Frame>
   ...
   <table class="table">
     <thead>
       <tr>
         <th>
           <strong>Setting (Paramètre)</strong>
         </th>
         <th>
     ...
     <tbody>
       ...
       <tr>
         <td>
           <strong>Filter by Event Category</strong>
         </td>
         <td>Liste des filtres de flux de journaux.</td>
       </tr>
       <tr>
         <td>
           <strong>Starting Curso</strong>
         </td>
