...
<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/1qsKiEY1kiRSIYqhORr4nQ/ef11f60e9262e0a794dc34964a91bdee/Screenshot_2025-05-22_at_12.22.51.png)
</Frame>
...
<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/Mq86ebcuUuTYSqaRdFJlb/73788cad3f355c41ceb7a4a9e658bddb/Screenshot_2025-05-27_at_19.58.21.png)
</Frame>
...
<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/4YEVrKX7HVo2LYWyZGxajt/865744113a4dbf5beff6bbce6587d8dc/Screenshot_2025-05-27_at_20.15.31.png)
</Frame>
...
<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/3TbCxY8cZNbhwmuZJ2ekCY/36dac0216ce83db1f93ab2423c9e0843/mfa-webauthn-not-available-error.png)
</Frame>
...
<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/1DFJ4Od7ukDasV7uAPH53P/f4018367fbf636f488cf94b6c6c62fda/Screenshot_2025-05-27_at_20.34.24.png)
</Frame>
...
interface screen {
  ...
  captchaProvider: null | string;
  captchaSiteKey: null | string;
  data: null | Record<string, string | boolean | PasskeyCreate | string[] | Record<string, string[]> | PhonePrefix[]>;
  isCaptchaAvailable: boolean;
  links: null | Record<string, string>;
  name: string;
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>No</td>
      <td>
        Remember the browser for future MFA challenges. Corresponds to the rememberBrowser form field. This is only
        applicable if screen.showRememberDevice is true.
      </td>
    </tr>
    <tr>
      <td>`[key: string]`</td>
...
<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/6hWi1hV5cPw336LB0JHYvM/7833f62a4339322bc55744c0477c4787/Screenshot_2025-05-27_at_21.04.27.png)
</Frame>
...
try {
  ...
  if (error.name && error.message) {
    // Check if it looks like a WebAuthn error
    await mfaWebAuthnPlatformEnrollmentManager.reportBrowserError({
...
<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/joy7T4RglZYOlWItGk5Xm/0a4b2477cba476281ce05f2605acfb12/Screenshot_2025-05-28_at_11.40.56.png)
</Frame>
...
<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/71Il3P3UP1Z2mpY9LdjHUQ/31e9f3e51bec04cdd0f4e78b744f6472/Screenshot_2025-05-28_at_12.19.06.png)
</Frame>
