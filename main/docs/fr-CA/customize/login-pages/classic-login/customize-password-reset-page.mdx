...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        La politique de sécurité active pour la connexion. Vous pouvez voir ce que c’est en utilisant
        `https://manage.auth0.com/#/connections/database/con_VOTRE-ID-CONNEXION/security`. Assurez-vous de fournir votre
        identifiant de connexion dans l’URL.)
      </td>
    </tr>
    <tr>
