...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      <td>`show_log_link`</td>
      <td>
        Indique s’il faut afficher un lien vers l’erreur dans les journaux des locataires. Les valeurs valides sont
...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>`{mgmtApiAccessToken}`</td>
      <td>
        <a href="/docs/fr-CA/api/management/v2/tokens">Jeton d’accès du Management API</a> avec la permission
