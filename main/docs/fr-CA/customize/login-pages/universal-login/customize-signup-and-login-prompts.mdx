...
<Frame>
  ![Screenshots of each Custom Prompt option and their
  partials](/docs/images/cdy7uua7fh8z/7sQVWVbaTp4VMW4nJjsn2G/74d0b30da7b034bd695274dbd146964b/Custom_Prompts.png)
</Frame>
...
<Frame>
  ...
  ](/docs/images/fr-ca/cdy7uua7fh8z/KxWfVAMkumyI2jrUqkEp8/b9315709899864a2f8758ad7f5a4f5b2/Partials_CLI_Image.jpg)
</Frame>
...
<div class="ulp-field">
  ...
  <div class="ulp-error-info">Please Select a Language.</div>
</div>
```
...
<div class="ulp-field">
  ...
  <div class="ulp-error-info">Please provide an answer.</div>
</div>
```
