...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>
        Renders the current page's state value, which is opaque and used for security purposes.
        <br />
        <br />
        To learn more about current screen information, review <a href="/docs/customize/login-pages/universal-login/customize-templates#current-screen-information">
          Customize Univeral Login Page Templates
        </a>.
      </td>
      <td>
        <code>&lt;input type='hidden' name='state' value='&#123;&#123;state&#125;&#125;'&gt;</code>
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        ...
        <br />
        <br />
        For passwordless connections, value is either <code>email</code> or <code>sms</code>.
      </td>
      <td>
        <code>&lt;input type='hidden' name='connection' value='email'&gt;</code>
      </td>
    </tr>
  </tbody>
</table>
