...
3. If you are able to use the Unified Phone Experience, a banner advises you to configure a tenant-level provider:
   ...
   <Frame>
     ![](/docs/images/fr-ca/cdy7uua7fh8z/1mZryDWIpdkpGmhxn4Gr8K/4bdad7fbcd81dd0bf4855d94b7205e8b/2025-02-11_23-20-07.png)
   </Frame>
...
2. Select and configure your provider:
   ...
   <Frame>
     ![Branding > Phone Provider >
     Twilio](/docs/images/fr-ca/cdy7uua7fh8z/6TESTIdmhUL0LEitACadIK/fcdc34e18a6b66b47370f6d754c085b5/2025-02-21_12-49-53.png)
   </Frame>
...
<table class="table">
  <thead>
    <tr>
      <th>
        <b>`send-phone-message` context object</b>
      </th>
      <th>
        <b>`custom-phone-provider` context object</b>
      </th>
      <th>
        <b>Status</b>
      </th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <ul>
          <li>
            Note the difference in values: `second-factor-authentication` vs `otp_enroll`, `verify` vs `otp_verify`)
          </li>
        </ul>
      </td>
      <td>Updated</td>
...
<table class="table">
  <thead>
    <tr>
      ...
      <th>
        <b>Tenant-level provider context object</b>
      </th>
      <th>
        <b> Status </b>
      </th>
...
<Frame>
  ![Unified phone MFA no tenant provider configured
  warning](/docs/images/fr-ca/cdy7uua7fh8z/6HE10zh6tL6ByihAh4Cj6K/c0faf43eb8e4d606ef1ac20ec538bcac/2025-02-12_09-14-41.png)
</Frame>
...
<table class="table">
  <thead>
    <tr>
      <th>
        <b>Current MFA Phone factors</b>
      </th>
      <th>
        <b>Desired MFA factors</b>
      </th>
      <th>
        <b>Tenant-level delivery method</b>
      </th>
      <th>
        <b>User action</b>
      </th>
...
<table class="table">
  <thead>
    <tr>
      <th>
        <b>MFA Phone factors</b>
      </th>
      <th>
        <b>Current tenant-level delivery method</b>
      </th>
      <th>
        <b>Desired tenant-level delivery method</b>
      </th>
      <th>
        <b>User action</b>
      </th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Voice</td>
      <td>
        User must update MFA phone factors to be a subset of the delivery methods enabled for the tenant-level provider
      </td>
    </tr>
    <tr>
      <td>SMS</td>
...
<table class="table">
  <thead>
    <tr>
      <th>
        <b>Send-phone-message Guardian endpoint</b>
      </th>
      <th>
        <b>Scope</b>
      </th>
  ...
  <tbody>
    <tr>
      <td>
        <ul>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/guardian/get-phone-twilio-factor-provider">
              Get Twilio configuration
            </a>
          </li>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/guardian/get-sms-twilio-factor-provider">
    ...
    <tr>
      <td>
        <ul>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/guardian/get-guardian-phone-providers">
              Get phone provider configuration
            </a>
          </li>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/guardian/get-sms-providers">
              Get phone provider SMS configuration
            </a>
          </li>
        </ul>
      </td>
    ...
    <tr>
      <td>
        <ul>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/guardian/put-twilio">Update Twilio configuration</a>
          </li>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/guardian/put-sms-twilio-factor-provider">
    ...
    <tr>
      <td>
        <ul>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/guardian/put-phone-providers">
              Update phone provider configuration
            </a>
          </li>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/guardian/put-sms-providers">Update SMS configuration</a>
          </li>
        </ul>
      </td>
      <td>`update:guardian_factors`</td>
    ...
    <tr>
      <td>
        <ul>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/guardian/get-factor-phone-templates">
              Get enrollment and verification phone templates
            </a>
          </li>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/guardian/get-factor-sms-templates">
    ...
    <tr>
      <td>
        <ul>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/guardian/put-factor-phone-templates">
              Update enrollment and verification phone templates
            </a>
          </li>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/guardian/put-factor-sms-templates">
...
<table class="table">
  <thead>
    <tr>
      <th>
        <b>Phone Provider Branding endpoint</b>
      </th>
      <th>
        <b>Scope</b>
      </th>
  ...
  <tbody>
    <tr>
      <td>
        <ul>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/branding/get-branding-phone-providers">
              Get the phone providers set for a tenant
            </a>
          </li>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/branding/get-phone-provider">Get the phone provider</a>
          </li>
        </ul>
      </td>
    ...
    <tr>
      <td>
        <ul>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/branding/update-phone-provider">
    ...
    <tr>
      <td>
        <ul>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/branding/create-phone-provider">
    ...
    <tr>
      <td>
        <ul>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/branding/get-phone-templates">
              Get list of phone notification templates
            </a>
          </li>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/branding/get-phone-template">
    ...
    <tr>
      <td>
        <ul>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/branding/update-phone-template">
    ...
    <tr>
      <td>
        <ul>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/branding/create-phone-template">
    ...
    <tr>
      <td>
        <ul>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/branding/delete-phone-provider">
  ...
  <tbody>
    <tr>
      <td>
        <ul>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/guardian/get-message-types">Get enabled phone factors</a>
          </li>
        </ul>
      </td>
      <td>`read:guardian_factors`</td>
    ...
    <tr>
      <td>
        <ul>
          <li>
            <a href="https://auth0.com/docs/api/management/v2/guardian/put-message-types">
              Update enabled phone factors
            </a>
          </li>
        </ul>
      </td>
...
<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/3qqa2QWXRNKZV96AQq6O0G/28cdff44a9532f5c005a5e1acb763ab8/2025-02-24_14-58-47.png)
</Frame>
