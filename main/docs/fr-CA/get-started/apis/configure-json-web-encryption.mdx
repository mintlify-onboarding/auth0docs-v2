...
<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/5xHKQ3rKN7DZogzD5qFDLp/623f3ab27591e30c96405869941f1e75/Access_Token_Settings_-_French.png)
</Frame>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Facultatif</td>
      <td>
        L’identifiant utilisé pour écrire dans l’en-tête `kid` de votre jeton JWE. Il peut être utilisé pour identifier
        la clé utilisée pour le chiffrement pendant la rotation des clés.
      </td>
    </tr>
  </tbody>
</table>
