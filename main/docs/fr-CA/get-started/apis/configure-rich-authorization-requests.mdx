...
<table class="table">
  <thead>
    <tr>
      <th>
        <strong>Est-ce une demande d’autorisation riche?</strong>
      </th>
      <th>
        <strong>MFA requise?</strong>
      </th>
      <th>
        <strong>`null` ou non défini (par défaut)</strong>
      </th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>La demande d’autorisation est rejetée avec `invalid_request`.</td>
      <td>
        Aucun consentement n’est affiché. Le consentement est traité dans l’application mobile qui a reçu le défi de
...
<Frame>
  ![Dashboard > Applications > APIs > Settings > Access
  Settings](/docs/images/fr-ca/cdy7uua7fh8z/3gr8Sf98gh8CUkjnlodNk/5262ab6330b4284087a7f87a719efd16/Access_Settings_-_API.png)
</Frame>
