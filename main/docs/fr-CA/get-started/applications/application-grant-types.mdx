...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>`implicit`</td>
      <td>
        <a href="https://auth0.com/docs/flows/implicit-flow-with-form-post" title="Flux implicite avec Form Post">
    ...
    <tr>
      ...
      <td>
        <a href="https://auth0.com/docs/flows/authorization-code-flow" title="Flux de code d’autorisation">
    ...
    <tr>
      ...
      <td>
        <a href="https://auth0.com/docs/flows/client-credentials-flow" title="Flux des identifiants client">
    ...
    <tr>
      ...
      <td>
        <a
          href="https://auth0.com/docs/flows/resource-owner-password-flow"
    ...
    <tr>
      ...
      <td>
        <a
          href="https://auth0.com/docs/tokens/refresh-tokens/use-refresh-tokens"
          title="Utiliser des jetons d’actualisation"
        >
    ...
    <tr>
      ...
      <td>
        <a href="https://auth0.com/docs/flows/device-authorization-flow" title="Flux d’autorisation d’appareil">
...
<table class="table">
  ...
  <tbody>
    <tr>
      ...
      <td>
        Utiliser une autorisation d’extension semblable à l’autorisation de mot de passe du propriétaire de ressource
        qui comprend la possibilité d’indiquer une partition particulière
      </td>
    </tr>
    <tr>
