...
<Frame>
  ![Tableau de bord - Liste des
  applications](/docs/images/fr-ca/cdy7uua7fh8z/1ecNwGgFQZxdP57p0tp3jT/f29e9dd02a5fb61311387cc3c93ac006/App_List_-_FR.png)
</Frame>
...
<Frame>
  ![Dashboard Onglet Paramètres d’application Information de
  base](/docs/images/fr-ca/cdy7uua7fh8z/2GPUw7BODYuYYH3658Upz3/061d21a8d965cec77a7bc65793a0a994/App_-_Basic_Settings_-_FR.png)
</Frame>
...
<Frame>
  ![Dashboard Applications Onglet Paramètres d’application Propriétés de
  l’application](/docs/images/fr-ca/cdy7uua7fh8z/4Z66jnQOVFwNo5iuHtdlxo/e59f56e7b763fad11c5244991cf92f31/Basic_Info_-_FR.png)
</Frame>
...
<Frame>
  ![Tableau de bord Applications Paramètres d’application URIs de
  l’application](/docs/images/fr-ca/cdy7uua7fh8z/1QhW2i4fTCCp8owey2tMPI/3f30e9b32339ee2a416bdb981d9f238b/App_URIs_-_FR.png)
</Frame>
...
<Frame>
  ![Dashboard (Tableau de bord) Applications Onglet Application Settings (Paramètres d’application) Refresh Token
  Rotation (Rotation du jeton
  d’actualisation)](/docs/images/fr-ca/cdy7uua7fh8z/Rk6i8MUVWZG34P7K6aurb/f416d625f4aa157a89238d975736086a/2025-02-27_16-05-01.png)
</Frame>
...
<Frame>
  ![Dashboard (Tableau de bord) Applications Onglet Applications Settings (Paramètres d’application) Refresh Token
  Expiration (Expiration du jeton
  d’actualisation)](/docs/images/fr-ca/cdy7uua7fh8z/2EnpIEc4kBxjnS3T67xPzC/aaedb8197ad64c314f5c9e913b421441/Refresh_Token_Expiration.png)
</Frame>
...
<Frame>
  ![Dashboard (Tableau de bord) Applications Onglet Application Settings (Paramètres d’application) Advanced Settings
  (Paramètres avancés) Onglet Application Metadata (Métadonnées
  d’application)](/docs/images/fr-ca/cdy7uua7fh8z/7GWHyQloNihda3fuYiVEWQ/90328936eaee7a89b43f5b41acfdc994/2025-02-28_13-43-37.png)
</Frame>
...
<Frame>
  ![Dashboard (Tableau de bord) Applications Onglet Application Settings (Paramètres d’application) Advanced Settings
  (Paramètres avancés) Onglet Device Settings (Paramètres de
  périphérique)](/docs/images/fr-ca/cdy7uua7fh8z/YKKPtWtswHn2FZGFSVWNw/e2d9450d2c288e0bddc97b5148ae6c4a/Device_Settings_-_FR.png)
</Frame>

### OAuth

<Frame>
  ![Tableau de bord Applications Onglet Paramètres d’application Paramètres avancés Onglet
  OAuth](/docs/images/fr-ca/cdy7uua7fh8z/5bbq6VrI9tUMht0PwMimre/12fee3cc092e220194a92316118d9538/OAuth_-_FR.png)
</Frame>
...
<Frame>
  ![Tableau de bord - Applications - Onglet Paramètres d’application - Paramètres avancés - Onglet Types
  d’autorisation](/docs/images/fr-ca/cdy7uua7fh8z/4ZMq4VfeGsKsKfZVFwSqe8/7750d3e5e237cb7ef41ffd3aec65f949/Grant_Types_-_FR.png)
</Frame>
...
<Frame>
  ![Dashboard (Tableau de bord) Applications Onglet Application Settings (Paramètres d’application) Advanced (Avancés)
  Onglet
  WS-Federation](/docs/images/fr-ca/cdy7uua7fh8z/3zuhwy8aQfveqIep1NilGk/f6e1792ec0ff324a199d1d4abe30ed80/WS_Federations_-_FR.png)
</Frame>
