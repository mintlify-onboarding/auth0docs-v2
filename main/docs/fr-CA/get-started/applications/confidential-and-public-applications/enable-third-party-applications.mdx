...
## Permissions current*user*\* de jeton d’accès
...
Un produit permettant aux clients d’effectuer des tâches administratives." cta="Voir le glossaire">Management API</Tooltip>. Elles doivent à la place obtenir des jetons d’accèss avec les permissions suivantes current*user*\* requises par chaque point de terminaison :
