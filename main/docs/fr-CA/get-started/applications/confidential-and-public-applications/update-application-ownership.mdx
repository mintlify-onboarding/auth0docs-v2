...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        La propriété que vous souhaitez spécifier pour l’application. Si l’application est de première partie,
        `is_first_party` elle doit avoir une valeur de `true`. Si l’application est tierce, `is_third_party` doit avoir
        une valeur de `false`.
      </td>
    </tr>
  </tbody>
