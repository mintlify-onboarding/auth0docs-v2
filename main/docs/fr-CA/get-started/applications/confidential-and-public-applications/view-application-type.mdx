...
<table class="table">
  <thead>
    <tr>
      ...
      <th>
        <strong>Méthode d’authentification du point de terminaison du jeton</strong>
      </th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      <td>
        <strong>Confidentielle</strong>
      </td>
      <td>Web standards ou communication entre machines</td>
      <td>
        <strong>Basic</strong>, <strong>Post</strong>, <strong>clé privée JWT</strong>, <strong>Non spécifié</strong>
      </td>
    </tr>
  </tbody>
</table>
