  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        avec les permissions « update:clients » et « update:credentials ».
      </td>
    </tr>
  </tbody>
</table>
4. Mettez à jour votre application afin qu’elle utilise la nouvelle clé privée pour signer les assertions pour l’Authentication
API Auth0. 5. Retirez la clé inutilisée de votre application.
