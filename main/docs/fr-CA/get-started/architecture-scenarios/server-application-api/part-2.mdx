...
>
  OAuth 2.0
</Tooltip> définit le type de profils, ou dialectes, pour un jeton d’accès. Auth0 prend en charge deux profils différents :
...
<Frame>
  ![Dashboard > API >
  Permissions](/docs/images/fr-ca/cdy7uua7fh8z/73FeuGyODcu3q7PKjLaQOO/f3bbc7875e527a6a32ae66b1e1432978/Timesheets_API_-_Permissions_-_French.png)
</Frame>
...
<Frame>
  ![undefined](/docs/images/fr-ca/cdy7uua7fh8z/7lnuzFgs3IuWyL4bK5aVZV/fc3bb9e27b8960d5ea5521e226cb7e42/2025-02-26_19-05-30.png)
</Frame>
...
<Frame>
  ![Dashboard (Tableau de bord) - Applications - APIs (APIs) - Machine to Machine Applications (Applications
  machine-machine) - Authorize
  (Autoriser)](/docs/images/fr-ca/cdy7uua7fh8z/3PjvkTaoOZKWCMJol4ajCu/7f25c09888f0688c4cf1c517bdc62aaa/2025-02-26_18-53-09.png)
</Frame>
