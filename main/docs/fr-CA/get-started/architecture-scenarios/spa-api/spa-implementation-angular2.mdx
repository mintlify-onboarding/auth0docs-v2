  ...
  <div class="container-fluid">
    ...
    <div class="navbar-collapse collapse">
      <ul class="nav navbar-nav">
        ...
        <li>
          <a *ngIf="auth.isAuthenticated() && auth.userHasScopes(['approve:timesheets'])" routerLink="/approval"
      ...
      <ul class="nav navbar-nav navbar-right">
        <li>
          <a *ngIf="!auth.isAuthenticated()" href="/docs/fr-CA/javascript:void(0)" (click)="auth.login()">Log In</a>
        </li>
        <li>
          <a *ngIf="auth.isAuthenticated()" href="/docs/fr-CA/javascript:void(0)" (click)="auth.logout()">Log Out</a>
        </li>
      </ul>
    </div>
  </div>
...
export const ROUTES: Routes = [
  ...
  { path: "timesheets", component: TimesheetListComponent, canActivate: [AuthGuard] },
  {
    ...
    data: { expectedScopes: ["approve:timesheets"] },
  },
  { path: "**", redirectTo: "" },
];
```
