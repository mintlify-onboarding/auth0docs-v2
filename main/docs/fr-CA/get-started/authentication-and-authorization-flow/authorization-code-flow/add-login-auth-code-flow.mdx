  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="https://manage.auth0.com/#/Applications/{yourClientId}/settings">paramètres d’application</a>.
      </td>
    </tr>
    <tr>
      <td>`redirect_uri`</td>
      <td>
        ...
        dans vos{" "}
        <a href="https://manage.auth0.com/#/Applications/{yourClientId}/settings">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="https://manage.auth0.com/#/Applications/{yourClientId}/settings">paramètres de votre application</a>.
      </td>
    </tr>
    <tr>
      <td>`client_secret`</td>
