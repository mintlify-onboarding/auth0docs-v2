...
<Frame>
  ![Diagramme simple montrant un utilisateur accédant à une
  ressource](/docs/images/fr-ca/cdy7uua7fh8z/4jZPLvwFRGMSCBRv6ksLqb/693853a577381525893f6bab8266db5b/intro-iam-user-wants-resource.png)
</Frame>

<Frame>
  ![Diagramme simple montrant que le système IAM contrôle l’accès des utilisateurs à une
  ressource](/docs/images/fr-ca/cdy7uua7fh8z/64NhRWH7dFSSTRGv040nIB/d002d707848d959b13ba811b062b6bf4/IAM-verifies-access.png)
</Frame>
...
<Frame>
  ![Diagramme montrant comment l’authentification ressemble à un garde de sécurité vérifiant votre badge à
  l’entrée](/docs/images/fr-ca/cdy7uua7fh8z/2kbfIgTRNIKNdqJBbgmWQ4/faff396daae73acbc5df646c3418091f/authentication-building.png)
</Frame>
...
<Frame>
  ![Diagramme montrant comment l’autorisation est similaire à un badge qui ne donne accès qu’à certaines pièces d’un
  bâtiment](/docs/images/fr-ca/cdy7uua7fh8z/2OGIbazhGLOdDB0OVOTyX8/fb6082167777035d40c41f2b921ac29c/authorization-building.png)
</Frame>
...
<Frame>
  ![Screenshot of Slate magazine
  login](/docs/images/fr-ca/cdy7uua7fh8z/2moycObnuKnYfoqFMSGCO0/12aa20de553bfce8afba3cf4f56cbd8d/Slate-login.png)
</Frame>
...
<Tooltip
  href="/docs/fr-CA/glossary?term=oath2"
  tip="OAuth 2.0
Cadre d’applications d’autorisation qui définit les protocoles d’autorisation et les flux de production."
  cta="Voir le glossaire"
>
  OAuth
</Tooltip>
 2.0 est un protocole de délégation ouvert pour accéder aux API et le protocole standard du secteur pour la gestion des
identités et des accès. Il permet à une application d’accéder à des ressources hébergées par d’autres applications Web
au nom d’un utilisateur sans jamais partager les identifiants de ce dernier. C’est la norme grâce à laquelle les
développeurs tiers peuvent s’appuyer sur de grandes plateformes sociales comme Facebook, Google et X à des fins de
connexion. Pour en savoir plus, veuillez consulter l’article [Cadre d’applications Authorization
OAuth 2.0](/docs/fr-CA/authenticate/protocols/oauth).

#### OpenID Connect

<Tooltip
  href="/docs/fr-CA/glossary?term=openid"
  tip="OpenID
Norme ouverte d’authentification qui permet aux applications de vérifier l’identité des utilisateurs sans avoir à collecter leurs informations de connexion."
  cta="Voir le glossaire"
>
  OpenID
</Tooltip>
 Connect (OIDC) est une couche d’identité simple qui repose sur OAuth 2.0. Elle permet de vérifier facilement l’identité
d’un utilisateur et d’obtenir des informations de base sur son profil auprès du fournisseur d’identité. OIDC est
également un protocole standard ouvert. Pour en savoir plus, consultez [Protocole
...
<Tooltip href="/docs/fr-CA/glossary?term=security-assertion-markup-language" tip="Security Assertion Markup Language (SAML) Protocole normalisé permettant à deux parties d’échanger des informations d’authentification sans mot de passe." cta="Voir le glossaire">Security Assertion Markup Language</Tooltip> (SAML) : format de données ouvert, basé sur XML, qui permet aux entreprises de communiquer des informations sur
l’authentification et l’autorisation des utilisateurs aux entreprises partenaires et aux applications d’entreprise que leurs
employés peuvent utiliser. Pour en savoir plus, consultez [SAML](/docs/fr-CA/authenticate/protocols/saml).
