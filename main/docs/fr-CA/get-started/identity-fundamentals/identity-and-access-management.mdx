...
<Tooltip
  ...
  tip="Security Assertion Markup Language (SAML)
Protocole normalisé permettant à deux parties d’échanger des informations d’authentification sans mot de passe."
  cta="Voir le glossaire"
>
  Security Assertion Markup Language
</Tooltip> (SAML) : format de données ouvert, basé sur XML, qui permet aux entreprises de communiquer des informations sur
