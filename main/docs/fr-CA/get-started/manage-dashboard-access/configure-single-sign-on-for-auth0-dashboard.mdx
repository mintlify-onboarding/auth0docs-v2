...
2. [Ajoutez une description de demande](https://learn.microsoft.com/en-us/windows-server/identity/ad-fs/operations/add-a-claim-description)
pour chacune des demandes suivantes :
...
3. Activez les point de terminaison SAML 2.0. 4. Communiquez les informations suivantes à Auth0 Support :
...
3. Ne modifiez pas la section **Attributes & Attributs et demandes**, notamment `Email`, `Unique User Identifier` et éventuellement
`name -`  ; laissez les suggestions Azure. 4. Communiquez à Auth0 Support les données XML des métadonnées SAML. Vous avez
le choix entre ce qui suit :
...
2. Définissez le **Name Identifier (Identifiant de nom)** pour qu’il envoie l’adresse courriel de l’utilisateur. 3. Communiquez
à Auth0 Support les données XML des métadonnées SAML. Vous avez le choix entre ce qui suit :
...
2. [Ajoutez la demande de courriel](/docs/fr-CA/secure/tokens/json-web-tokens/create-custom-claims) au jeton d’ID. 3. Transmettez
à Auth0 Support ce qui suit :
...
<table class="table">
  <thead>
    <tr>
      ...
      <th>
        <strong>Membre du locataire</strong>
      </th>
      <th>
        <strong>Connexion</strong>
      </th>
      <th>
        <strong>Affecté?</strong>
      </th>
    </tr>
  </thead>
  <tbody>
