...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>`YOUR_KEY_ID`</td>
      <td>
        ID de la clé de connexion à afficher. Pour savoir comment trouver l’ID de votre clé de connexion, consultez{" "}
        <a href="https://auth0.com/docs/tokens/guides/locate-jwks">Localiser des ensembles de clés Web JSON</a>.
      </td>
    </tr>
    <tr>
      <td>`MGMT_API_ACCESS_TOKEN`</td>
