...
| Auth0.PrimaryColor     |  color - reference   | Utilisé comme _normal_ state dans les widgets comme le bouton Soumettre. Également utilisée comme _accent_ color.                     |
| Auth0.DarkPrimaryColor | couleur - référence  | Utilisée en tant qu’état _pressed_ state dans les widgets tels que le bouton Soumettre.                                               |
