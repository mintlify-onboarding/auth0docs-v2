...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Il s’agit de l’identifiant de l’API associée à/aux autorisation(s) que vous souhaitez ajouter pour le rôle
        spécifié, également connu comme « audience ». Ce n’est pas l’ID de l’API.
      </td>
    </tr>
    <tr>
