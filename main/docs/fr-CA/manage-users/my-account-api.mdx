...
You can activate the My Account API for your tenant in the <Tooltip href="/docs/fr-CA/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/DGkDQNIHcegN8vtQyEvF3/a2e98b06867701a66fa1f1b3df1c996b/My_Account_API_-_Activate.png)
</Frame>
...
You can get an <Tooltip href="/docs/fr-CA/glossary?term=access-token" tip="Jeton d’accès
...
If you’re using <Tooltip href="/docs/fr-CA/glossary?term=universal-login" tip="Connexion universelle
...
1. Navigate to [Auth0 Dashboard > Applications > Applications](https://manage.auth0.com/#/applications) and select the name of the application.
2. Under **Settings**, toggle on ** Allow Cross-Origin Authentication**.
3. Enter your application's origin URL under **Allowed Origins (CORS)**.
4. **Save** your changes.

<Note>
  If you do not need to use CORS for your application, ensure that Allow Cross-Origin Authentication is toggled off.
  Adding your application's URL to this list tells Auth0 to trust requests from that origin, allowing your client-side
