  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        permission `create:organization_members`.
      </td>
    </tr>
    <tr>
      <td>`USER_ID`</td>
      <td>
        ID de(s) l’utilisateur(s) que vous voulez attribuer à l’organization spécifiée. Vous pouvez envoyer un maximum
        de 10 membres par organization et par demande.
      </td>
    </tr>
  </tbody>
</table>
