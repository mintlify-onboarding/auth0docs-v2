...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>
        <a href="/docs/fr-CA/secure/tokens/refresh-tokens/manage-refresh-tokens-actions">
          Jetons d’actualisation avec les actions
        </a>
      </td>
    ...
    <tr>
      <td>
        <a href="/docs/fr-CA/manage-users/sessions/manage-sessions-actions">Sessions avec les actions</a>
      </td>
