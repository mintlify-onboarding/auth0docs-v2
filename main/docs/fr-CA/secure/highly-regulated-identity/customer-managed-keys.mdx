...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>`create:encryption_keys` `update:encryption_keys`</td>
      <td>
        Les utilisateurs peuvent faire une rotation et re-chiffrer la hiérarchie des clés d’un locataire Auth0 avec le
        point de terminaison Management API <a>Re-chiffrer les clés</a>.
      </td>
    </tr>
  </tbody>
</table>
