...
<Frame>
  ![Auth0 Dashboard > Security > Multi-factor Auth > Guardian > Custom > Amazon
  SNS](/docs/images/fr-ca/cdy7uua7fh8z/6PKSyH99GJ2CalJoG38sfZ/fbe7229dcc6f7d303a582520001b3dc1/Amazon_SNS.png)
</Frame>
   ...
   <table class="table">
     ...
     <tbody>
       <tr>
         ...
         <td>
           Permet à Auth0 d’envoyer des notifications poussées à votre application personnalisée. Si cette option n’est
           pas activée, les notifications poussées ne peuvent pas être envoyées.
         </td>
       </tr>
       <tr>
         <td>URL Google Play Store</td>
         <td>
           Fournissez un lien vers l’application personnalisée que les utilisateurs doivent télécharger pour configurer
           MFA.
         </td>
       </tr>
       <tr>
         ...
         <td>
           Téléversez vos{" "}
           <a href="https://firebase.google.com/docs/admin/setup#initialize-sdk">identifiants du serveur MFA</a>.
         </td>
       </tr>
     </tbody>
   </table>
   ...
   <table class="table">
     ...
     <tbody>
       <tr>
         ...
         <td>
           Permet à Auth0 d’envoyer des notifications poussées à votre application personnalisée. Si cette option n’est
           pas activée, les notifications poussées ne seront pas envoyées.
         </td>
       </tr>
       <tr>
         <td>Apple App Store URL</td>
         <td>
           Fourni un lien vers l’application personnalisée que les utilisateurs doivent télécharger pour configurer MFA.
         </td>
       </tr>
       <tr>
       ...
       <tr>
         ...
         <td>
           Téléverser votre{" "}
           <a href="https://developer.apple.com/documentation/usernotifications/setting_up_a_remote_notification_server/establishing_a_certificate-based_connection_to_apns">
             certificat P12
           </a>
           .
         </td>
