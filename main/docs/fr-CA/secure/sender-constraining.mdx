...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>
        <a href="/docs/fr-CA/secure/sender-constraining/mtls-sender-constraining">mTLS Sender Constraining</a>
      </td>
      <td>How mTLS sender constraining works in Auth0, step by step.</td>
    </tr>
    <tr>
      <td>
        <a href="/docs/fr-CA/secure/sender-constraining/demonstrating-proof-of-possession-dpop">
    ...
    <tr>
      <td>
        <a href="/docs/fr-CA/secure/sender-constraining/configure-sender-constraining">Configure Sender Constraining</a>
      </td>
