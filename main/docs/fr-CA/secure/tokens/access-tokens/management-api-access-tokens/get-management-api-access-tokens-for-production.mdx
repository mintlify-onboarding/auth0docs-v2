...
N’oubliez pas de mettre à jour `{yourClientSecret}` avec le secret du client dans l’<AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">onglet Settings (Paramètres) de votre application</AuthLink>.
...
<table class="table">
  <thead>
    <tr>
      <th>
        <strong>Paramètre de la requête</strong>
      </th>
      <th>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Indique le <a href="/docs/fr-CA/protocols/oauth2#grant-types">flux OAuth 2.0</a> que vous souhaitez exécuter.
        Pour la communication entre machines, utilisez la valeur `client_credentials`.
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Il s’agit de la valeur du champ <strong>Client ID</strong> de l’application de communication entre machines que
        vous avez créée. Vous pouvez la trouver dans l’onglet [Paramètres] de votre
        application(https://manage.auth0.com/#/applications/{yourClientId}/settings).
      </td>
    </tr>
    <tr>
      <td>
      ...
      <td>
        Il s’agit de la valeur du champ <strong>Client Secret</strong> de l’application de communication entre machines
        que vous avez créée. Vous pouvez la trouver dans l’onglet{" "}
    ...
    <tr>
      ...
      <td>
        Il s’agit de la valeur du champ <strong>Identifier</strong> de l’`Auth0 Management API`. Vous pouvez le trouver
        dans l’onglet <a href="https://manage.auth0.com/#/api">Paramètres de l’API</a>.
      </td>
    </tr>
  </tbody>
</table>
