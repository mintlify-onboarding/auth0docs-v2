...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>
        <strong>Clé Web JSON (JWK)</strong>
      </td>
      <td>
        Un objet JSON qui représente une clé cryptographique. Les membres de l’objet représentent les propriétés de la
        clé, y compris sa valeur.
      </td>
    </tr>
    <tr>
      <td>
        <strong>Ensemble de clés Web JSON (JWKS)</strong>
      </td>
      <td>
        Un objet JSON qui représente un ensemble de JWKs. L’objet JSON DOIT avoir un membre `clés`, qui est un tableau
        de JWC.
      </td>
    </tr>
  </tbody>
