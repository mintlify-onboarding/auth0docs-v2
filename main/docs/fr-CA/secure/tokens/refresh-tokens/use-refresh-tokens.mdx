...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      <td>`client_secret`</td>
      <td>
        (Facultatif) Secret client de l’application. Uniquement requis pour les applications confidentielles utilisant
        la méthode d’authentification par jeton Post.
      </td>
    </tr>
    <tr>
      <td>`refresh_token`</td>
