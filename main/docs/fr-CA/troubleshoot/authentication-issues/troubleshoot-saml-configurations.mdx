...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>Destination</td>
      <td>
        Vérifiez que la destination de l’assertion SAML est le bon locataire Auth0 et la bonne connexion (`https://
        {TENANT}.auth0.com/login/callback?connection={CONNECTION}`).
      </td>
    </tr>
    <tr>
      <td>Status Field (Champ d’état)</td>
      <td>
        Ce champ doit indiquer la réussite. (`&lt;samlp:StatusCode
    ...
    <tr>
      ...
      <td>
        ...
        connexion (`&lt;saml:AudienceRestriction&gt;&lt;saml:Audience&gt;urn:auth0:{TENANT}:{CONNECTION}
        &lt;/saml:audience&gt;`).
      </td>
    </tr>
    <tr>
