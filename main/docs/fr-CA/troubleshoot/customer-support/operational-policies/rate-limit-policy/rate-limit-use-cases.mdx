...
<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/30m5xST81Db6mROVGCV5Bj/a16e0e09e31aee2f5e39514a0fcadf83/Examples_of_how_rate_limits_are_enforced_-_Page_1.png)
</Frame>
...
<Frame>
  ![](/docs/images/fr-ca/cdy7uua7fh8z/PhtwGBwS9PfEpNQbPeA1o/a8d5f862d1b288557fbcb068d4629a6c/Examples_of_how_rate_limits_are_enforced_-_Page_1__1_.png)
</Frame>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      <td>
        <strong>Connexions d’entreprise</strong>
      </td>
    ...
    <tr>
      <td>
        <strong>Identifiants client</strong>
      </td>
      <td>
        Utilisé pour les authentifications de communication entre machines. S’applique universellement, même si des
...
<table class="table">
  <thead>
    <tr>
      ...
      <th>
        <strong>Requêtes supplémentaires</strong>
      </th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>
        <strong>Authentification SMS uniquement</strong>
      </td>
    ...
    <tr>
      <td>
        <strong>Connexion sociale native</strong>
      </td>
