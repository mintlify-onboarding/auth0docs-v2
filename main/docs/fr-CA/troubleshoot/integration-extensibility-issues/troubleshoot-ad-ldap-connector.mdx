...
1. Passez à la vue **Dépannage** pour lire les journaux.
   ...
   <Frame>
     ![Troubleshoot AD/LDAP Connector Admin Console Troubleshooting
     Screen](/docs/images/fr-ca/cdy7uua7fh8z/3N6GgZVMaYUcY48GK8IKgU/92a469b9375dbcd9e3c35adaef6709d5/connector-admin-console-troubleshooter.png)
   </Frame>
...
<Frame>
  ![Troubleshoot AD/LDAP Connector Troubleshooting Tool
  Screen](/docs/images/fr-ca/cdy7uua7fh8z/5LOU1ZyB69cPe8rVa9lVPd/c5c7419ae736a3992ddd2a436b26a3e0/connector-troubleshooter.png)
</Frame>
...
4. Numéro de version de votre Connecteur AD/LDAP.
   ...
   <Frame>
     ![Troubleshoot AD/LDAP Connector Console
     Screen](/docs/images/fr-ca/cdy7uua7fh8z/4TxfMbN76vRwaON9RKzt6F/81327d0c830082a0d78a89f005edfc87/adldap-connector-version.png)
   </Frame>
