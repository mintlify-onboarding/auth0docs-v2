...
1. Rendez-vous à [Dashboard > Paramètres de locataire > Membres du locataire](https://manage.auth0.com/#/tenant/admins) et identifiez les membres auxquels le rôle **Administrateur d’application** est attribué. (Vous pouvez indiquer à ces membres que leur expérience dans le tableau de bord va changer : ils n’auront plus accès aux sections Utilisateurs et Connexions).
   ...
   <Frame>
     ![Dashboard - Tenant Settings - Tenant
     Members](/docs/images/fr-ca/cdy7uua7fh8z/1lsoGSi3Wgou5SF1iGAIgH/93fbd705f03bbdca5791e485e1b23ac1/tenant-settings-tenant-admins.png)
   </Frame>
