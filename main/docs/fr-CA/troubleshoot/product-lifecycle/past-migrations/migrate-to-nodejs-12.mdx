...
1. Allez à <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Dashboard > Applications > Applications > Paramètres</AuthLink>, et ajoutez URL aux champs **Callback URL autorisées** et **URL de déconnexion autorisées**.
...
<Frame>
  ![Misconfiguration or Service Outage
  Error](/docs/images/fr-ca/cdy7uua7fh8z/4mq5ebCa83XNLlbn28pp9s/beb869df9a11d188f30332030655ac9d/node-hidden-secret-error.png)
</Frame>
