...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>
        <a href="https://github.com/auth0/auth0-java">Auth0 Java</a>
      </td>
      <td>1.8.0</td>
    ...
    <tr>
      <td>
        <a href="https://github.com/auth0/auth0-python">Auth0 Python</a>
      </td>
      <td>3.0.0</td>
...
<table class="table">
  ...
  <tbody>
    <tr>
      <td>
        <a href="/docs/fr-CA/extensions/authorization-extension/v2">Authorization Extension</a>
      </td>
      <td>2.5.0+</td>
      <td>
        Si vous utilisez une version antérieure, vous devez mettre à jour manuellement l’extension depuis la page{" "}
        <a href="https://manage.auth0.com/#/extensions">Extensions</a>.
      </td>
    </tr>
    <tr>
      <td>
        <a href="/docs/fr-CA/extensions/delegated-admin/v3">Administration déléguée</a>
      </td>
      <td>3.1+</td>
      <td>
        Si vous utilisez une version antérieure, vous devez mettre à jour manuellement l’extension à partir de la page{" "}
        <a href="https://manage.auth0.com/#/extensions">Extensions</a>. Le paramètre de configuration `SEARCH_ENGINE`
        n’existe plus dans la version 3.1 car seule la recherche utilisateur v3 est disponible.
      </td>
    </tr>
  </tbody>
</table>
