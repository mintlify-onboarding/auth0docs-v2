...
* [Modifier le mot de passe](/docs/docs/fr-ca/authenticate/database-connections/custom-db/templates/change-password)
* [Créer utilisateur](/docs/docs/fr-ca/authenticate/database-connections/custom-db/templates/create)
* [Supprimer utilisateur](/docs/docs/fr-ca/authenticate/database-connections/custom-db/templates/delete)
* [Obtenir utilisateur](/docs/docs/fr-ca/authenticate/database-connections/custom-db/templates/get-user)
* [Connexion](/docs/docs/fr-ca/authenticate/database-connections/custom-db/templates/login)
* [Vérifier utilisateur](/docs/docs/fr-ca/authenticate/database-connections/custom-db/templates/verify)
* [Modifier l’adresse courriel](/docs/docs/fr-ca/authenticate/database-connections/custom-db/templates/change-email)
