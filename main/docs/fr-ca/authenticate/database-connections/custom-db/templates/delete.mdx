...
Le script est seulement utilisé dans un [scénario d’authentification héritée](/docs/docs/fr-ca/authenticate/database-connections/custom-db/overview-custom-db-connections), et est exigé si vous souhaitez supprimer un utilisateur d’Auth0 et de votre base de données externe au cours de la même opération.
