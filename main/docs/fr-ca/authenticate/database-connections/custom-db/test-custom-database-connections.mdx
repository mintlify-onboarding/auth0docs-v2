...
Le script [Obtenir l’utilisateur](/docs/docs/fr-ca/authenticate/database-connections/custom-db/templates/get-user) permet de mettre en œuvre une fonction qui détermine l’état actuel d’un utilisateur.
...
* Modifier l’adresse courriel d’un utilisateur (script [de modification de courriel)](/docs/docs/fr-ca/authenticate/database-connections/custom-db/templates/change-email)
* Se connecter (script [de connexion](/docs/docs/fr-ca/authenticate/database-connections/custom-db/templates/login))
* Modifier son mot de passe (script [de modification de mot de passe](/docs/docs/fr-ca/authenticate/database-connections/custom-db/templates/change-password))
...
* Créer un utilisateur (script [de création](/docs/docs/fr-ca/authenticate/database-connections/custom-db/templates/create))
* Modifier l’adresse courriel d’un utilisateur (script [de modification de courriel](/docs/docs/fr-ca/authenticate/database-connections/custom-db/templates/change-email))
* Modifier le mot de passe d’un utilisateur (script [de modification de mot de passe](/docs/docs/fr-ca/authenticate/database-connections/custom-db/templates/change-password))
...
Le script de [modification du courriel](/docs/docs/fr-ca/authenticate/database-connections/custom-db/templates/change-email) met en œuvre une fonction exécutable qui met à jour l’adresse courriel d’un utilisateur lorsque celui-ci la change ou modifie son état de vérification.

Ce script n’est pas disponible dans Auth0 Dashboard Vous devez appeler le point de terminaison [Update a connection (Mettre à jour une connexion)](/docs/docs/fr-ca/api/management/v2/connections/patch-connections-by-id) de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
* [Password Strength in Auth0 Database Connections](/docs/docs/fr-ca/authenticate/database-connections/password-strength)
* [Meilleures pratiques en matière d’environnement des scripts d’action des bases de données personnalisées](/docs/docs/fr-ca/authenticate/database-connections/custom-db/custom-database-connections-scripts/environment)
* [Password Options in Auth0 Database Connections](/docs/docs/fr-ca/authenticate/database-connections/password-options)
* [Configurer la connexion du fournisseur d’identité pour les mises à jour du profil utilisateur](/docs/docs/fr-ca/manage-users/user-accounts/user-profiles/configure-connection-sync-with-auth0)
* [Meilleures pratiques des paramètres de connexion](/docs/docs/fr-ca/authenticate/connection-settings-best-practices)
* [Créer des connexions de base de données personnalisée](/docs/docs/fr-ca/authenticate/database-connections/custom-db/create-db-connection)