...
For more information about identifiers and attributes, read [Flexible Identifiers](/docs/docs/fr-ca/authenticate/database-connections/flexible-identifiers-and-attributes).
