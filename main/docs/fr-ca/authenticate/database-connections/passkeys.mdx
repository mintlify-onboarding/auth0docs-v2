...
Auth0 prend en charge les clés d’identification en tant que méthode d’authentification pour les [connexions de bases de données](/docs/docs/fr-ca/authenticate/database-connections).
...
Si l’utilisateur doit réinitialiser son compte, il peut [déclencher un flux interactif de réinitialisation du mot de passe](/docs/docs/fr-ca/authenticate/database-connections/password-change#universal-login-page) par le biais du <Tooltip href="/docs/docs/fr-ca/glossary?term=universal-login" tip="Connexion universelle
...
Si la <Tooltip href="/docs/docs/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
...
Pour en savoir plus, lisez [Réduire les frictions avec les clés d’identification](/docs/docs/fr-ca/customize/actions/flows-and-triggers/login-flow#reduce-friction-with-passkeys) et [Authentification multifacteur (MFA)](/docs/docs/fr-ca/secure/multi-factor-authentication).
