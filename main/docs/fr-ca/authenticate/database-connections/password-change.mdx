...
Allez dans <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Auth0 Dashboard > Applications > Applications</AuthLink>, et ajoutez l’URL à la liste **Allowed Origins (Origines autorisées)**.
