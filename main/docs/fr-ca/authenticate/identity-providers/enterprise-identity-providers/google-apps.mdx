...
* Sur l’**écran de consentement d’<Tooltip href="/docs/docs/fr-ca/glossary?term=oath2" tip="OAuth 2.0
...
Une fois ces étapes complétées, utilisez le point de terminaison [Obtenir une connexion](/docs/docs/fr-ca/api/management/v2/connections/get-connections-by-id) d'Auth0 <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
Vous pouvez utiliser les `Actions`[post-connexion](/docs/docs/fr-ca/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger) pour vérifier si les événements d’authentification proviennent d‘utilisateurs légitimes membres d’une organisation Google. Cela peut contribuer à atténuer les vulnérabilités potentielles en empêchant tout accès non autorisé à vos applications une fois que les utilisateurs ne font plus partie de votre organisation.
...
* [Intégration d’Auth0 en utilisant l’une de nos bibliothèques](/docs/docs/fr-ca/libraries)
* [Intégration d’Auth0 en utilisant notre Authentication API](/docs/docs/fr-ca/api/authentication)
