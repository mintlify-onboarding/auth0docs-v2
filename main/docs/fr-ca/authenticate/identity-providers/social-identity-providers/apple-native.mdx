...
* [Enregistrer votre application sur le portail des développeurs Apple](https://marketplace.auth0.com/integrations/apple-social-connection) si vous ne l’avez pas déjà fait. Notez les ID et la clé suivants pour les réglages de connexion de l’application dans le <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
* [Révoquer le jeton d’actualisation Auth0](/docs/docs/fr-ca/api/authentication#revoke-refresh-token)
...
* [Politique de limites anti-attaques](/docs/docs/fr-ca/troubleshoot/customer-support/operational-policies/rate-limit-policy)