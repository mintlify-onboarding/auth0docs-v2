...
Comme l’implémentation de la connexion native n’utilise pas les flux de navigateur standard, les propriétaires des applications doivent veiller à effectuer la déconnexion de manière appropriée. Lorsqu’une application a besoin d’effectuer une déconnexion, elle doit également [Révoquer le jeton d’actualisation Auth0](/docs/docs/fr-ca/api/authentication#revoke-refresh-token).

## Poursuivre la lecture

* [Connexion Facebook native avec iOS Swift](/docs/docs/fr-ca/quickstart/native/ios-swift-facebook-login)
* [Connexion Facebook native avec Android](/docs/docs/fr-ca/quickstart/native/android-facebook-login)
* [Limites anti-attaques pour les réseaux sociaux natifs](/docs/docs/fr-ca/troubleshoot/customer-support/operational-policies/rate-limit-policy)