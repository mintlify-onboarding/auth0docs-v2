...
En général, pour tester une connexion, vous devez vous connecter à <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
3. Envoyez à votre partenaire le lien de connexion.
   ...
   export const codeExample = `   https://{yourDomain}/authorize?response_type=token&scope=openid%20profile&client_id={yourClientId}&redirect_uri=http://jwt.io&connection={connectionToTest}
   `;
