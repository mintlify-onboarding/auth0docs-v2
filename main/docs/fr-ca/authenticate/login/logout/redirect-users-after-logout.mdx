...
2. Utilisez `*` comme [caractère générique pour les sous-domaines](/docs/docs/fr-ca/get-started/applications/wildcards-for-subdomains)  (par exemple, `http://*.example.com`).
...
Pour rediriger avec le point de terminaison `oidc/logout` d’Auth0, lisez [Utiliser le point de terminaison OIDC pour déconnecter les utilisateurs d’Auth0](/docs/docs/fr-ca/authenticate/login/logout/log-users-out-of-auth0).
