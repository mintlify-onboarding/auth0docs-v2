...
* [Guide de démarrage rapide d’Android](/docs/docs/fr-ca/quickstart/native/android)
* [Guide de démarrage rapide d’iOS Swift](/docs/docs/fr-ca/quickstart/native/ios-swift)
...
* [Lock.swift](/docs/docs/fr-ca/libraries/lock-swift)
* [Lock.Android](/docs/docs/fr-ca/libraries/lock-android)
...
* Non conforme aux meilleures pratiques <Tooltip href="/docs/docs/fr-ca/glossary?term=oath2" tip="OAuth 2.0
...
* [Ajoutez une connexion Facebook aux applications natives](/docs/docs/fr-ca/authenticate/identity-providers/social-identity-providers/facebook-native)
* [Android – Connexion Facebook](/docs/docs/fr-ca/quickstart/native/android-facebook-login)
* [iOS Swift – Connexion Facebook](/docs/docs/fr-ca/quickstart/native/ios-swift-facebook-login)

Se connecter avec Apple :

* [iOS Swift – Se connecter avec Apple](/docs/docs/fr-ca/quickstart/native/ios-swift-siwa)
* [Ajouter une connexion avec Apple aux application iOS natives](/docs/docs/fr-ca/authenticate/identity-providers/social-identity-providers/apple-native)
