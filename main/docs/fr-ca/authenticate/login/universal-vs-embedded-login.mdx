...
Google ne prend plus en charge l’approche intégrée lors de l’implémentation d’<Tooltip href="/docs/docs/fr-ca/glossary?term=oath2" tip="OAuth 2.0
...
* [Prévenir les menaces courantes en matière de cybersécurité](/docs/docs/fr-ca/secure/security-guidance/prevent-threats)
* [Dépanner les domaines personnalisés](/docs/docs/fr-ca/troubleshoot/integration-extensibility-issues/troubleshoot-custom-domains)