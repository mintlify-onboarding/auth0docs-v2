...
* [Authentification sans mot de passe avec courriel et mots de passe à usage unique (OTP)](/docs/docs/fr-ca/authenticate/passwordless/authentication-methods/email-otp)
* [Authentification sans mot de passe avec courriel et Magic Links](/docs/docs/fr-ca/authenticate/passwordless/authentication-methods/email-magic-link)
* [Authentification sans mot de passe par SMS](/docs/docs/fr-ca/authenticate/passwordless/authentication-methods/sms-otp)
...
* [Authentification sans mot de passe avec connexion universelle](/docs/docs/fr-ca/authenticate/passwordless/passwordless-with-universal-login)
* [Authentification sans mot de passe avec connexion classique](/docs/docs/fr-ca/authenticate/passwordless/implement-login/universal-login)
* [Authentification sans mot de passe avec connexion intégrée](/docs/docs/fr-ca/authenticate/passwordless/implement-login/embedded-login)

## En savoir plus

* [Meilleures pratiques pour les connexions sans mot de passe](/docs/docs/fr-ca/authenticate/passwordless/best-practices)
* [Utilisation des API sans mot de passe](/docs/docs/fr-ca/authenticate/passwordless/implement-login/embedded-login/relevant-api-endpoints)