...
Pour en savoir plus, consultez [Configurer courriel ou SMS pour l’authentification sans mot de passe](/docs/docs/fr-ca/authenticate/login/auth0-universal-login/passwordless-login/email-or-sms).
...
Si l’utilisateur est connecté par le biais d’une [organization](/docs/docs/fr-ca/manage-users/organizations/organizations-overview), les paramètres suivants sont également disponibles :
...
Pour plus d’informations sur ces paramètres et leurs valeurs, lisez le point de terminaison [Get organization](https://auth0.com/docs/api/management/v2#!/Organizations/get_organizations_by_id) (obtenir une organisation) de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
[Configurez votre propre fournisseur de messagerie SMTP](/docs/docs/fr-ca/customize/email/smtp-email-providers) pour gérer, surveiller et dépanner vos communications par courriel, ainsi que personnaliser les modèles de courriels.
...
* [Fournisseur de courriel externe SMTP personnalisé](/docs/docs/fr-ca/customize/email/smtp-email-providers/configure-custom-external-smtp-email-provider)