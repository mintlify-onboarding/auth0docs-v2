...
Pour en savoir plus, consultez [Configure Email or SMS for Passwordless Authentication (Configurer l’authentification sans mot de passe par courriel ou SMS)](/docs/docs/fr-ca/authenticate/login/auth0-universal-login/passwordless-login/email-or-sms).

Auth0 prend en charge l’utilisation de [Twilio](https://www.twilio.com) et de passerelles SMS personnalisées pour envoyer des codes OTP. Si vous souhaitez utiliser une passerelle SMS personnalisée, lisez l’article [Set Up Custom SMS Gateway for Passwordless Connections (Configurer la passerelle SMS personnalisée pour les connexions sans mot de passe)](/docs/docs/fr-ca/authenticate/passwordless/authentication-methods/use-sms-gateway-passwordless).
...
Si vous souhaitez utiliser votre propre passerelle SMS, vous devrez créer la connexion sans mot de passe, puis la modifier à l’aide de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
* [Auth0's Unified Phone Experience](/docs/docs/fr-ca/customize/phone-messages/unified-phone)
* [Use the Unified Phone Experience for Passwordless](/docs/docs/fr-ca/customize/phone-messages/unified-phone/unified-phone-experience-passwordless)
* [Configure Auth0 Unified Phone Experience](/docs/docs/fr-ca/customize/phone-messages/unified-phone/configure-unified-phone)