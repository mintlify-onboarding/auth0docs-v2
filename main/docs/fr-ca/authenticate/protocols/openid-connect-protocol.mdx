...
Norme ouverte d’authentification qui permet aux applications de vérifier l’identité des utilisateurs sans avoir à collecter leurs informations de connexion." cta="Voir le glossaire">OpenID</Tooltip> Connect (OIDC) est une couche d’identité construite au-dessus du cadre d’applications <Tooltip href="/docs/docs/fr-ca/glossary?term=oath2" tip="OAuth 2.0
Cadre d’applications d’autorisation qui définit les protocoles d’autorisation et les flux de production." cta="Voir le glossaire">OAuth 2.0</Tooltip>. Elle permet aux applications tierces de vérifier l’identité de l’utilisateur final et d’obtenir des informations de base sur le profil utilisateur. L’OIDC utilise des jetons Web JSON (<Tooltip href="/docs/docs/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
...
* [Forcer la réauthentification dans OIDC](/docs/docs/fr-ca/authenticate/login/max-age-reauthentication)
* [Applications dans Auth0](/docs/docs/fr-ca/get-started/applications)
* [Authentification unique](/docs/docs/fr-ca/authenticate/single-sign-on)
* [Profils utilisateurs](/docs/docs/fr-ca/manage-users/user-accounts/user-profiles)