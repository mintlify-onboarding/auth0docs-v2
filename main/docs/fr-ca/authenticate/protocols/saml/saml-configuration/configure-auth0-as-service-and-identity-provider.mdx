...
Vous pouvez configurer Auth0 en tant que fournisseur de services (SP) et fournisseur d’identité (<Tooltip href="/docs/docs/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
Service de stockage et de gestion des identités numériques." cta="Voir le glossaire">IdP</Tooltip>) pour tester votre connexion d’authentification unique <Tooltip href="/docs/docs/fr-ca/glossary?term=security-assertion-markup-language" tip="Security Assertion Markup Language (SAML)
...
* [Désactivation d’utilisateurs dans les intégrations SAML](/docs/docs/fr-ca/authenticate/protocols/saml/saml-configuration/deprovision-users-in-saml-integrations)
