...
* Liaison **HTTP-Redirect** pour les requêtes <Tooltip href="/docs/docs/fr-ca/glossary?term=security-assertion-markup-language" tip="Security Assertion Markup Language (SAML)
...
Lorsque vous utilisez l’authentification unique initiée par <Tooltip href="/docs/docs/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
...
Pour savoir comment configurer Auth0 pour acheminer des assertions SAML entrantes, lisez [Configurer l’authentification unique initiée par le fournisseur d’identité](/docs/docs/fr-ca/authenticate/protocols/saml/saml-sso-integrations/identity-provider-initiated-single-sign-on).