...
Configurez SSOCircle en tant que fournisseur d’identité <Tooltip href="/docs/docs/fr-ca/glossary?term=security-assertion-markup-language" tip="Security Assertion Markup Language (SAML)
...
1. Pour tester votre connexion, suivez les étapes dans [Tester les connexions entreprise](/docs/docs/fr-ca/authenticate/identity-providers/enterprise-identity-providers/test-enterprise-connections).
...
Lors du dépannage de <Tooltip href="/docs/docs/fr-ca/glossary?term=single-sign-on" tip="Authentification unique (SSO)
...
* Une redirection de votre site d’origine vers l’<Tooltip href="/docs/docs/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
