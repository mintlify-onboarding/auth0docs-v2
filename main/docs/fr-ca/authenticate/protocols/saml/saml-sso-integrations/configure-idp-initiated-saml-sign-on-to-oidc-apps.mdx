...
Auth0 fournit une méthode pour traduire une réponse <Tooltip href="/docs/docs/fr-ca/glossary?term=security-assertion-markup-language" tip="Security Assertion Markup Language (SAML)
...
Service de stockage et de gestion des identités numériques." cta="Voir le glossaire">IdP</Tooltip>) en une réponse <Tooltip href="/docs/docs/fr-ca/glossary?term=openid" tip="OpenID
...
* [Connectez votre application aux fournisseurs d’identité SAML](/docs/docs/fr-ca/authenticate/identity-providers/enterprise-identity-providers/saml)
