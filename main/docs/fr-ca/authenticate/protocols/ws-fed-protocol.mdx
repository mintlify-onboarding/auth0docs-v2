...
Le protocole Web Services Federation (WS-Federation ou <Tooltip href="/docs/docs/fr-ca/glossary?term=ws-fed" tip="Web Service Federation (WS-Fed)
...
* [Configurer des applications WS-Fed](/docs/docs/fr-ca/get-started/applications/configure-ws-fed-applications)