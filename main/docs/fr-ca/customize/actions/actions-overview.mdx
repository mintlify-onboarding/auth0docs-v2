...
Les actions sont des fonctions sécurisées, spécifiques au locataire, [avec version](/docs/docs/fr-ca/customize/actions/manage-versions), écrites en Node.js qui s’exécutent à certains points de la plateforme Auth0. Les actions sont utilisées pour personnaliser et étendre les capacités d’Auth0 avec une logique personnalisée.
...
* Lorsque vous modifiez une Action dans le <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
Lorsque les Actions sont exécutées, Auth0 capturera des mesures clés à leur sujet et les reliera aux [journaux Auth0](/docs/docs/fr-ca/deploy-monitor/logs).
...
* [Programmez votre première Action](/docs/docs/fr-ca/customize/actions/write-your-first-action)!
* Consulter les [limitations actuelles des Actions](/docs/docs/fr-ca/customize/actions/limitations).

## En savoir plus

* [Write Your First Action (Programmer votre première action)](/docs/docs/fr-ca/customize/actions/write-your-first-action)
* [Explorer les déclencheurs](/docs/docs/fr-ca/customize/actions/explore-triggers)
* [Limitations des actions](/docs/docs/fr-ca/customize/actions/limitations)
* [Gérer les versions](/docs/docs/fr-ca/customize/actions/manage-versions)