...
* [Objet Event](/docs/docs/fr-ca/customize/actions/explore-triggers/mfa-notifications-trigger/send-phone-message-event-object) : Fournit des renseignements contextuels à propos du message à envoyer et de l’utilisateur à mettre au défi ou à inscrire.
* [Objet API](/docs/docs/fr-ca/customize/actions/explore-triggers/mfa-notifications-trigger/send-phone-message-api-object) : fournit des méthodes permettant de modifier le comportement du flux.
