...
Nous vous recommandons de tester les différentes actions du <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
Chaque fois qu’un déclencheur s’exécute et qu’une Action associée est liée à son Flux, vos [journaux de locataire](/docs/docs/fr-ca/deploy-monitor/logs/view-log-events) incluront les détails de l’exécution de l’Action.
...
<td><a href="/docs/docs/fr-ca/customize/actions/triggers/post-login">post-connexion</a></td>
</tr>
<tr>
...
<td><a href="/docs/docs/fr-ca/customize/actions/triggers/post-login">post-login</a></td>
</tr>
<tr>
...
<td><a href="/docs/docs/fr-ca/customize/actions/triggers/post-change-password">post-change-password</a></td>
</tr>
<tr>
...
<td><a href="/docs/docs/fr-ca/customize/actions/triggers/pre-user-registration">pre-user-registration</a></td>
</tr>
<tr>
...
<tr>
<td>Échange réussi</td>
<td><a href="/docs/docs/fr-ca/customize/actions/triggers/credentials-exchange">credentials-exchange</a></td>
</tr>
<tr>
<td>Échange échoué</td>
<td><a href="/docs/docs/fr-ca/customize/actions/triggers/credentials-exchange">credentials-exchange</a></td>
...
Lorsque vous construisez des Actions dans Auth0, [nous vous recommandons de créer un locataire Auth0 dédié par environnement](/docs/docs/fr-ca/get-started/auth0-overview/create-tenants/set-up-multiple-environments). Cela vous permet d’isoler votre base d’utilisateurs de production de vos autres environnements, ainsi que de configurer différents administrateurs par environnement (par exemple, les ingénieurs peuvent ne pas avoir accès à la configuration de production).

<Callout icon="file-lines" color="#0EA5E9" iconType="regular">

Si vous souhaitez gérer, tester et déployer entièrement vos Actions via une interface de ligne de commande ou un pipeline CI/CD, vous pouvez utiliser l’outil [Deploy CLI](/docs/docs/fr-ca/deploy-monitor/deploy-cli-tool).
