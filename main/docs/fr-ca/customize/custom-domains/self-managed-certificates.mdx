...
Vous devez avoir un abonnement Enterprise pour gérer les certificats dans votre domaine personnalisé. Pour en savoir plus, lisez [Tarification](https://auth0.com/pricing/) et [connexion](/docs/docs/fr-ca/authenticate/login) Auth0.
...
Vous pouvez utiliser un service tel que [Cloudflare](/docs/docs/fr-ca/customize/custom-domains/self-managed-certificates/configure-cloudflare-for-use-as-reverse-proxy), [Azure CDN](/docs/docs/fr-ca/customize/custom-domains/self-managed-certificates/configure-azure-cdn-for-use-as-reverse-proxy), [Google Cloud Platform](/docs/docs/fr-ca/customize/custom-domains/self-managed-certificates/configure-gcp-as-reverse-proxy), ou [AWS Cloudfront](/docs/docs/fr-ca/customize/custom-domains/self-managed-certificates/configure-aws-cloudfront-for-use-as-reverse-proxy) et configurer les paramètres de votre domaine personnalisé. Vous ajouterez la nouvelle valeur CNAME à votre DNS pour votre domaine personnalisé, pointant vers le nom de domaine du serveur mandataire inverse pour la distribution.
...
Il y a des étapes de configuration supplémentaires à suivre en fonction des fonctionnalités Auth0 que vous utilisez. Pour en savoir plus, veuillez consulter [Configure Features to Use Custom Domains (Configurer les fonctionnalités pour utiliser les domaines personnalisés)](/docs/docs/fr-ca/customize/custom-domains/configure-features-to-use-custom-domains).
...
* [Configurer Google Cloud Platform avec un équilibrage de charge en tant que proxy inverse](/docs/docs/fr-ca/customize/custom-domains/self-managed-certificates/configure-gcp-as-reverse-proxy)
* [Configurer Cloudflare en tant que proxy inverse](/docs/docs/fr-ca/customize/custom-domains/self-managed-certificates/configure-cloudflare-for-use-as-reverse-proxy)
* [Configurer AWS CloudFront en tant que proxy inverse](/docs/docs/fr-ca/customize/custom-domains/self-managed-certificates/configure-aws-cloudfront-for-use-as-reverse-proxy)
* [Configurer CDN en tant que proxy inverse](/docs/docs/fr-ca/customize/custom-domains/self-managed-certificates/configure-azure-cdn-for-use-as-reverse-proxy)
* [Configurer Akamai en tant que proxy inverse.](/docs/docs/fr-ca/customize/custom-domains/self-managed-certificates/configure-akamai-for-use-as-reverse-proxy)