...
Appelez le point de terminaison [Mettre à jour la configuration du domaine personnalisé](https://auth0.com/docs/api/management/v2#!/Custom_Domains/patch_custom_domains_by_id) d’Auth0 <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
