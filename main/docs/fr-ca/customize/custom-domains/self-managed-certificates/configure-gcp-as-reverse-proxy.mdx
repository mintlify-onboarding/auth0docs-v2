...
1. [Configurer des domaines personnalisés avec des certificats autogérés](/docs/docs/fr-ca/customize/custom-domains/self-managed-certificates) si ce n’est déjà fait. Prenez note des valeurs **Nom du domaine d’origine** et `cname-api-key` pour utilisation ultérieure.
