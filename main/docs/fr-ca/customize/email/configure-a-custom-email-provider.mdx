...
Vous pouvez configurer un fournisseur de courrier électronique personnalisé à l’aide de <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
Toutes les Actions sont soumises aux mêmes [limites](/docs/docs/fr-ca/customize/actions/limitations).
...
Pour en savoir plus sur la création et le déploiement d’actions, consultez [Créer votre première action](/docs/docs/fr-ca/customize/actions/write-your-first-action).