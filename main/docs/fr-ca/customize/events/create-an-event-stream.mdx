...
Event streams can either be provisioned using the <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
Principal produit d’Auth0 pour configurer vos services." cta="Voir le glossaire">Auth0 dashboard</Tooltip> or the [Auth0 Management API](/docs/fr-ca/api/management/v2). If using the <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
