...
* **callback(error, user)** : Rappel auquel vous pouvez renvoyer une erreur et l’objet utilisateur qui doit être envoyé au <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
