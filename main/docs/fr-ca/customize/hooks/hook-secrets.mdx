...
Vous pouvez créer, mettre à jour, supprimer et consulter les secrets des hooks depuis le Dashboard ou <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
