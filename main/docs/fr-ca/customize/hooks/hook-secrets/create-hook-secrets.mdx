...
Vous pouvez créer plusieurs Secrets d’appel pour n’importe quel [Hook](/docs/fr-ca/customize/hooks) à l’aide de Dashboard ou de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
