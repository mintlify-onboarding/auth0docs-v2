...
Vous pouvez mettre à jour les secrets d’appels ajoutés à un appel donné à l’aide du Dashboard ou de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
