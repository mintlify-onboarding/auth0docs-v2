...
Le guide vous montre ensuite comment configurer Amazon API Gateway en utilisant les fonctions AWS Lambda, en sécurisant ces fonctions avec les rôles IAM AWS, puis en obtenant un jeton pour le rôle IAM AWS à l’aide de la délégation Auth0. Il vous montrera ensuite comment attribuer différentes autorisations à diverses classes d’utilisateurs, comme la base de données interne ou les utilisateurs sociaux, et comment faire circuler l’identité à l’aide d’un jeton Web JSON (<Tooltip href="/docs/docs/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
...
* [Étape 1 – Configuration de la passerelle API AWS](/docs/docs/fr-ca/customize/integrations/aws/aws-api-gateway-delegation/aws-api-gateway-delegation-1)
* [Étape 2 - Sécuriser et déployer la Passerelle API Amazon](/docs/docs/fr-ca/customize/integrations/aws/aws-api-gateway-delegation/aws-api-gateway-delegation-2)
* [Étape 3 – Création de l’application](/docs/docs/fr-ca/customize/integrations/aws/aws-api-gateway-delegation/aws-api-gateway-delegation-3)
* [Étape 4 - Utiliser plusieurs rôles avec Amazon API Gateway](/docs/docs/fr-ca/customize/integrations/aws/aws-api-gateway-delegation/aws-api-gateway-delegation-4)
* [Étape 6 - Utilisation des jetons d’identité pour le flux Identité](/docs/docs/fr-ca/customize/integrations/aws/aws-api-gateway-delegation/aws-api-gateway-delegation-5)