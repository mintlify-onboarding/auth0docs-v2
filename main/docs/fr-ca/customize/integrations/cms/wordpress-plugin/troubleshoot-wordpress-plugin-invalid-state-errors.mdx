...
Excluez la mise en cache sur votre serveur pour toutes les URL indiquées dans le champ **URL de rappel autorisées** dans <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Dashboard Auth0 > Applications > Applications > Paramètres</AuthLink> et testez à nouveau. En outre, excluez la mise en cache de l’URL du site (`/index.php` sur une installation normale) si elle comporte un paramètre URL Auth0.
