...
When integrating Auth0 with your Netlify project, you'll need to provide your application with authentication settings such as the **<Tooltip href="/docs/docs/fr-ca/glossary?term=client-id" tip="ID client
...
After adding the Auth0 integration to your Netlify project, the <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
