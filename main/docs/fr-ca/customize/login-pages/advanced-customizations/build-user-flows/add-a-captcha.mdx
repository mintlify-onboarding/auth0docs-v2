...
In your Auth0 tenant, navigate to [Dashboard > Security > Attack Protection](https://manage.auth0.com/#/security/attack-protection/bot-detection) and enable at least one <Tooltip href="/docs/docs/fr-ca/glossary?term=bot-detection" tip="Détection de robots
