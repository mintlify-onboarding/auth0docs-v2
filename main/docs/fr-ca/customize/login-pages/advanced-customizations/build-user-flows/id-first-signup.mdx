...
Dans votre <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
<tbody>
<tr>
<td><a href="/docs/docs/fr-ca/customize/login-pages/advanced-customizations">Personnalisations avancées pour la connexion universelle</a></td>
<td>Fonctionnement des personnalisations avancées.</td>
</tr>
<tr>
<td><a href="/docs/docs/fr-ca/customize/login-pages/advanced-customizations/getting-started">Mise en route des personnalisations avancées</a></td>
<td>Notions de base pour la mise en route des personnalisations avancées</td>
</tr>
<tr>
<td><a href="/docs/docs/fr-ca/customize/login-pages/advanced-customizations/screens">Personnalisations avancées pour la connexion universelle : Écrans</a></td>
