...
Cette méthode redirige l’utilisateur vers le fournisseur d’identité sociale ou d’entreprise (<Tooltip href="/docs/docs/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
