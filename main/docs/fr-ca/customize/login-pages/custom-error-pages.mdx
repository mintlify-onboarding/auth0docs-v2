...
Utilisez le point de terminaison de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
<tr>
<td>`{mgmtApiAccessToken}`</td>
<td><a href="/docs/docs/fr-ca/api/management/v2/tokens">Jeton d’accès du Management API</a> avec la permission `update:tenant_settings`.</td>
</tr>
<tr>
<td>`show_log_link`</td>
