...
**Scenario: Custom phone provider configured using Terraform is not taking effect, and the <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
* If you encounter this scenario after managing your custom providers through multiple methods (Terraform, Auth0 Dashboard, <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
