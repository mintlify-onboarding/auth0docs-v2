...
The Unified Phone Experience does not use the [custom SMS gateway](/docs/fr-ca/authenticate/passwordless/authentication-methods/use-sms-gateway-passwordless) you configured for Passwordless SMS. You can use the <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
Principal produit d’Auth0 pour configurer vos services." cta="Voir le glossaire">Auth0 Dashboard</Tooltip> or <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
