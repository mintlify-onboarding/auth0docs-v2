...
Chaîne de caractères. Jeton d’accès de courte durée pour <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
Chaîne de caractères. Le chemin d’accès à la clé privée utilisée par le client pour faciliter l’authentification par clé privée <Tooltip href="/docs/docs/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
