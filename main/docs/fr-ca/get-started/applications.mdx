...
* **Type d’application**: Pour ajouter l’authentification à votre application, vous devez l’enregistrer dans <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
Vous pouvez [supprimer une application](/docs/fr-ca/get-started/applications/remove-applications) à partir du Dashboard ou <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
