...
Ni les applications internes ni les applications tierces ne peuvent utiliser les jetons d’ID pour invoquer les points de terminaison du <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
