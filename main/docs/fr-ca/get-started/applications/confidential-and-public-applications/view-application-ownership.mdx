...
et `{yourMgmtApiAccessToken}` avec votre ID client et votre jeton d’accès de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
export const codeExample2 = `var client = new RestClient("https://{yourDomain}/api/v2/clients/%7ByourClientId%7D?fields=is_first_party&include_fields=true");
...
export const codeExample4 = `HttpResponse response = Unirest.get("https://{yourDomain}/api/v2/clients/%7ByourClientId%7D?fields=is_first_party&include_fields=true")
  .header("authorization", "Bearer {yourMgmtApiAccessToken}")
  .asString();`;
...
<td><a href="/docs/docs/fr-ca/api/management/v2/tokens">Jetons d’accès à Management API</a> avec la <dfn id="react-containers-DefinitionTooltip-1"><span class="tooltip-portal-underlined-word" data-react-universal-portal="">permission</span></dfn> `read:clients`.</td>
</tr>
</tbody>
</table>
