...
Dans <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
2. Activez l’option **Notification poussée via Gardien Auth0**. Cela peut nécessiter des paramètres de configuration de la <Tooltip href="/docs/docs/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
