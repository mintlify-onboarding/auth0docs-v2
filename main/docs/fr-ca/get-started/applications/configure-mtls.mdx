...
<tbody>
<tr>
<td><a href="/docs/docs/fr-ca/get-started/applications/configure-mtls/set-up-the-customer-edge">Configurer votre Edge client</a></td>
...
<tr>
<td><a href="/docs/docs/fr-ca/get-started/applications/configure-mtls/configure-mtls-for-a-client">Configurer mTLS pour un client</a></td>
<td>Comment configurer l’authentification mTLS pour votre application Auth0.</td>
</tr>
<tr>
<td><a href="/docs/docs/fr-ca/get-started/applications/configure-mtls/configure-mtls-for-a-tenant">Configurer mTLS pour un locataire</a></td>
