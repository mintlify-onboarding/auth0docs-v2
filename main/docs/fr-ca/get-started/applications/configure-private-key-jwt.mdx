...
L’authentification par clé privée <Tooltip href="/docs/docs/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
...
<td><a href="/docs/docs/fr-ca/secure/tokens/access-tokens/management-api-access-tokens">Jeton d’accès pour Management API</a> avec la permission `create:credentials`.</td>
</tr>
<tr>
<td>`pem`</td>
...
<tr>
<td>`managementApiAccessToken`</td>
<td><a href="/docs/docs/fr-ca/secure/tokens/access-tokens/management-api-access-tokens">Jeton d’accès à Management API</a> avec la permission `create:credentials`.</td>
</tr>
<tr>
<td>`pem`</td>
...
<tr>
<td>`managementApiAccessToken`</td>
<td><a href="/docs/docs/fr-ca/secure/tokens/access-tokens/management-api-access-tokens">Jeton d’accès à Management API</a> avec les permissions `update:client` et `update:credentials`.</td>
</tr>
<tr>
<td>`credentialId`</td>
...
<tr>
<td>`managementApiAccessToken`</td>
<td><a href="/docs/docs/fr-ca/secure/tokens/access-tokens/management-api-access-tokens">Jeton d’accès pour Management API</a> avec les permissions `update:client`</td>
</tr>
<tr>
