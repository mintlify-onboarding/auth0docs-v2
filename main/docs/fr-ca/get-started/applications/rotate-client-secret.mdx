...
Vous pouvez modifier le secret client d’une application à l’aide de l’<Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
<td><a href="/docs/docs/fr-ca/api/management/v2/tokens">Jetons d’accès à Management API</a> avec la permission `update:client_keys`.</td>
</tr>
</tbody>
</table>
