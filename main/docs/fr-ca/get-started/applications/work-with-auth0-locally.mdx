...
1. Accédez à <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Auth0 Dashboard > Applications > Applications</AuthLink> et cliquez sur l’application.
