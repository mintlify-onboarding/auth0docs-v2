...
* L’utilisation de tout code personnalisé dans Auth0 (actions, règles, hooks, scripts de base de données personnalisés, connexions <Tooltip href="/docs/docs/fr-ca/glossary?term=oath2" tip="OAuth 2.0
...
* Assurez-vous d’utiliser vos propres identifiants de compte pour toutes les connexions sociales plutôt que les clés de développement Auth0. Dans l’<Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
