...
Auth0 ne communiquera pas avec le fournisseur d’identité en amont, si une session <Tooltip href="/docs/docs/fr-ca/glossary?term=single-sign-on" tip="Authentification unique (SSO)
