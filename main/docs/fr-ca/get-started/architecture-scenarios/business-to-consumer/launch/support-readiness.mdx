...
L’outi [jwt.io](https://jwt.io/) a été créé par Auth0 et vous permet de visualiser le contenu d’un jeton au format <Tooltip href="/docs/docs/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
