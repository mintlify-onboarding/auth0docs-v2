...
* Vérifier que le jeton <Tooltip href="/docs/docs/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
...
<td>Le défi-réponse de code généré par le vérificateur de code. Vous trouverez des instructions sur la génération d’un défi-réponse de code <a href="/docs/docs/fr-ca/flows/guides/auth-code-pkce/call-api-auth-code-pkce#authorize-the-user#create-a-code-verifier">ici</a>.</td>
</tr>
<tr>
...
<td>Clé cryptographiquement aléatoire utilisée pour générer le `code_challenge` transmis à <a href="/docs/docs/fr-ca/api/authentication#authorization-code-grant-pkce-">authorization URL</a> (`/authorize`).</td>
</tr>
<tr>
