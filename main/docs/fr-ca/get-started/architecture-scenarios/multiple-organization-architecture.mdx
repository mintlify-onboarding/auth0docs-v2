...
* **Employé** : personne qui travaille pour votre entreprise. Ils auront généralement un compte dans votre fournisseur d’identité (<Tooltip href="/docs/docs/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
...
Pour d’autres accès administratifs, vous voudrez généralement construire votre propre API et/ou application que vous utiliserez en collaboration avec l’Auth0 <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
