...
La configuration d’Auth0 commence par l’enregistrement de l’application de feuilles de temps dans l’<Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
Le champ **URL de rappel autorisées** contient les URL vers lesquels Auth0 redirigera l’utilisateur après son authentification pour permettre à <Tooltip href="/docs/docs/fr-ca/glossary?term=openid" tip="OpenID
...
* Entreprise : Permettez à vos utilisateurs de se connecter en utilisant Active Directory, ADFS, LDAP, <Tooltip href="/docs/docs/fr-ca/glossary?term=security-assertion-markup-language" tip="Security Assertion Markup Language (SAML)
