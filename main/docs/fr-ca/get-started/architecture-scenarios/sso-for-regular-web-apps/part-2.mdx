...
Cliquez ensuite sur **Créer** pour accéder à la <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/quickstart">vue de démarrage rapide</AuthLink>. Dans cette vue, vous pouvez choisir la technologie que vous prévoyez d’utiliser pour créer votre application et des instructions de démarrage rapide seront affichées.

Voici les autres vues disponibles :

* <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Paramètres</AuthLink>
* <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/addons">Modules complémentaires</AuthLink>
* <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/connections">Connexions</AuthLink>
