...
* **AI agents:** Control autonomous AI agent access to external APIs using <Tooltip href="/docs/docs/fr-ca/glossary?term=oath2" tip="OAuth 2.0
...
* **Comprehensive security controls:** Secures authentication flows with OAuth 2.0 and <Tooltip href="/docs/docs/fr-ca/glossary?term=openid" tip="OpenID
...
Leverage OAuth 2.0 and OpenID Connect to securely authenticate users with [Universal Login](/docs/fr-ca/authenticate/login/auth0-universal-login). With [Client-Initiated Account Linking](https://auth0.com/ai/docs/client-initiated-account-linking), AI agents can request access and connect to multiple <Tooltip href="/docs/docs/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
...
Using [Token Vault](/docs/fr-ca/secure/tokens/token-vault), AI agents can fetch <Tooltip href="/docs/docs/fr-ca/glossary?term=access-token" tip="Jeton d’accès
