...
* Vous avez des groupes d’utilisateurs provenant de connexions différentes. Par exemple, un locataire pourrait demander aux utilisateurs de fournir des identifiants nom d’utilisateur/mot de passe, tandis qu’un autre locataire pourrait demander aux utilisateurs de se connecter par l’intermédiaire d’un <Tooltip href="/docs/docs/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
...
Cette approche vous permet de partager l’accès à <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
