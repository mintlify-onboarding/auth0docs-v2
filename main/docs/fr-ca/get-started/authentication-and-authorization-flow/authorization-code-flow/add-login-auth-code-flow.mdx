...
export const codeExample3 = `curl --request POST \
...
export const codeExample4 = `var client = new RestClient("https://{yourDomain}/oauth/token");
...
export const codeExample5 = `package main
...
export const codeExample6 = `HttpResponse response = Unirest.post("https://{yourDomain}/oauth/token")
  .header("content-type", "application/x-www-form-urlencoded")
  ...
  .asString();`;
export const codeExample7 = `var axios = require("axios").default;
...
export const codeExample8 = `#import <Foundation/Foundation.h>
...
[dataTask resume];`;
export const codeExample9 = `$curl = curl_init();
...
export const codeExample10 = `import http.client
...
export const codeExample11 = `require 'uri'
require 'net/http'
require 'openssl'
...
export const codeExample12 = `import Foundation
...
<AuthCodeBlock children={codeExample4} language="csharp" filename="C#" />
<AuthCodeBlock children={codeExample5} language="go" filename="Go" />
<AuthCodeBlock children={codeExample6} language="java" filename="Java" />
<AuthCodeBlock children={codeExample7} language="javascript" filename="Node.JS" />
<AuthCodeBlock children={codeExample8} language="obj-c" filename="Obj-C" />
<AuthCodeBlock children={codeExample9} language="php" filename="PHP" />
<AuthCodeBlock children={codeExample10} language="python" filename="Python" />
<AuthCodeBlock children={codeExample11} language="ruby" filename="Ruby" />
<AuthCodeBlock children={codeExample12} language="swift" filename="Swift" />
</CodeGroup>
