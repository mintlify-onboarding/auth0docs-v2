...
La demande PAR permet à votre application d’envoyer les paramètres des demandes d’autorisation <Tooltip href="/docs/docs/fr-ca/glossary?term=oath2" tip="OAuth 2.0
