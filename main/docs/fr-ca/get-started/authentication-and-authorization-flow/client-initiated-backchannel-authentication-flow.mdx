...
Le flux d’authentification par voie de retour initié par le client (CIBA) est une norme <Tooltip href="/docs/docs/fr-ca/glossary?term=openid" tip="OpenID
...
<tbody>
<tr>
<td><a href="/docs/docs/fr-ca/get-started/applications/configure-client-initiated-backchannel-authentication">Configurer une authentification Back-channel initiée par le client</a></td>
<td>Comment configurer le type d’autorisation CIBA pour votre application.</td>
</tr>
<tr>
<td><a href="/docs/docs/fr-ca/get-started/authentication-and-authorization-flow/client-initiated-backchannel-authentication-flow/user-authentication-with-ciba">Authentification des utilisateurs avec CIBA</a></td>
