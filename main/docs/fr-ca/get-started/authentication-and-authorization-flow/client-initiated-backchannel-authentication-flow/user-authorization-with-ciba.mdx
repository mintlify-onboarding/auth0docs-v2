...
[Client-Initiated Backchannel Authentication (CIBA)](/docs/fr-ca/get-started/authentication-and-authorization-flow/client-initiated-backchannel-authentication-flow) is an <Tooltip href="/docs/docs/fr-ca/glossary?term=oath2" tip="OAuth 2.0
Cadre d’applications d’autorisation qui définit les protocoles d’autorisation et les flux de production." cta="Voir le glossaire">OAuth 2.0</Tooltip> specification that allows a client application to initiate an authentication and/or <Tooltip href="/docs/docs/fr-ca/glossary?term=authorization-flow" tip="Flux d’autorisation
...
You can use CIBA with RAR to pass <Tooltip href="/docs/docs/fr-ca/glossary?term=fine-grained-auth" tip="Autorisation à granularité fine (FGA)
Produit Auth0 permettant à des utilisateurs individuels d’accéder à des objets ou ressources particulières." cta="Voir le glossaire">fine-grained authorization</Tooltip> data to the <Tooltip href="/docs/docs/fr-ca/glossary?term=authorization-server" tip="Serveur d’autorisations :
...
* [Enroll the authorizing user in MFA using push notifications via the Guardian SDK](/docs/fr-ca/secure/multi-factor-authentication/auth0-guardian#enroll-in-push-notifications). To verify in the <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
If you have set <Tooltip href="/docs/docs/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
...
* [Configure Rich Authorization Requests](/docs/fr-ca/get-started/apis/configure-rich-authorization-requests) for your <Tooltip href="/docs/docs/fr-ca/glossary?term=resource-server" tip="Serveur de ressources
...
If the user approves the push request, Auth0 returns an <Tooltip href="/docs/docs/fr-ca/glossary?term=access-token" tip="Jeton d’accès
