...
* Vérification des sessions actives d’authentification unique (<Tooltip href="/docs/docs/fr-ca/glossary?term=single-sign-on" tip="Authentification unique (SSO)
...
<tr>
<td>`nonce`</td>
<td>Une chaîne cryptographiquement aléatoire que votre application ajoute à la requête initiale et qu’Auth0 inclut dans le jeton d’ID, <a href="/docs/docs/fr-ca/api-auth/tutorials/nonce">utilisée pour prévenir les attaques par réinsertion de jeton</a>.</td>
</tr>
<tr>
<td>`organization`</td>
