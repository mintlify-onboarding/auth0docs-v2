...
Vous pouvez utiliser <Tooltip href="/docs/docs/fr-ca/glossary?term=openid" tip="OpenID
...
Le Flux implicite avec Form Post utilise OIDC pour implémenter l’ouverture de session sur le web, qui est très similaire au fonctionnement de <Tooltip href="/docs/docs/fr-ca/glossary?term=security-assertion-markup-language" tip="Security Assertion Markup Language (SAML)
