...
<tr>
<td>`client_id`</td>
<td>L’ID client de votre application. Vous trouverez cette valeur dans vos <AuthLink href="https://manage.auth0.com/#/Applications/{yourClientId}/settings">paramètres de l’application</AuthLink>.</td>
</tr>
<tr>
...
<tr>
<td>`client_secret`</td>
<td>Secret du client de votre application. Requis lorsque le secret du client est la méthode d’authentification de l’application. <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Paramètres de l’application</AuthLink> est `Post` ou `Basic`. Si votre application n’est pas très fiable (p. ex., une SPA), ne définissez pas ce paramètre.</td>
</tr>
<tr>
<td>`audience`</td>
