...
Le [cadre d’applications Authorization OAuth 2.0](/docs/fr-ca/authenticate/protocols/oauth) prend en charge différents flux (ou autorisations) différents. <Tooltip href="/docs/docs/fr-ca/glossary?term=flow" tip="Flux
...
L’authentification par canal arrière initiée par le client (CIBA) est une norme de la <Tooltip href="/docs/docs/fr-ca/glossary?term=openid" tip="OpenID
