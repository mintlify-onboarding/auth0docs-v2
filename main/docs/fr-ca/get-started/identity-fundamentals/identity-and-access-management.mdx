...
* **Authentification multifacteur (<Tooltip href="/docs/docs/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
...
* **Autorisation précise (<Tooltip href="/docs/docs/fr-ca/glossary?term=fine-grained-auth" tip="Autorisation à granularité fine (FGA)
...
<Tooltip href="/docs/docs/fr-ca/glossary?term=oath2" tip="OAuth 2.0
...
<Tooltip href="/docs/docs/fr-ca/glossary?term=openid" tip="OpenID
...
Jetons Web JSON (<Tooltip href="/docs/docs/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
...
<Tooltip href="/docs/docs/fr-ca/glossary?term=security-assertion-markup-language" tip="Security Assertion Markup Language (SAML)
