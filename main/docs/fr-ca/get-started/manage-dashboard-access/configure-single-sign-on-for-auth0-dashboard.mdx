...
Vous pouvez configurer Auth0 pour qu’il autorise les [membres locataires](/docs/fr-ca/get-started/manage-dashboard-access) à utiliser votre propre [fournisseur d’identité Enterprise](/docs/fr-ca/authenticate/identity-providers/enterprise-identity-providers) (<Tooltip href="/docs/docs/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
Service de stockage et de gestion des identités numériques." cta="Voir le glossaire">IdP</Tooltip>) pour s’authentifier auprès de <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
Principal produit d’Auth0 pour configurer vos services." cta="Voir le glossaire">Auth0 Dashboard</Tooltip> via l’authentification unique (<Tooltip href="/docs/docs/fr-ca/glossary?term=single-sign-on" tip="Authentification unique (SSO)
...
* Les invitations de membres locataires ne peuvent ni être automatisées, ni être envoyées en masse avec Auth0 <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
* La <Tooltip href="/docs/docs/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
...
Auth0 prend en charge la configuration de SSO pour le Dashboard avec un IdP <Tooltip href="/docs/docs/fr-ca/glossary?term=security-assertion-markup-language" tip="Security Assertion Markup Language (SAML)
...
Si vous utilisez <Tooltip href="/docs/docs/fr-ca/glossary?term=universal-login" tip="Connexion universelle
