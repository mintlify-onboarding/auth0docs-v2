...
Utilisez `déconnexion` pour déconnecter vos utilisateurs. Assurez-vous que `returnTo` est spécifié dans **URL de déconnexion autorisées**dans votre <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
