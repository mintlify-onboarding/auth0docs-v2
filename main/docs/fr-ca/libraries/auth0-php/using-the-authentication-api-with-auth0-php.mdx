...
2. Nous vérifions que nous avons une valeur `state` et qu’elle coïncide à la même que celle générée. [Ceci est important pour éviter les attaques CSRF.](/docs/docs/fr-ca/secure/attack-protection)
...
Consultez [Utilisation de Management API avec Auth0-PHP](/docs/docs/fr-ca/libraries/auth0-php/using-the-management-api-with-auth0-php) pour plus d’informations sur la façon d’utiliser ce jeton d’accès.
