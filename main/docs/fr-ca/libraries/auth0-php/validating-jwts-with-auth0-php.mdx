...
La documentation ci-dessous part du principe que vous avez suivi les étapes du [guide de démarrage de PHP](/docs/docs/fr-ca/libraries/auth0-php), et que vous avez utilisé le code fourni.
