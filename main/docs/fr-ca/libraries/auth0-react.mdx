...
Utilisez `logout (déconnexion)` pour déconnecter vos utilisateurs. Assurez-vous que `returnTo` est indiqué dans « URL de déconnexions autorisées » dans <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
