...
Après une connexion réussie, Auth0 redirigera l’utilisateur vers l’URL de rappel configurée avec un <Tooltip href="/docs/docs/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
