...
Lorsque vous cliquez sur le bouton <Tooltip href="/docs/docs/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
...
Si vous ne souhaitez pas afficher de fenêtre contextuelle et que vous n’avez pas besoin de la <Tooltip href="/docs/docs/fr-ca/glossary?term=single-sign-on" tip="Authentification unique (SSO)
