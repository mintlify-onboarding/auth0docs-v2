...
Différentes valeurs sont prises en charge pour le paramètre scope. Gardez à l’esprit que les <Tooltip href="/docs/docs/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
