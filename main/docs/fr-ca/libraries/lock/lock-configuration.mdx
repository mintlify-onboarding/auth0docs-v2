...
<td>Lorsque vous utilisez `Auth0LockPasswordless` avec une connexion courriel, vous pouvez utiliser cette option pour choisir entre l’envoi d’un <a href="/docs/docs/fr-ca/connections/passwordless/spa-email-code">code</a> ou un <a href="/docs/docs/fr-ca/connections/passwordless/spa-email-link">magic link</a> pour authentifier l’utilisateur</td>
</tr>
</tbody>
</table>
...
Exemples de `allowedConnections`:](/docs/images/
...
Demande des données d’authentification unique (<Tooltip href="/docs/docs/fr-ca/glossary?term=single-sign-on" tip="Authentification unique (SSO)
...
`allowForgotPassword: false`](/docs/images/
