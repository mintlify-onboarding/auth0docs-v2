...
Vous pouvez activer le [contrôle d'accès basé sur les rôles (RBAC)](/docs/fr-ca/manage-users/access-control/rbac) à l’aide de <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
2. Faites défiler jusqu’aux **RBAC Settings (Paramètres RBAC)** et activez la bascule **Enable RBAC (Activer RBAC)**.](/docs/images/
