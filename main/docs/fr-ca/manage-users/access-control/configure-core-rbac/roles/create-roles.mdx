...
* Pour que le contrôle d'accès basé sur les rôles (RBAC) fonctionne correctement, vous devez l’activer pour votre API en utilisant soit le Dashboard, soit <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
* [Mettre en place une API](/docs/fr-ca/get-started/auth0-overview/set-up-apis) dans l’<Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
export const codeExample2 = `var client = new RestClient("https://{yourDomain}/api/v2/roles");
...
export const codeExample4 = `HttpResponse<String> response = Unirest.post("https://{yourDomain}/api/v2/roles")
  .header("content-type", "application/json")
  .header("authorization", "Bearer MGMT_API_ACCESS_TOKEN")
  .header("cache-control", "no-cache")
