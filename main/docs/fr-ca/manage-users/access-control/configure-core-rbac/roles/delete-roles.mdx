...
Vous pouvez supprimer un [rôle](/docs/fr-ca/manage-users/access-control/rbac) avec <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
