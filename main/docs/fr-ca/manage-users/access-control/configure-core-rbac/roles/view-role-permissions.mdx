...
Vous pouvez afficher les [autorisations](/docs/fr-ca/manage-users/access-control/rbac) attribuées à un rôle en utilisant <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
