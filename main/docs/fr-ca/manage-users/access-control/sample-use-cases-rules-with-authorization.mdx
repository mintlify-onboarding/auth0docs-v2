...
Si vous procédez aux actions [activer RBAC pour les API](/docs/fr-ca/get-started/apis/enable-role-based-access-control-for-apis) ainsi que « Ajouter des autorisations dans le jeton d’accès » (ou activer RBAC via <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
