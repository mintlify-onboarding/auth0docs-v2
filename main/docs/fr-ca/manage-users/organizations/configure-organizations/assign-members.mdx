...
Pour gérer les membres directement, vous pouvez utiliser le <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
Principal produit d’Auth0 pour configurer vos services." cta="Voir le glossaire">Auth0 Dashboard</Tooltip> (Tableau de bord Auth0) ou <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
<td><a href="/docs/docs/fr-ca/tokens/management-api-access-tokens">Jetons d’accès pour Management API</a> avec la permission `create:organization_members`.</td>
</tr>
<tr>
<td>`USER_ID`</td>
