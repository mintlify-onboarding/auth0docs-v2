...
Vous pouvez désactiver les connexions d’[organisations](/docs/fr-ca/manage-users/organizations/organizations-overview) à l’aide d’<Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
export const codeExample2 = `var client = new RestClient("https://{yourDomain}/api/v2/organizations/ORG_ID/enabled_connections/CONNECTION_ID");
...
export const codeExample4 = `HttpResponse<String> response = Unirest.delete("https://{yourDomain}/api/v2/organizations/ORG_ID/enabled_connections/CONNECTION_ID")
  .header("authorization", "Bearer MGMT_API_ACCESS_TOKEN")
  .asString();`;
...
<td><a href="/docs/docs/fr-ca/tokens/management-api-access-tokens">Jeton d’accès pour Management API</a> avec la permission `delete:organization_connections`.</td>
</tr>
<tr>
<td>`CONNECTION_ID`</td>
