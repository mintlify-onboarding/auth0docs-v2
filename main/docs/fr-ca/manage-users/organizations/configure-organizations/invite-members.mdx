...
Comme la langue de l’utilisateur invité n’est pas connue à l’avance, vous pouvez envoyer un paramètre facultatif `user_metadata` au point de terminaison de l’invitation à l’aide de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
Vous pouvez [envoyer des invitations d’adhésion à une organization](/docs/fr-ca/manage-users/organizations/configure-organizations/send-membership-invitations) aux utilisateurs à l’aide de <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
