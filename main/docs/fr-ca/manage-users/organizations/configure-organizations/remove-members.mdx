...
export const codeExample4 = `HttpResponse<String> response = Unirest.delete("https://{yourDomain}/api/v2/organizations/ORG_ID/members")
  .header("authorization", "Bearer MGMT_API_ACCESS_TOKEN")
  .header("cache-control", "no-cache")
...
<td><a href="/docs/docs/fr-ca/tokens/management-api-access-tokens">Jeton d’accès pour Management API</a> avec la permission `delete:organization_members`.</td>
</tr>
<tr>
<td>`USER_ID`</td>
