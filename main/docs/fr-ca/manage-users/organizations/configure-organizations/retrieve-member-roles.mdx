...
Vous pouvez afficher les rôles associés à un membre de l’organisation à l’aide du <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
<td><a href="/docs/docs/fr-ca/tokens/management-api-access-tokens">Jeton d’accès pour Management API</a> avec la permission `read:organization_member_roles`.</td>
</tr>
</tbody>
</table>
