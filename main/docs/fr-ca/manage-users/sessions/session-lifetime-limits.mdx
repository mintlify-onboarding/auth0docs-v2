...
Ces paramètres sont configurés sur le locataire; vous pouvez les configurer à l’aide de [Auth0 Dashboard](/docs/fr-ca/manage-users/sessions/configure-session-lifetime-settings) ou de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
