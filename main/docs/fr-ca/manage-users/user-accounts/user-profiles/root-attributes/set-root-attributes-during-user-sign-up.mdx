...
Vous pouvez établir les attributs racine pour les utilisateurs au cours de l’inscription en utilisant <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
<td><a href="/docs/docs/fr-ca/api/management/v2/tokens">Jeton d’accès pour Management API</a> avec la <dfn id="react-containers-DefinitionTooltip-1"><span class="tooltip-portal-underlined-word" data-react-universal-portal="">permission</span></dfn> `create:users`.</td>
</tr>
<tr>
