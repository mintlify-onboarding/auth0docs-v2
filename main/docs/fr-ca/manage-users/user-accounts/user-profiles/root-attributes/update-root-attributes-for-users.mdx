...
Vous pouvez mettre à jour les attributs racine d’un profil utilisateur existant à l’aide de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
