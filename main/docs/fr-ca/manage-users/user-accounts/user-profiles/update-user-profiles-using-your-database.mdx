...
Une fois qu’un utilisateur a été migré, vous pourrez également mettre à jour les champs tels que `name`, `nickname`, `given_name`, `family_name`, `picture`, `email` et `email_verified` par le biais de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
