...
Le tableau `user.mfa_factors` contient les inscriptions à <Tooltip href="/docs/docs/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
