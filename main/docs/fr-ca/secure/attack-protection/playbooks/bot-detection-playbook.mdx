...
While setting the <Tooltip href="/docs/docs/fr-ca/glossary?term=bot-detection" tip="Détection de robots
...
* **Technical capacity**: assess your ability to implement IP blocking, WAF rules, and <Tooltip href="/docs/docs/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
