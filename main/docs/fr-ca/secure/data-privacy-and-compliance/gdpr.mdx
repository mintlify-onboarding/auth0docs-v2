...
* Fournir les moyens de permettre aux clients de récupérer, d’examiner, de corriger ou de supprimer des données client à partir de l’<Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
Principal produit d’Auth0 pour configurer vos services." cta="Voir le glossaire">Auth0 Dashboard</Tooltip> et de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
* Protégez les informations d’identification du tableau de bord Auth0 Management et exigez une authentification multifacteur (<Tooltip href="/docs/docs/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
