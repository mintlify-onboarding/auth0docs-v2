...
Au lieu de créer une application de zéro, nous allons [utiliser l’exemple Guide rapide JavaScript](/docs/fr-ca/quickstart/spa/vanillajs) d’Auth0. Nous utiliserons d’autre part les pages <Tooltip href="/docs/docs/fr-ca/glossary?term=universal-login" tip="Connexion universelle
