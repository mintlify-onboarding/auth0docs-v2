...
En utilisant Bring Your Own Key (BYOK, « Utilisez votre propre clé »), les utilisateurs avec le [rôle Éditeur de gestion de clés](/docs/fr-ca/get-started/manage-dashboard-access/add-dashboard-users) peuvent utiliser le <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
