...
Une fois qu’un utilisateur s’est inscrit ou qu’il a été créé dans votre locataire, vous pouvez créer des inscriptions avec le point de terminaison du <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
