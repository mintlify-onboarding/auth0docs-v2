...
`languageDictionary` peut être utilisé pour remplacer le texte dans de nombreux domaines du processus <Tooltip href="/docs/docs/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
