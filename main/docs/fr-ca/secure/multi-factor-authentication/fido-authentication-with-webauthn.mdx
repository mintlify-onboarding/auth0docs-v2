...
* Les utilisateurs sont authentifiés avec nom d’utilisateur/mot de passe.
* Ceux-ci utilisent une autre méthode d’authentification <Tooltip href="/docs/docs/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
