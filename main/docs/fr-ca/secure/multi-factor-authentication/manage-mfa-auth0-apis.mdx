...
Auth0 fournit deux API différentes pour vous aider, vous et vos utilisateurs, à gérer les facteurs d’authentification <Tooltip href="/docs/docs/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
...
Cette méthode repose sur l’authentification à l’aide du flux d’authentification <Tooltip href="/docs/docs/fr-ca/glossary?term=resource-owner" tip="Propriétaire de ressources
