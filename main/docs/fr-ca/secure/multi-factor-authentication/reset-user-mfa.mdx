...
Un utilisateur peut se servir d’un code de récupération pour se connecter en cas de perte de son appareil mobile. S’il n’a pas de code de récupération, il devra demander à l’administrateur de son locataire de réinitialiser son authentification multifacteur (<Tooltip href="/docs/docs/fr-ca/glossary?term=multifactor-authentication" tip="Authentification multifacteur (MFA)
