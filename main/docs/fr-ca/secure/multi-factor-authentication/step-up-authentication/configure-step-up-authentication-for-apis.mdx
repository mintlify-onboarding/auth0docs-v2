...
<tr>
<td>`client_ID`</td>
<td>Définissez l’ID client de votre application (trouvez-le dans <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Application Settings (Paramètres de l’application)</AuthLink>).</td>
</tr>
<tr>
<td>`redirect_URI`</td>
<td>Définissez sur une URL dans votre application vers laquelle Auth0 devrait rediriger l’utilisateur après l’authentification (trouvez-le dans <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Application Settings (Paramètres de l’application)</AuthLink>).</td>
</tr>
<tr>
<td>`nonce`</td>
