...
Voici un aperçu de l’écran que l’utilisateur utiliserait pour modifier son `displayName` :](/docs/images/
...
pour enregistrer les modifications dans la base de données, l’application appelle le point de terminaison [Obtenir un utilisateur](/docs/fr-ca/api/management/v2#!/Users/get_users_by_id) de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
Voici le code mettant en œuvre la validation <Tooltip href="/docs/docs/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
