...
Une façon de vérifier les demandes envoyées est d’utiliser le [paramètre d’état](/docs/fr-ca/secure/attack-protection/state-parameters) du protocole <Tooltip href="/docs/docs/fr-ca/glossary?term=oath2" tip="OAuth 2.0
