...
Sender constraining is an <Tooltip href="/docs/docs/fr-ca/glossary?term=oath2" tip="OAuth 2.0
Cadre d’applications d’autorisation qui définit les protocoles d’autorisation et les flux de production." cta="Voir le glossaire">OAuth 2.0</Tooltip> and <Tooltip href="/docs/docs/fr-ca/glossary?term=openid" tip="OpenID
...
<tbody>
<tr>
<td><a href="/docs/docs/fr-ca/secure/sender-constraining/mtls-sender-constraining">mTLS Sender Constraining</a></td>
<td>How mTLS sender constraining works in Auth0, step by step.</td>
</tr>
<tr>
<td><a href="/docs/docs/fr-ca/secure/sender-constraining/demonstrating-proof-of-possession-dpop">Demonstrating Proof-of-Possession (DPoP)</a></td>
<td>How DPoP works in Auth0, step by step.</td>
</tr>
<tr>
<td><a href="/docs/docs/fr-ca/secure/sender-constraining/configure-sender-constraining">Configure Sender Constraining</a></td>
