...
Les [jetons d’accès](/docs/fr-ca/secure/tokens/access-tokens) (qui ne sont pas toujours des <Tooltip href="/docs/docs/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
...
* **Jetons d’accès des <Tooltip href="/docs/docs/fr-ca/glossary?term=idp" tip="Fournisseur d’identité (IdP)
...
* **Jetons d'accès à l’Auth0 Management API** : jetons de courte durée contenant des demandes spécifiques (permissions) qui vous permettent d’appeler les points de terminaison de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
