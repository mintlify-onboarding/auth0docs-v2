...
Jusqu’à récemment, vous pouviez générer un jeton de Management APIv2 directement à partir de l’explorateur <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
La nouvelle implémentation ne présente pas de tels risques. Une fois que vous avez effectué la configuration initiale, vous pouvez obtenir un jeton soit en visitant <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
