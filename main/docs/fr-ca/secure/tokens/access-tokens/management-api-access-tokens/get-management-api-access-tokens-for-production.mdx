...
<td>Il s’agit de la valeur du champ <strong>Client Secret</strong> de l’application de communication entre machines que vous avez créée. Vous pouvez la trouver dans l’onglet <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Paramètres de votre application</AuthLink>.</td>
</tr>
<tr>
