...
Les demandes de [Jetons Web JSON (JWT)](/docs/fr-ca/tokens/concepts/jwts) sont des éléments d’information concernant un sujet. Par exemple, un [jeton d’ID](/docs/fr-ca/secure/tokens/id-tokens) (qui est toujours un <Tooltip href="/docs/docs/fr-ca/glossary?term=json-web-token" tip="Jeton Web JSON (JWT)
...
Dans le [Registre des demandes de jetons Web JSON de l’IANA](https://www.iana.org/assignments/jwt/jwt.xhtml#claims), vous pouvez voir quelques exemples de demandes publiques enregistrées par <Tooltip href="/docs/docs/fr-ca/glossary?term=openid" tip="OpenID
