...
La signature du jeton JWT est générée à l’aide d’un <Tooltip href="/docs/docs/fr-ca/glossary?term=signing-algorithm" tip="Algorithme de signature
