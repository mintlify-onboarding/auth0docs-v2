...
Vous pouvez activer et configurer deux paramètres de durée de vie des jetons d’actualisation, expiration absolue et expiration pour inactivité, en utilisant <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
