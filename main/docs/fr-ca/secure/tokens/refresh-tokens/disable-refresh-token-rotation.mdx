...
Vous pouvez désactiver la rotation des jetons d’actualisation de chaque application en utilisant le Dashboard ou <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
