...
Multi-Resource <Tooltip href="/docs/docs/fr-ca/glossary?term=refresh-token" tip="Jeton d’actualisation
...
When an application exchanges a refresh token for an <Tooltip href="/docs/docs/fr-ca/glossary?term=access-token" tip="Jeton d’accès
...
* No need to go through a full <Tooltip href="/docs/docs/fr-ca/glossary?term=authorization-flow" tip="Flux d’autorisation
...
* Performance improvement and reduced load on the <Tooltip href="/docs/docs/fr-ca/glossary?term=authorization-server" tip="Serveur d’autorisations :
...
* The Auth0 <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
