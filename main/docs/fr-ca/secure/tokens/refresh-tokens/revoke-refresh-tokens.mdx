...
You can also use [refresh token rotation](/docs/fr-ca/secure/tokens/refresh-tokens/refresh-token-rotation) so that every time a client exchanges a <Tooltip href="/docs/docs/fr-ca/glossary?term=refresh-token" tip="Jeton d’actualisation
Jeton utilisé pour obtenir un jeton d’accès renouvelé sans obliger les utilisateurs à se connecter à nouveau." cta="Voir le glossaire">refresh token</Tooltip> to get a new <Tooltip href="/docs/docs/fr-ca/glossary?term=access-token" tip="Jeton d’accès
...
* Envoyer une demande au point de terminaison `/api/v2/device-credentials` de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
<tr>
<td>`client_secret`</td>
<td>Le secret client de votre application. Requis pour les <a href="/docs/docs/fr-ca/applications/concepts/app-types-confidential-public#confidential-applications">applications confidentielles</a>.</td>
</tr>
<tr>
