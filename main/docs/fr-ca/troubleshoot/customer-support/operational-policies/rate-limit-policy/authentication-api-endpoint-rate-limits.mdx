...
Les clients qui utilisent l’extensibilité peuvent ajouter d’autres requêtes, non seulement à l’Authentication API, mais aussi à <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
