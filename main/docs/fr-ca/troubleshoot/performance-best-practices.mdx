...
Les métadonnées client d’une application peuvent être définies manuellement via <Tooltip href="/docs/docs/fr-ca/glossary?term=auth0-dashboard" tip="Auth0 Dashboard
...
Essayez d’éviter les appels à <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
