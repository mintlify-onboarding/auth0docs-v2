...
Une autre approche pour obtenir le profil utilisateur complet consiste à utiliser <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
