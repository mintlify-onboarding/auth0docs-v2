...
Lorsque vous utilisez les points de terminaison des connexions dans <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
...
L’extension Delegated Administration et l’extension Dashboard à authentification unique (<Tooltip href="/docs/docs/fr-ca/glossary?term=single-sign-on" tip="Authentification unique (SSO)
