...
<td><a href="/docs/docs/fr-ca/customize/actions/migrate">Migrer vers les Actions Node 16</a> dès que possible.</td>
</tr>
<tr>
<td>Node 8 hérité</td>
...
<td><a href="/docs/docs/fr-ca/customize/actions/migrate">Migrer vers Actions Node 16</a> immédiatement.</td>
</tr>
</tbody>
</table>
