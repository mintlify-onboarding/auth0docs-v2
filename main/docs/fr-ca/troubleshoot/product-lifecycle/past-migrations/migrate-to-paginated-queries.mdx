...
Après le **26 janvier 2021** (ou Private Cloud version 2202), les requêtes adressées aux points de terminaison de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
