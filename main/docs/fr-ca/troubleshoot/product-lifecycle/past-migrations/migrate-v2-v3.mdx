...
<tbody>
<tr>
<td><a href="/docs/docs/fr-ca/extensions/authorization-extension/v2">Authorization Extension</a></td>
<td>2.5.0+</td>
...
<tr>
<td><a href="/docs/docs/fr-ca/extensions/delegated-admin/v3">Administration déléguée</a></td>
<td>3.1+</td>
