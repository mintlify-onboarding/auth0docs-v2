...
En gardant à l’esprit la façon dont un exemple de réceptacle de point de terminaison est configuré, examinons les limites de charge subite de <Tooltip href="/docs/docs/fr-ca/glossary?term=management-api" tip="Management API
