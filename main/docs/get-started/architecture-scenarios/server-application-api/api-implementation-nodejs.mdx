...
---
As part of the [Server + API Architecture Scenario](/get-started/architecture-scenarios/server-application-api), we will implement the Timesheets API in Node.js. Please refer to the scenario for information on the implemented solution.
