...
For medium-risk logins that require additional verification, you'll want to create a custom [Form](/customize/forms) that explains the situation to the user.
