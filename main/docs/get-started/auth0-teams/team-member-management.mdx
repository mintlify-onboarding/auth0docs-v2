...
If you only want to remove the team member's access to one or more tenants, go to the [Team Member's details page](/get-started/auth0-teams/tenant-member-management).
