...
<tr>
<td><a href="/docs/get-started/authentication-and-authorization-flow/client-initiated-backchannel-authentication-flow/mobile-notifications-with-ciba">Mobile notifications with CIBA</a></td>
...
<td>How to authorize users using the CIBA with RAR flow.</td>
</tr>
</tbody>
</table>