...
<td>Your application's Client Secret. Required when Client Secret is the application authentication method. <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Application Settings</AuthLink> is <code>Post</code> or <code>Basic</code>. If your application is not highly trusted (for example, a SPA), then do not set this parameter.</td>
</tr>
<tr>
