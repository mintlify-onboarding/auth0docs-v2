...
<td>ID of the signing key to be revoked.  To learn how to find your signing key ID, see <a href="/secure/tokens/json-web-tokens/locate-json-web-key-sets">Locate JSON Web Key Sets</a>.</td>
</tr>
<tr>
