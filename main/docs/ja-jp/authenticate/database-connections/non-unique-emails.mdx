...
For more information about identifiers and attributes, read [Flexible Identifiers](/ja-jp/authenticate/database-connections/flexible-identifiers-and-attributes).
