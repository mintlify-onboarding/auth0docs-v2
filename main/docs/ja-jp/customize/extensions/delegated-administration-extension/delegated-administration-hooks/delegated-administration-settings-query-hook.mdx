...
書き込みフックの詳細については、「[委任管理：書き込みフック](/ja-jp/customize/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-write-hook)」をお読みください。
