...
[SSOダッシュボード拡張機能を追加](/ja-jp/customize/extensions/single-sign-on-dashboard-extension/install-sso-dashboard-extension)する前に、Auth0でアプリケーションを作成する必要があります。
...
次に、[SSOダッシュボード拡張機能をインストール](/ja-jp/customize/extensions/single-sign-on-dashboard-extension/install-sso-dashboard-extension)し、ダッシュボードに[アプリケーションを追加](/ja-jp/customize/extensions/single-sign-on-dashboard-extension/add-applications-to-the-sso-dashboard)します。

## もっと詳しく

* [シングルサインオンダッシュボード拡張機能をインストールする](/ja-jp/customize/extensions/single-sign-on-dashboard-extension/install-sso-dashboard-extension)
