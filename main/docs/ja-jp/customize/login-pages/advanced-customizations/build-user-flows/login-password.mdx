...
このガイドの終わりには、カスタマイズしたログイン画面のあるIdentity Firstフローが完成します。詳細については、「[使用の開始ガイド](/ja-jp/customize/login-pages/advanced-customizations/getting-started)」をお読みの上で、「[SDKリファレンスガイド](/ja-jp/customize/login-pages/advanced-customizations/getting-started/sdk-quickstart)」を参照してください。
