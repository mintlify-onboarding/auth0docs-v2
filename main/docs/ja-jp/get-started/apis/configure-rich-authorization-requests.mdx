...
同意プロンプトをカスタマイズする方法については、「[新しいユニバーサルログインページをカスタマイズする](/ja-jp/customize/login-pages/universal-login/customize-templates)」と「[ノーコードエディターで新しいユニバーサルログインをカスタマイズする](/ja-jp/customize/login-pages/universal-login/customize-themes)」をお読みください。