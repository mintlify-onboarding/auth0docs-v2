...
export const codeExample12 = `var client = new RestClient("https://{yourDomain}/oidc/register");
...
export const codeExample14 = `HttpResponse<String> response = Unirest.post("https://{yourDomain}/oidc/register")
  .header("content-type", "application/json")
