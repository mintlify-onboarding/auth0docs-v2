...
* Dashboardで[APIをセットアップ](/ja-jp/get-started/auth0-overview/set-up-apis)します。
* 権限は事前に定義された値から選択されます。権限のリストが空白の場合は、APIに[権限を追加](/ja-jp/get-started/apis/add-api-permissions)してください。
...
* [ユーザーの権限を表示する](/ja-jp/manage-users/access-control/configure-core-rbac/rbac-users/view-user-permissions)