...
プログラムで[組織](/ja-jp/manage-users/organizations/organizations-overview)を操作するには、組織のメンバーに割り当てられたロールのリストを取得する必要がある場合があります。
...
<td>`read:organization_member_roles`のスコープを持つ<a href="/ja-jp/tokens/management-api-access-tokens">Management APIのアクセストークン</a>。</td>
</tr>
</tbody>
</table>
