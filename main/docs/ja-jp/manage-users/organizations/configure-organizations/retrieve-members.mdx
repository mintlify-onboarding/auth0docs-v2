...
プログラムで[組織](/ja-jp/manage-users/organizations/organizations-overview)を操作するには、組織メンバーのリストを取得する必要がある場合があります。
...
<td>スコープ`read:organization_members`を持つ<a href="/ja-jp/tokens/management-api-access-tokens">Management API</a>のアクセストークン。</td>
</tr>
</tbody>
</table>
