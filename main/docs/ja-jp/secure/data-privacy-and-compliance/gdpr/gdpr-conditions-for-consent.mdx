...
export const codeExample2 = `var client = new RestClient("https://{yourDomain}/api/v2/users-by-email?email=USER_EMAIL_ADDRESS&fields=user_metadata");
...
export const codeExample4 = `HttpResponse response = Unirest.get("https://{yourDomain}/api/v2/users-by-email?email=USER_EMAIL_ADDRESS&fields=user_metadata")
.header("authorization", "Bearer YOUR_MGMT_API_ACCESS_TOKEN")
.asString();`;
...
export const codeExample6 = `#import 
...
<CodeGroup>
<AuthCodeBlock children={codeExample1} language="bash" filename="cURL" /> lines
<AuthCodeBlock children={codeExample2} language="csharp" filename="C#" />
<AuthCodeBlock children={codeExample3} language="go" filename="Go" /> lines
<AuthCodeBlock children={codeExample4} language="java" filename="Java" />
<AuthCodeBlock children={codeExample5} language="javascript" filename="Node.JS" /> lines
<AuthCodeBlock children={codeExample6} language="obj-c" filename="Obj-C" />
<AuthCodeBlock children={codeExample7} language="php" filename="PHP" /> lines
<AuthCodeBlock children={codeExample8} language="python" filename="Python" />
<AuthCodeBlock children={codeExample9} language="ruby" filename="Ruby" /> lines
...
export const codeExample12 = `var client = new RestClient("https://{yourDomain}/api/v2/users/%7ByourUserID%7D?fields=user_metadata");
var request = new RestRequest(Method.GET);
...
export const codeExample14 = `HttpResponse response = Unirest.get("https://{yourDomain}/api/v2/users/%7ByourUserID%7D?fields=user_metadata")
.header("authorization", "Bearer {yourMgmtApiAccessToken}")
.asString();`;
...
export const codeExample16 = `#import 
...
<CodeGroup>
<AuthCodeBlock children={codeExample11} language="bash" filename="cURL" /> lines
<AuthCodeBlock children={codeExample12} language="csharp" filename="C#" />
<AuthCodeBlock children={codeExample13} language="go" filename="Go" /> lines
<AuthCodeBlock children={codeExample14} language="java" filename="Java" />
<AuthCodeBlock children={codeExample15} language="javascript" filename="Node.JS" /> lines
<AuthCodeBlock children={codeExample16} language="obj-c" filename="Obj-C" />
<AuthCodeBlock children={codeExample17} language="php" filename="PHP" /> lines
<AuthCodeBlock children={codeExample18} language="python" filename="Python" />
<AuthCodeBlock children={codeExample19} language="ruby" filename="Ruby" /> lines
...
export const codeExample24 = `HttpResponse response = Unirest.patch("https://{yourDomain}/api/v2/users/USER_ID")
.header("authorization", "Bearer YOUR_MGMT_API_ACCESS_TOKEN")
.header("content-type", "application/json")
...
export const codeExample26 = `#import 
NSDictionary \*headers = @{ @"authorization": @"Bearer YOUR_MGMT_API_ACCESS_TOKEN",
@"content-type": @"application/json" };
...
<CodeGroup>
<AuthCodeBlock children={codeExample21} language="bash" filename="cURL" /> lines
<AuthCodeBlock children={codeExample22} language="csharp" filename="C#" />
<AuthCodeBlock children={codeExample23} language="go" filename="Go" /> lines
<AuthCodeBlock children={codeExample24} language="java" filename="Java" />
<AuthCodeBlock children={codeExample25} language="javascript" filename="Node.JS" /> lines
<AuthCodeBlock children={codeExample26} language="obj-c" filename="Obj-C" />
<AuthCodeBlock children={codeExample27} language="php" filename="PHP" /> lines
<AuthCodeBlock children={codeExample28} language="python" filename="Python" />
<AuthCodeBlock children={codeExample29} language="ruby" filename="Ruby" /> lines
...
export const codeExample32 = `var client = new RestClient("https://{yourDomain}/api/v2/users/USER_ID");
var request = new RestRequest(Method.PATCH);
request.AddHeader("authorization", "Bearer YOUR_MGMT_API_ACCESS_TOKEN");
request.AddHeader("content-type", "application/json");
...
export const codeExample34 = `HttpResponse response = Unirest.patch("https://{yourDomain}/api/v2/users/USER_ID")
.header("authorization", "Bearer YOUR_MGMT_API_ACCESS_TOKEN")
.header("content-type", "application/json")
...
export const codeExample36 = `#import 
NSDictionary \*headers = @{ @"authorization": @"Bearer YOUR_MGMT_API_ACCESS_TOKEN",
@"content-type": @"application/json" };
...
<CodeGroup>
<AuthCodeBlock children={codeExample31} language="bash" filename="cURL" /> lines
<AuthCodeBlock children={codeExample32} language="csharp" filename="C#" />
<AuthCodeBlock children={codeExample33} language="go" filename="Go" /> lines
<AuthCodeBlock children={codeExample34} language="java" filename="Java" />
<AuthCodeBlock children={codeExample35} language="javascript" filename="Node.JS" /> lines
<AuthCodeBlock children={codeExample36} language="obj-c" filename="Obj-C" />
<AuthCodeBlock children={codeExample37} language="php" filename="PHP" /> lines
<AuthCodeBlock children={codeExample38} language="python" filename="Python" />
<AuthCodeBlock children={codeExample39} language="ruby" filename="Ruby" /> lines
...
export const codeExample41 = `curl --request DELETE \
--url 'https://{yourDomain}/api/v2/users/USER_ID' \
--header 'authorization: Bearer YOUR_MGMT_API_ACCESS_TOKEN'`;
export const codeExample42 = `var client = new RestClient("https://{yourDomain}/api/v2/users/USER_ID");
...
export const codeExample44 = `HttpResponse response = Unirest.delete("https://{yourDomain}/api/v2/users/USER_ID")
.header("authorization", "Bearer YOUR_MGMT_API_ACCESS_TOKEN")
.asString();`;
...
export const codeExample46 = `#import 
NSDictionary \*headers = @{ @"authorization": @"Bearer YOUR_MGMT_API_ACCESS_TOKEN" };
NSMutableURLRequest \*request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://{yourDomain}/api/v2/users/USER_ID"]
cachePolicy:NSURLRequestUseProtocolCachePolicy
timeoutInterval:10.0];
...
<CodeGroup>
<AuthCodeBlock children={codeExample41} language="bash" filename="cURL" /> lines
<AuthCodeBlock children={codeExample42} language="csharp" filename="C#" />
<AuthCodeBlock children={codeExample43} language="go" filename="Go" /> lines
<AuthCodeBlock children={codeExample44} language="java" filename="Java" />
<AuthCodeBlock children={codeExample45} language="javascript" filename="Node.JS" /> lines
<AuthCodeBlock children={codeExample46} language="obj-c" filename="Obj-C" />
<AuthCodeBlock children={codeExample47} language="php" filename="PHP" /> lines
<AuthCodeBlock children={codeExample48} language="python" filename="Python" />
<AuthCodeBlock children={codeExample49} language="ruby" filename="Ruby" /> lines
...
export const codeExample51 = `curl --request PATCH \
--url 'https://{yourDomain}/api/v2/users/USER_ID' \
--header 'authorization: Bearer YOUR_MGMT_API_ACCESS_TOKEN' \
--header 'content-type: application/json' \
--data '{"app_metadata":{"deleted":true}}'`;
export const codeExample52 = `var client = new RestClient("https://{yourDomain}/api/v2/users/USER_ID");
var request = new RestRequest(Method.PATCH);
request.AddHeader("authorization", "Bearer YOUR_MGMT_API_ACCESS_TOKEN");
request.AddHeader("content-type", "application/json");
request.AddParameter("application/json", "{\"app_metadata\":{\"deleted\":true}}", ParameterType.RequestBody);
IRestResponse response = client.Execute(request);`;
export const codeExample53 = `package main
import (
"fmt"
"strings"
"net/http"
...
export const codeExample54 = `HttpResponse response = Unirest.patch("https://{yourDomain}/api/v2/users/USER_ID")
.header("authorization", "Bearer YOUR_MGMT_API_ACCESS_TOKEN")
.header("content-type", "application/json")
.body("{\"app_metadata\":{\"deleted\":true}}")
.asString();`;
export const codeExample55 = `var axios = require("axios").default;
var options = {
method: 'PATCH',
url: 'https://{yourDomain}/api/v2/users/USER_ID',
headers: {
...
export const codeExample56 = `#import 
NSDictionary \*headers = @{ @"authorization": @"Bearer YOUR_MGMT_API_ACCESS_TOKEN",
@"content-type": @"application/json" };
...
[dataTask resume];`;
export const codeExample57 = `$curl = curl_init();
curl_setopt_array($curl, [
CURLOPT_URL => "https://{yourDomain}/api/v2/users/USER_ID",
CURLOPT_RETURNTRANSFER => true,
CURLOPT_ENCODING => "",
...
export const codeExample58 = `import http.client
conn = http.client.HTTPSConnection("")
...
data = res.read()
print(data.decode("utf-8"))`;
export const codeExample59 = `require 'uri'
require 'net/http'
require 'openssl'
url = URI("https://{yourDomain}/api/v2/users/USER_ID")
http = Net::HTTP.new(url.host, url.port)
...
response = http.request(request)
puts response.read_body`;
export const codeExample60 = `import Foundation
let headers = [
"authorization": "Bearer YOUR_MGMT_API_ACCESS_TOKEN",
"content-type": "application/json"
]
...
<CodeGroup>
<AuthCodeBlock children={codeExample51} language="bash" filename="cURL" /> lines
<AuthCodeBlock children={codeExample52} language="csharp" filename="C#" />
<AuthCodeBlock children={codeExample53} language="go" filename="Go" /> lines
<AuthCodeBlock children={codeExample54} language="java" filename="Java" />
<AuthCodeBlock children={codeExample55} language="javascript" filename="Node.JS" /> lines
<AuthCodeBlock children={codeExample56} language="obj-c" filename="Obj-C" />
<AuthCodeBlock children={codeExample57} language="php" filename="PHP" /> lines
<AuthCodeBlock children={codeExample58} language="python" filename="Python" />
<AuthCodeBlock children={codeExample59} language="ruby" filename="Ruby" /> lines
<AuthCodeBlock children={codeExample60} language="swift" filename="Swift" />
</CodeGroup>
