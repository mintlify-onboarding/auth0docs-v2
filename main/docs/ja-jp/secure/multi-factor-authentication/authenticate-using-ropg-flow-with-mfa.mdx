...
export const codeExample12 = `var client = new RestClient("https://{yourDomain}/mfa/authenticators");
...
export const codeExample14 = `HttpResponse<String> response = Unirest.get("https://{yourDomain}/mfa/authenticators")
  .header("authorization", "Bearer MFA_TOKEN")
  .header("content-type", "application/json")
  .asString();`;
