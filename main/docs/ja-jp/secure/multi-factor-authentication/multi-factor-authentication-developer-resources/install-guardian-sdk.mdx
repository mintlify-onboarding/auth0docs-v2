...
`requestToken`または`ticket`の使用は認証方法に応じます。チケットは、前に生成された[登録チケット](/ja-jp/secure/multi-factor-authentication/multi-factor-authentication-developer-resources/create-custom-enrollment-tickets)に相当します。
