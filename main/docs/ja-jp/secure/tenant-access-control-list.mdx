...
You can toggle monitoring mode for a rule by updating the `action` object. To learn more, read [Configure Rules](/ja-jp/secure/tenant-access-control-list/configure-rules).
...
* [Configure Rules](/ja-jp/secure/tenant-access-control-list/configure-rules)
* [Use Cases](/ja-jp/secure/tenant-access-control-list/use-cases)
* [Reference](/ja-jp/secure/tenant-access-control-list/reference)