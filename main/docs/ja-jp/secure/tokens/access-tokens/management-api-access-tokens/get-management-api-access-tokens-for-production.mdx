...
export const codeExample11 = `curl --request GET \
  ...
  --header 'content-type: application/json'`;
export const codeExample12 = `var client = new RestClient("https://{yourDomain}/api/v2/clients");
...
export const codeExample14 = `HttpResponse<String> response = Unirest.get("https://{yourDomain}/api/v2/clients")
  .header("content-type", "application/json")
  .header("authorization", "Bearer {yourAccessToken}")
  .asString();`;
