...
For more information about identifiers and attributes, read [Flexible Identifiers](/docs/jp/authenticate/database-connections/flexible-identifiers-and-attributes).
