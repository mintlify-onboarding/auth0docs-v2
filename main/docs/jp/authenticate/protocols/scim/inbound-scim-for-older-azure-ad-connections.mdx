...
新しい接続については、「[新しい接続](/docs/jp/authenticate/protocols/scim/inbound-scim-for-new-azure-ad-connections)」をご覧ください。
