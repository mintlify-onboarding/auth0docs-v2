...
Auth0 Management APIの[アクション作成エンドポイント](/docs/jp/api/management/v2#!/Actions/post_action)を使用して、依存関係を追加することもできます。エンドポイントを呼び出す際には、ペイロード内で依存関係を指定します。
