...
* メールはAuth0からご利用のSMTPプロバイダーに送信されます。ポートが開いており、特定のAuth0 IPアドレスから受信接続を許可する必要があります。詳細については、「[許可リスト用のAuth0 IPアドレス](/docs/jp/secure/security-guidance/data-security/allowlist)」をお読みください。
