...
当社のサポートチームは、お客様のメールプロバイダーがメッセージを受信したかどうか、またメッセージが受け入れられなかった場合に返されるエラーを確認できます。詳細については、「[サポートチケットの開示と管理](/docs/jp/troubleshoot/customer-support/open-and-manage-support-tickets)」をお読みください。
