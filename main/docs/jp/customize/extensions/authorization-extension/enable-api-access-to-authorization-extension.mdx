...
APIにアクセスするには、[適切なトークンを要求して取得](/docs/jp/get-started/authentication-and-authorization-flow/client-credentials-flow/call-your-api-using-the-client-credentials-flow)する必要があります。
