...
次に、[Delegated Admin Extension（委任管理拡張機能）をインストール](/docs/jp/customize/extensions/delegated-administration-extension/install-delegated-admin-extension)します。
