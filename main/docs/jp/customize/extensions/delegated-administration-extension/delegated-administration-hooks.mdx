...
リアルタイムWebtaskログ拡張機能の詳細については、[［Realtime Webtask Logs（リアルタイムWebtaskログ）］](/docs/jp/customize/extensions/real-time-webtask-logs)をお読みください。
...
* [アクセスフック](/docs/jp/customize/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-access-hook)
* [フィルタフック](/docs/jp/customize/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-filter-hook)
* [メンバーシップクエリフック](/docs/jp/customize/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-memberships-query-hook)
* [設定クエリフック](/docs/jp/customize/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-settings-query-hook)
* [書き込みフック](/docs/jp/customize/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-write-hook)

## もっと詳しく

* [委任管理：アクセスフック](/docs/jp/customize/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-access-hook)
* [委任管理：フィルターフック](/docs/jp/customize/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-filter-hook)
* [委任管理：メンバーシップクエリフック](/docs/jp/customize/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-memberships-query-hook)
* [委任管理：クエリ設定フック](/docs/jp/customize/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-settings-query-hook)
* [委任管理：書き込みフック](/docs/jp/customize/extensions/delegated-administration-extension/delegated-administration-hooks/delegated-administration-write-hook)