...
Auth0では、Amazon Web Servicesを委任認証用に構成することができます。詳細については、「[Amazon Web Servicesをシングルサインオン用に構成する](/docs/jp/customize/integrations/aws/configure-amazon-web-services-for-sso)」および「[カスタムオーソライザーを使用した安全なAWS API Gatewayエンドポイント](/docs/jp/customize/integrations/aws/aws-api-gateway-custom-authorizers)」をお読みください。
