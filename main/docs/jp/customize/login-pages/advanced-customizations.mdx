...
ユニバーサルログインの高度なカスタマイズは、現在早期アクセス版として提供されています。Auth0のリリースについては、「[製品のリリース段階](/docs/jp/troubleshoot/product-lifecycle/product-release-stages)」を参照してください。
...
ユニバーサルログインの高度なカスタマイズを使い始めるには、「[高度なカスタマイズの使用を開始する](/docs/jp/customize/login-pages/advanced-customizations/getting-started)」をご覧ください。
