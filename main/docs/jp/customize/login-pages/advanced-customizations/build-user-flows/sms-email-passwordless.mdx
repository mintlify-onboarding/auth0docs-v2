...
詳細については、「[使用の開始ガイド](/docs/jp/customize/login-pages/advanced-customizations/getting-started)」をお読みの上で、[SDKリファレンスガイド](/docs/jp/customize/login-pages/advanced-customizations/getting-started/sdk-quickstart)」を参照してください。
