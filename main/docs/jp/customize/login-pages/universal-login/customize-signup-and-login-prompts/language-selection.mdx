...
* Use [Universal Login](/docs/jp/authenticate/login/auth0-universal-login).

  + This feature is not available for custom login pages.
* Configure a [custom domain](/docs/jp/customize/custom-domains).
* Enable the languages you plan to add to your prompts in your Auth0 tenant.
  ...
  + On the Auth0 Dashboard, navigate to [Settings > General > Languages](https://manage.auth0.com/#/tenant/general) and enable one or more desired languages.
    ...
    - For more information, review [Universal Login Internationalization](/docs/jp/customize/internationalization-and-localization/universal-login-internationalization).
...
To get started, add the following script to your [Universal Login page template](/docs/jp/customize/login-pages/universal-login/customize-templates) to facilitate language selection.
...
To add language selection to the `signup` prompt, use the [Set partials for a prompt](/docs/jp/api/management/v2/prompts/put-partials) endpoint:
...
To add language selection to the `login-id` prompt, use the [Set partials for a prompt](/docs/jp/api/management/v2/prompts/put-partials) endpoint:
...
To add language selection to the `login-passwordless-email-code` prompt, use the [Set partials for a prompt](/docs/jp/api/management/v2/prompts/put-partials) endpoint:
