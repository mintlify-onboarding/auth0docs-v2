...
同意プロンプトをカスタマイズする方法については、「[新しいユニバーサルログインページをカスタマイズする](/docs/jp/customize/login-pages/universal-login/customize-templates)」と「[ノーコードエディターで新しいユニバーサルログインをカスタマイズする](/docs/jp/customize/login-pages/universal-login/customize-themes)」をお読みください。