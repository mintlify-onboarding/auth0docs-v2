...
* `fapi1_adv_mtls_par`：ユーザーは[mTLS](/docs/jp/get-started/applications/configure-mtls)と[PAR](/docs/jp/get-started/applications/configure-par)を使用したFAPI 1高度プロファイルに準じてこのクライアントが行動することを望んでいます。
* `fapi1_adv_pkj_par`：ユーザーは[秘密鍵JWT](/docs/jp/get-started/applications/configure-private-key-jwt)と[PAR](/docs/jp/get-started/applications/configure-par)を使用したFAPI 1高度プロファイルに準じてこのクライアントが行動することを望んでいます。
...
* **秘密鍵JWTとPARを使用したFAPI 1高度プロファイル** ：ユーザーは[秘密鍵JWT](/docs/jp/get-started/applications/configure-private-key-jwt)と[PAR](/docs/jp/get-started/applications/configure-par)を使用したFAPI 1高度プロファイルに準じてクライアントに行動するように望んでいます。
* **mTLSとPARを使用したFAPI 1高度プロファイル** ：ユーザーは[mTLS](/docs/jp/get-started/applications/configure-mtls)と[PAR](/docs/jp/get-started/applications/configure-par)を使用したFAPI 1高度プロファイルに準じてクライアントに行動するように望んでいます。
