...
<tbody>
<tr>
<td><a href="/docs/jp/get-started/applications/configure-client-initiated-backchannel-authentication">Configure Client-Initiated Backchannel Authentication（クライアントが開始するバックチャネル認証を設定する）</a></td>
<td>アプリケーションに対してCIBA付与タイプを構成する方法。</td>
</tr>
<tr>
<td><a href="/docs/jp/get-started/authentication-and-authorization-flow/client-initiated-backchannel-authentication-flow/user-authentication-with-ciba">User Authentication with CIBA（CIBAを使ったユーザー認証）</a></td>
