...
<td>`read:signing_keys`スコープのある<a href="https://auth0.com/docs/jp/api/management/v2/tokens">Management APIのアクセストークン</a>。</td>
</tr>
</tbody>
</table>
...
<tr>
<td>`YOUR_KEY_ID`</td>
<td>表示する署名鍵のID。署名鍵IDを見つける方法については、「<a href="https://auth0.com/docs/jp/tokens/guides/locate-jwks">JSON Web鍵セットを見つける</a>」を参照してください。</td>
</tr>
<tr>
<td>`MGMT_API_ACCESS_TOKEN`</td>
<td>スコープ`read:signing_keys`を持つ<a href="https://auth0.com/docs/jp/api/management/v2/tokens">Management APIのアクセストークン</a>。</td>
</tr>
</tbody>
</table>
