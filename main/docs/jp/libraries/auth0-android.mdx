...
Auth0.Androidは、Androidアプリでユーザーを認証し、[Auth0 API](/docs/jp/api)にアクセスするために使用できる、クライアント側のライブラリーです。
...
SDKをプロジェクトに追加します。ライブラリーはAuth0のAuthentication APIと<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" href="/docs/jp/glossary?term=management-api" tip="Management API: 顧客が管理タスクを実行できるようにするための製品。" cta="用語集の表示">Management API</Tooltip>に要求を行います。
...
`WebAuthProvider`クラスを使用して[ユーザーをアプリケーションにログインおよびアプリケーションからログアウト](/docs/jp/libraries/auth0-android/auth0-android-login-logout-and-user-profiles)します。
...
* [Auth0 Androidの構成オプション](/docs/jp/libraries/auth0-android/auth0-android-configuration)
* [Auth0.Androidデータベース認証](/docs/jp/auth0-android-database-authentication)
* [Auth0.Androidパスワードレス認証](/docs/jp/auth0-android-passwordless)
* [Auth0.Androidでトークンを保存および更新する](/docs/jp/auth0-android-save-and-renew-tokens)
