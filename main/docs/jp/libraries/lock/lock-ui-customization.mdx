...
アプリケーション用のLockをカスタマイズする際に、より詳細な情報が必要な場合は、[構成オプション](/docs/jp/libraries/lock/lock-configuration)ページまたは[Lock API](/docs/jp/libraries/lock/lock-api-reference)ページをご覧ください。
