...
* ロールは事前に定義された値から選択されます。ロールのリストが空白の場合は、[ロールを作成](/docs/jp/manage-users/access-control/configure-core-rbac/roles/create-roles)する必要があります。
* Auth0 Dashboardで[APIをセットアップ](/docs/jp/get-started/auth0-overview/set-up-apis)します。
* 権限は事前に定義された値から選択されます。権限のリストが空白の場合は、APIに[権限を追加する](/docs/jp/get-started/apis/add-api-permissions)必要があります。
...
* [ロールから権限を削除する](/docs/jp/manage-users/access-control/configure-core-rbac/roles/remove-permissions-from-roles)