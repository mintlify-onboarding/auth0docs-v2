...
<td>スコープ`delete:organization_members`を持つ<a href="/docs/jp/tokens/management-api-access-tokens">Management APIのアクセストークン</a>。</td>
</tr>
<tr>
<td>`USER_ID`</td>
