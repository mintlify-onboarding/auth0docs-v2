...
<td>Auth0は3つのスコアから総スコアを評価します。独自のビジネスロジックを実装したい場合には、<a href="https://auth0.com/docs/jp/secure/multi-factor-authentication/adaptive-mfa/customize-adaptive-mfa">アクション</a>を使用します。</td>
</tr>
</tbody>
</table>
...
リスク評価、信頼スコア、およびカスタマイズオプションの詳細については、「[Adaptive MFAをカスタマイズする](/docs/jp/secure/multi-factor-authentication/adaptive-mfa/customize-adaptive-mfa)」をお読みください。

## サポートと制限事項

### 認可フロー

Adaptive MFAはエンドユーザーから開始されるすべての認証フローと認可フローによってサポートされています。異なるフローとプロトコルの詳細については、「[認証フローと認可フロー](/docs/jp/get-started/authentication-and-authorization-flow)」および「[プロトコル](/docs/jp/authenticate/protocols)」をお読みください。
...
* [Adaptive MFAを有効にする](/docs/jp/secure/multi-factor-authentication/adaptive-mfa/enable-adaptive-mfa)
