...
You can toggle monitoring mode for a rule by updating the `action` object. To learn more, read [Configure Rules](/docs/jp/secure/tenant-access-control-list/configure-rules).
...
* [Configure Rules](/docs/jp/secure/tenant-access-control-list/configure-rules)
* [Use Cases](/docs/jp/secure/tenant-access-control-list/use-cases)
* [Reference](/docs/jp/secure/tenant-access-control-list/reference)