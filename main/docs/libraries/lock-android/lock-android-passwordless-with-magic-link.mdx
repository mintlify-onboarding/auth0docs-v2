...
Go to your <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">application settings</AuthLink> and click **Show Advanced Settings** at the bottom of the page. Then in the "Device Settings" tab, you will need to provide both the Android Application's Package Name and certificate Key Hash.
