...
---
You can assign [permissions](/manage-users/access-control/rbac) to a user using the <Tooltip tip="Auth0 Dashboard: Auth0's main product to configure your services." cta="View Glossary" href="/glossary?term=Auth0+Dashboard">Auth0 Dashboard</Tooltip> or the <Tooltip tip="Auth0 Dashboard: Auth0's main product to configure your services." cta="View Glossary" href="/glossary?term=Management+API">Management API</Tooltip>. The assigned permissions can be used with the API Authorization Core feature set.
...
* [Set up an API](/get-started/auth0-overview/set-up-apis) in the Dashboard.
* Permissions are selected from pre-defined values. If your list of roles is blank, make sure you [add permissions](/get-started/apis/add-api-permissions) for your API.
