...
---
To assign a member to your [organization](/manage-users/organizations/organizations-overview), you must have already [created the user](/manage-users/user-accounts/create-users) in your tenant. If you cannot find a user, you can [invite them](/manage-users/organizations/configure-organizations/invite-members) instead.
...
| `MGMT_API_ACCESS_TOKEN` | [Access Token for the Management API](/secure/tokens/access-tokens/management-api-access-tokens) with the scope `create:organization_members`. |
