...
Delete an Organization domains via the Auth0 Dashboard or the Management API.

<Tabs>
  <Tab title="Auth0 Dashboard">
To delete an organization domain via the Auth0 Dashboard:
...
Make a `DELETE` call to the Delete Organization Discovery Domain endpoint. Ensure you replace the placeholder values with the appropriate values from your tenant.
