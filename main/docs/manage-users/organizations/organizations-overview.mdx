...
* **Granite Outpost Rafting and Ziplines**: An established company that directly employs their large staff of guides, but sometimes also reaches out to freelance guides. They have their own <Tooltip tip="Identity Provider (IdP): Service that stores and manages digital identities." cta="View Glossary" href="/glossary?term=IdP">IdP</Tooltip> that they use for their employees.
...
Additionally, you must choose whether to use the default <Tooltip tip="Universal Login: Your application redirects to Universal Login, hosted on Auth0's Authorization Server, to verify a user's identity." cta="View Glossary" href="/glossary?term=Universal+Login">Universal Login</Tooltip> page that is configured for your application or to customize a login page specific to each organization using page templates. To learn more, see [Create Your First Organization](/manage-users/organizations/create-first-organization).
...
Once you have determined how many organizations you will have and what your connection model should look like, you can set up [database](/authenticate/database-connections), [social](/authenticate/identity-providers/social-identity-providers), or [enterprise](/authenticate/identity-providers/enterprise-identity-providers) connections; [create organizations](/manage-users/organizations/configure-organizations/create-organizations); and [configure organization membership](/manage-users/organizations/configure-organizations/invite-members) or [enable organization connections](/manage-users/organizations/configure-organizations/enable-connections).
...
The Management API should be accessed using only a confidential client. Its use is subject to [Auth0 Management API rate limits](/troubleshoot/customer-support/operational-policies/rate-limit-policy/management-api-endpoint-rate-limits).
...
* Organizations-enabled applications are not compatible with the following grants and protocols: <Tooltip tip="Web Service Federation (WS-Fed): Protocol for managing user identities across domains." cta="View Glossary" href="/glossary?term=Resource+Owner">Resource Owner</Tooltip> Password, Device <Tooltip tip="Resource Owner: Entity (such as a user or application) capable of granting access to a protected resource." cta="View Glossary" href="/glossary?term=Authorization+Flow">Authorization Flow</Tooltip>, <Tooltip tip="Authorization Flow: Authorization grant (or workflow) specified in the OAuth 2.0 framework." cta="View Glossary" href="/glossary?term=WS-Fed">WS-Fed</Tooltip> (Auth0 as IdP).
* Does not support:
