...
You can use the `/api/v2/clients/{id}` endpoint to include session metadata in your application.
...
You can view log events by navigating to **Dashboard > Monitoring > Logs** or retrieve logs using the [Management API logs](https://auth0.com/docs/api/management/v2/logs/get-logs) endpoint.
