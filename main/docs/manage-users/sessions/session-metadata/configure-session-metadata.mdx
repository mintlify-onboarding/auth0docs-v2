...
You can use the [/api/v2/clients/{id}](https://auth0.com/docs/api/management/v2/sessions/patch-sessions-by-id) endpoint to include session metadata in your application.
