...
* blocked through the <Tooltip tip="Auth0 Dashboard: Auth0's main product to configure your services." cta="View Glossary" href="/glossary?term=Auth0+Dashboard">Auth0 Dashboard</Tooltip> by an administrator
* blocked through the <Tooltip tip="Management API: A product to allow customers to perform administrative tasks." cta="View Glossary" href="/glossary?term=Management+API">Management API</Tooltip> by updating the user profile to set `blocked` to `false`
...
* [Manage User Access to Applications](/manage-users/user-accounts/manage-user-access-to-applications)