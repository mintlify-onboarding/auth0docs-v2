...
export const codeExample2 = `var client = new RestClient("https://{yourDomain}/api/v2/users/USER_ID");
...
export const codeExample4 = `HttpResponse<String> response = Unirest.patch("https://{yourDomain}/api/v2/users/USER_ID")
  .header("content-type", "application/json")
  .header("authorization", "Bearer MGMT_API_ACCESS_TOKEN")
  .header("cache-control", "no-cache")
