...
<td>Your application's Client Secret. You can find this value in your <AuthLink href="https://manage.auth0.com/#/Applications/{yourClientSecret}/settings">Application Settings</AuthLink>.</td>
</tr>
<tr>
