  ...
  <Content>
    ...
    **New to Auth?** Learn [How Auth0 works](https://auth0.com/docs/overview),
    ...
    <Section id={sections[3].id} title={sections[3].title} stepNumber="4">
      ...
      Go to the <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">settings page</AuthLink> of your Auth0 application, scroll to the end, and open **Advanced
