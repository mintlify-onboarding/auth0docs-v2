  ...
  <Content>
    ...
    <Section id={sections[3].id} title={sections[3].title} stepNumber="4" isSingleColumn>
      ...
      To persist authentication after closing and reopening the application, you may want to set
                      ...
                      [the risks of
                        storing tokens in localstorage](https://auth0.com/docs/libraries/auth0-single-page-app-sdk#change-storage-options). Also, localstorage should be treated as **transient** in
