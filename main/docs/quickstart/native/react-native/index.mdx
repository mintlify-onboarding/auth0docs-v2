...
First, you must provide a way for your users to log in. We recommend using the Auth0 hosted [login page](https://auth0.com/docs/authenticate/login/auth0-universal-login).
