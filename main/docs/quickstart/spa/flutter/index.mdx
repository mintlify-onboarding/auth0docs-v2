...
<Recipe>
  <Content>
    ...
    <Section id={sections[0].id} title={sections[0].title} stepNumber="1">
      ...
      You need to add the URL for your app to the **Allowed Web Origins** field in your <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Application Settings</AuthLink>. If you don't register your application URL here, the
