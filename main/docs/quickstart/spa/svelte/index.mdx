...
mode: wide
'og:description': This guide demonstrates how to integrate Auth0 with any Svelte
  app using the Auth0 SPA JS SDK.
'og:image': https://cdn2.auth0.com/docs/1.14553.0/img/share-image.png
'og:title': 'Auth0 Svelte Quickstarts: Add Login to Your Svelte Application'
'og:url': https://auth0.com/docs/
sidebarTitle: Svelte
title: Add Login to Your Svelte Application
'twitter:description': This guide demonstrates how to integrate Auth0 with any Svelte
  app using the Auth0 SPA JS SDK.
'twitter:title': 'Auth0 Svelte Quickstarts: Add Login to Your Svelte Application'
---
...
<Tip>
  [**Sign up**](https://auth0.com/signup?utm_source=svelte_quickstart) **for an Auth0 account if you don't have one**
</Tip>
...
<Accordion title="AI Prompt" defaultOpen icon="microchip-ai" iconType="sharp-solid">
  **Using AI to integrate Auth0?** Add this prompt to Cursor, Windsurf, Copilot, Claude Code or your favourite AI-powered IDE to speed up development.
  ...
  ```markdown expandable
  Integrate the Auth0 SPA SDK into a Svelte app
  ...
  6. 🚨 DIRECTORY NAVIGATION RULE: NEVER run `cd auth0-svelte-app` or any `cd` command automatically. ALWAYS check current directory with `pwd` first.
  ...
  Step 1a: Create New Project and Install the Auth0 SDK
  If an existing project exists, simply install the SDK:
  npm install @auth0/auth0-spa-js

  Otherwise, create a new project and install the SDK:
  npm create svelte@latest auth0-svelte-app && cd auth0-svelte-app && npm install && npm install @auth0/auth0-spa-js

  Step 2: Setup Auth0 environment configuration
  Create .env file and configure Auth0:
  ...
  Step 3: Create Auth0 store and components
  You will create these files with beautiful, production-ready code including comprehensive styling, animations, and error handling.
  ```
</Accordion>
...
<Steps>
  <Step title="Create a new project" stepNumber={1}>
    ...
    ```shellscript
    npm create svelte@latest auth0-svelte -- --template skeleton --types typescript
    ```
  ...
  <Step title="Create the Auth0 store" stepNumber={4}>
    ```typescript src/lib/stores/auth.ts expandable lines
  ...
  <Step title="Create Login, Logout and Profile Components" stepNumber={5}>
    ...
    <CodeGroup>
      ```svelte src/lib/components/LoginButton.svelte expandable lines
      <script lang="ts">
      ...
      ```svelte src/lib/components/LogoutButton.svelte expandable lines
      <script lang="ts">
      ...
      ```svelte src/lib/components/Profile.svelte expandable lines
      <script lang="ts">
