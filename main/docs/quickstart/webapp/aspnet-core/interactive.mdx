...
<QuickstartButtons githubLink="https://github.com/auth0-samples/auth0-aspnetcore-mvc-samples/tree/master/Quickstart/Sample" downloadLink="https://auth0.auth0.com/u/login/"/>
