...
<Recipe isSingleColumn>
  <Content>
    ...
    <Section id={sections[1].id} title={sections[1].title} stepNumber="2" isSingleColumn>
      ...
      - `auth0:Domain`: The domain of your Auth0 tenant. You can find this in the Auth0 Dashboard under your application's **Settings **in the Domain field. If you are using a [custom domain](https://auth0.com/docs/customize/custom-domains), set this to the value of your custom domain instead.
