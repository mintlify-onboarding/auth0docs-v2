...
---
<Tooltip tip="Brute-force Protection: Form of attack protection that safeguards against brute-force attacks that occur from a single IP address and target a single user account." cta="View Glossary" href="/glossary?term=Brute-force+protection">Brute-force protection</Tooltip> safeguards your tenant against attackers who use a single IP address to target a single user account. By default, Brute-force protection is enabled when you create an Auth0 tenant.
...
Auth0 applies brute-force protection for a given [user identifier](/authenticate/database-connections/flexible-identifiers-and-attributes#attribute-and-identifier-definitions) after that user consecutively fails to authenticate a number of times equal to your configured **Brute Force Threshold**.
...
By default, email notifications contain a link that allows the user to unblock their account. To learn more, read [Customize Blocked Account Emails](/customize/email/customize-blocked-account-emails).
...
To learn more, read [Avoid Common Issues with Resource Owner Password Flow and Attack Protection](/get-started/authentication-and-authorization-flow/resource-owner-password-flow/avoid-common-issues-with-resource-owner-password-flow-and-attack-protection).
...
* [Flexible Identifiers and Attributes](/authenticate/database-connections/flexible-identifiers-and-attributes)
* [Activate and Configure Attributes for Flexible Identifiers](/authenticate/database-connections/activate-and-configure-attributes-for-flexible-identifiers)
