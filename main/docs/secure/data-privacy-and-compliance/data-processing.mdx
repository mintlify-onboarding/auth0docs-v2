...
When an end user's account is deleted, their user profile, included metadata, is removed. To learn more, read [Auth0 General Data Protection Regulation Compliance: Right to access, correct, and erase data](/secure/data-privacy-and-compliance/gdpr).