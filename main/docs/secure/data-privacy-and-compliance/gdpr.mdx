---
description: Describes how Auth0 complies with the EU's General Data Protection
  Regulation (GDPR).
...
The Auth0 user profile information is stored in Auth0 when you use a database connection. If a user logs in using any other type of connection (including custom database connections), Auth0 stores information provided by the external <Tooltip tip="Identity Provider (IdP): Service that stores and manages digital identities." cta="View Glossary" href="/glossary?term=identity+provider">identity provider</Tooltip> for future queries.
...
With Auth0, you can access, edit, and delete user information, either manually or using our API. To learn more, read [GDPR: Right to Access, Correct, and Erase Data](/secure/data-privacy-and-compliance/gdpr/gdpr-right-to-access-correct-and-erase-data).
...
There are several Auth0 features than can help you achieve these goals, like account linking, user profile encryption, and more. To learn more, read [GDPR: Data Minimization](/secure/data-privacy-and-compliance/gdpr/gdpr-data-minimization).
...
You can export user data, stored in the Auth0 user store, either manually or programmatically. Raw data from Auth0 can be exported in JSON format (which is machine-readable). To learn more, read [GDPR: Data Portability](/secure/data-privacy-and-compliance/gdpr/gdpr-data-portability).
...
There are several Auth0 features than can help you meet this requirement, like user profile encryption, <Tooltip tip="Breached Password Detection: Form of attack protection in which Auth0 notifies your users if they use a username/password combination that has been compromised in a data leak on a third-party website or app." cta="View Glossary" href="/glossary?term=brute-force+protection">brute-force protection</Tooltip>, <Tooltip tip="Brute-force Protection: Form of attack protection that safeguards against brute-force attacks that occur from a single IP address and target a single user account." cta="View Glossary" href="/glossary?term=breached+password+detection">breached password detection</Tooltip>, step-up authentication, and more. To learn more, read [GDPR: Protect and Secure User Data](/secure/data-privacy-and-compliance/gdpr/gdpr-protect-and-secure-user-data).
...
* [GDPR: Data Portability](/secure/data-privacy-and-compliance/gdpr/gdpr-data-portability)
