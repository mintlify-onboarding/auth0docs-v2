...
export const codeExample2 = `var client = new RestClient("https://{yourDomain}/api/v2/guardian/post-ticket");
...
export const codeExample4 = `HttpResponse<String> response = Unirest.post("https://{yourDomain}/api/v2/guardian/post-ticket")
  .header("authorization", "Bearer {yourMgmtApiAccessToken}")
  .header("content-type", "application/json")
  .body("{ \n \"user_id\": \"string\",\n \"email\": \"user@exampleco.com\",\n \"send_email\": \"true\",\n \"email_locale\": \"string\",\n \"factor\": \"oob\",\n \"allow_multiple_enrollments\": \"true\"\n }")
  .asString();`;
