...
<td>Set to the Client ID of your application (find it at <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Application Settings</AuthLink>).</td>
</tr>
<tr>
<td><code>redirect_uri</code></td>
<td>Set to a URL in your application that Auth0 should redirect back to after authentication (find it at <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Application Settings</AuthLink>).</td>
</tr>
<tr>
