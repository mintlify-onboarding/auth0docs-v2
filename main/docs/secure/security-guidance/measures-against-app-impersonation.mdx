...
<Frame>![Measures Against App Impersonation - Confirmation Prompt](/media/articles/universal-login/text-customization/consent-pompt-uris.png)</Frame>
...
<Frame>! [Auth0 Dashboard>Settings>Advanced>SkipCustomURIScheme](/media/articles/universal-login/text-customization/custom-uri-override.png) </Frame>
...
<Frame>![Auth0 Dashboard>Tenant Settings>Advanced>Skip Custom URI toggle](/media/articles/universal-login/text-customization/skip-custom-uri.png)</Frame>