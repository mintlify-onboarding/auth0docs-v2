...
When your tenant or <Tooltip tip="Management API: A product to allow customers to perform administrative tasks." cta="View Glossary" href="/glossary?term=Management+API">Management API</Tooltip> receives a request, Tenant ACL processes that request and then determines how to respond based on the rules you have configured.
...
You can toggle monitoring mode for a rule by updating the `action` object. To learn more, read [Configure Rules](/secure/tenant-access-control-list/configure-rules).
...
* [Configure Rules](/secure/tenant-access-control-list/configure-rules)
* [Use Cases](/secure/tenant-access-control-list/use-cases)
* [Reference](/secure/tenant-access-control-list/reference)