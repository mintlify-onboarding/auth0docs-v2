...
Remember to update `` `{yourClientSecret}` `` with the <Tooltip tip="Client Secret: Secret used by a client (application) to authenticate with the Authorization Server; it should be known to only the client and the Authorization Server and must be sufficiently random to not be guessable." cta="View Glossary" href="/docs/glossary?term=client+secret">client secret</Tooltip> in the <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Settings tab of your Application</AuthLink>.
...
<td>This is the value of the <strong>Client ID</strong> field of the Machine-to-Machine Application you created. You can find it on the <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Settings tab of your Application</AuthLink>.</td>
</tr>
<tr>
<td><strong>client_secret</strong></td>
<td>This is the value of the <strong>Client Secret</strong> field of the Machine-to-Machine Application you created. You can find it at the <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Settings tab of your Application</AuthLink>.</td>
</tr>
<tr>
