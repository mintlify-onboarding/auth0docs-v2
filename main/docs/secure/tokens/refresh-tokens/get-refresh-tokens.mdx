...
export const codeExample3 = `var client = new RestClient("https://{yourDomain}/oauth/token");
...
export const codeExample5 = `HttpResponse<String> response = Unirest.post("https://{yourDomain}/oauth/token")
  .header("content-type", "application/x-www-form-urlencoded")
