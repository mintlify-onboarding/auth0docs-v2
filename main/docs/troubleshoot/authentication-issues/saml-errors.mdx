...
5. Enable at least one application (if you don't see any in the list, you will need to [create an application](/get-started/applications) before proceeding).

## IdP-Initiated Default App Not Configured

### Cause

This error appears if you haven't provided the necessary information to support <Tooltip tip="Identity Provider (IdP): Service that stores and manages digital identities." cta="View Glossary" href="/glossary?term=IdP">IdP</Tooltip>-initiated login flows.
