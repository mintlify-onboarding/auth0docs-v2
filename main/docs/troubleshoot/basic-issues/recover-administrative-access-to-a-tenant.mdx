...
If you still cannot gain access to the tenant, create a support request with Auth0. Our support team will verify tenant ownership and grant access. To learn more, read [Open and Manage Support Tickets](/troubleshoot/customer-support/open-and-manage-support-tickets).
