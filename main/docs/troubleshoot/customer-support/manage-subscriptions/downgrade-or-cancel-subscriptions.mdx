...
If you downgrade or cancel your Auth0 subscription, you may be eligible for a credit on your next billing cycle or a refund. To learn more, read our [Billing Policy](/troubleshoot/customer-support/operational-policies/billing-policy).

## Enterprise plans

If you are subscribed to an Enterprise plan, contact your Technical Account Manager (TAM) and then [open a ticket with Auth0 Support](/troubleshoot/customer-support/open-and-manage-support-tickets).
