...
For Private Cloud customers, please see [Private Cloud Load Testing Policy](/deploy-monitor/deploy-private-cloud/private-cloud-on-aws#load-testing).
...
[Open a new ticket](/troubleshoot/customer-support/open-and-manage-support-tickets), select **Product Support** from the **What can we help you with?** dropdown field, and then provide all the information described below.
...
* Whether you are using a <Tooltip tip="Custom Domain: Third-party domain with a specialized, or vanity, name." cta="View Glossary" href="/glossary?term=custom+domain">custom domain</Tooltip>
...
* [Auth0 Professional Services](/get-started/professional-services)