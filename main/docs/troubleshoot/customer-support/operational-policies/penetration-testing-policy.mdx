...
* Request per second (the test must be conformant with the [Rate Limit Policy](/troubleshoot/customer-support/operational-policies/rate-limit-policy))
...
* The test requests per second must not exceed rates defined in our [Rate Limit Policy](/troubleshoot/customer-support/operational-policies/rate-limit-policy)
...
* You may not conduct any [load testing](/troubleshoot/customer-support/operational-policies/load-testing-policy) (such as Denial of Service testing) per the load testing policy.
...
* [Load Testing Policy](/troubleshoot/customer-support/operational-policies/load-testing-policy)