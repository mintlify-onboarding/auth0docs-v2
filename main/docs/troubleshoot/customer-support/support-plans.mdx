...
[Auth0 Enterprise and Premier Support](/troubleshoot/customer-support/auth0-enterprise-and-premier-support) are no longer offered to new customers or customers that have transitioned to a Premier Success Plan.

## Learn more

* [Support Channels](/troubleshoot/customer-support/support-channels)
* [Responsible Disclosure Program Security Support Tickets](/troubleshoot/customer-support/responsible-disclosure-program-security-support-tickets)