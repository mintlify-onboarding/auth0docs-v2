...
<Frame!>[Auth0 Dashboard > Tenant Settings > Advanced > Skip Custom URI toggle](/media/articles/universal-login/text-customization/migrate-uri-setting.png)></Frame>
...
<Frame!>[Auth0 Dashboard > Tenant Settings > Advanced > Skip Custom URI toggle](main/docs/media/articles/universal-login/text-customization/custom-uri-override.png)</Frame>
...
<Frame!>[Auth0 Dashboard > Tenant Settings > Advanced](/media/articles/universal-login/text-customization/migrate-uri-setting.png)</Frame>
...
For additional information and guidance on configuring your applications, read [Measures Against Application Impersonation](main/docs/secure/security-guidance/measures-against-application-impersonation).