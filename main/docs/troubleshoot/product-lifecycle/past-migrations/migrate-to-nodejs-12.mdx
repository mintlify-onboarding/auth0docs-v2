...
1. Go to <AuthLink href="https://manage.auth0.com/#/applications/{yourClientId}/settings">Dashboard > Applications > Applications > Settings</AuthLink>, and add the URL to the fields **Allowed Callback URLs** and **Allowed Logout URLs**.
