...
<td>The Auth0 default token profile generates an access token formatted as a <a href="/secure/tokens/json-web-tokens">JSON Web Token (JWT)</a>. In the <code>scope</code> claim of the access token, includes an intersection of the requested permissions and the permissions assigned to the user. No <code>permissions</code> claim is passed. To learn more, read <a href="/secure/tokens/access-tokens/access-token-profiles">Access Token Profiles</a>.</td>
</tr>
<tr>
