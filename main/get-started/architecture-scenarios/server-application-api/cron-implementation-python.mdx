---
description: The Python implementation of the server cron job for the Server
...
---
As part of the [Server + API Architecture Scenario](/get-started/architecture-scenarios/server-application-api), we will explain how to implement the server process in Python. Please refer to the [Server + API Architecture Scenario](/get-started/architecture-scenarios/server-application-api) document for information on the implemented solution.
