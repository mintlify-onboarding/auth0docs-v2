...
* **login**: calls `authorize` from auth0.js which initiates <Tooltip tip="Universal Login: Your application redirects to Universal Login, hosted on Auth0's Authorization Server, to verify a user's identity." cta="View Glossary" href="/glossary?term=Universal+Login">Universal Login</Tooltip>
* **handleAuthentication**: looks for an authentication result in the URL hash and processes it with the `parseHash` method from auth0.js
* **setSession**: sets the user's <Tooltip tip="Access Token: Authorization credential, in the form of an opaque string or JWT, used to access an API." cta="View Glossary" href="/glossary?term=Access+Token">Access Token</Tooltip>, <Tooltip tip="Access Token: Authorization credential, in the form of an opaque string or JWT, used to access an API." cta="View Glossary" href="/glossary?term=ID+Token">ID Token</Tooltip>, and a time at which the Access Token will expire
...
<div class="loading">
  <Frame><img src="/assets/loading.svg" alt="loading"></Frame>
</div>
```
...
<div class="panel panel-default profile-area">
  ...
  <div class="panel-body">
    <Frame><img src="/{{profile?.picture}}" class="avatar" alt="avatar"></Frame>
    <div>
...
The [angular2-jwt](https://github.com/auth0/angular2-jwt) module can be used to automatically attach <Tooltip tip="JSON Web Token (JWT): Standard ID Token format (and often Access Token format) used to represent claims securely between two parties." cta="View Glossary" href="/glossary?term=JSON+Web+Tokens">JSON Web Tokens</Tooltip> to requests made to your API. It does this by providing an `AuthHttp` class which is a wrapper over Angular's `Http` class.
