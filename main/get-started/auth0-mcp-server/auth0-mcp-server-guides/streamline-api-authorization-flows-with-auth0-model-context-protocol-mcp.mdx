...
After your APIs are defined, you'll need to implement custom authorization logic. With Auth0 MCP Server, you can describe your business rules in natural language and Claude will generate the appropriate Auth0 [Actions](/customize/actions) code.
