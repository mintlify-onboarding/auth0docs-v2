...
---
You can add login to your regular web application using the Authorization Code Flow. To learn how the flow works and why you should use it, read [Authorization Code Flow](/get-started/authentication-and-authorization-flow/authorization-code-flow). To call your API from a regular web app, read [Call Your API Using the Authorization Code Flow](/get-started/authentication-and-authorization-flow/authorization-code-flow/call-your-api-using-the-authorization-code-flow).
...
Following a successful login, your application will have access to the user's <Tooltip tip="ID Token: Credential meant for the client itself, rather than for accessing a resource." cta="View Glossary" href="/glossary?term=ID+token">ID token</Tooltip> and <Tooltip tip="ID Token: Credential meant for the client itself, rather than for accessing a resource." cta="View Glossary" href="/glossary?term=access+token">access token</Tooltip>. The ID token contains basic user profile information, and the access token can be used to call the Auth0 `/userinfo` endpoint or your own protected APIs. To learn more about ID tokens, read [ID Tokens](/secure/tokens/id-tokens). To learn more about access tokens, read [Access Tokens](/secure/tokens/access-tokens).
...
Register your app with Auth0. To learn more, read [Register Regular Web Applications](/get-started/auth0-overview/create-applications/regular-web-apps).
...
* [Register Regular Web Applications](/get-started/auth0-overview/create-applications/regular-web-apps)
