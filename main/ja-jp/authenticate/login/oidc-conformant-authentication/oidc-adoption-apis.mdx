...
* [マシンツーマシン（M2M）](/ja-jp/get-started/authentication-and-authorization-flow/client-credentials-flow)統合のシナリオ：アプリケーションは、（ユーザーの代理としてではなく）自身として認証し、プログラムで安全にアクセストークンを取得できます。
