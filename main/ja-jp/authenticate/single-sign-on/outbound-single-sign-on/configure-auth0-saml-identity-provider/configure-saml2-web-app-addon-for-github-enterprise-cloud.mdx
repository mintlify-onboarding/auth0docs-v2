...
* Auth0をGitHub Enterprise Server（プライベートインスタンス）のIDプロバイダーとして構成する方法については、「[Auth0をGitHub Enterprise ServerのIDプロバイダーとして構成する](/ja-jp/authenticate/single-sign-on/outbound-single-sign-on/configure-auth0-saml-identity-provider/configure-saml2-web-app-addon-for-github-enterprise-server)」をお読みください。
