...
認可拡張機能のバージョン1と2にある主だった変更は、 **［Applications（アプリケーション）］** セクションが削除されたことです。このセクションは、アクセス制御のポリシー定義で使用されていた場合など、内在的な複雑性を簡素化させるために削除されました。そのようなユースケースには、[ルール](/ja-jp/customize/rules)の使用が推奨されます。
