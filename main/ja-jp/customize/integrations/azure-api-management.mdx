...
Azure API Management Serviceによって管理されるAPIを表すために、Auth0でAPIを作成する必要があります。詳細については、「[APIを登録する](/ja-jp/get-started/auth0-overview/set-up-apis)」お読みください。
...
すでにユーザーセットがある場合は、ユーザーをインポートするか、[カスタムデータベース接続](/ja-jp/connections/database/mysql)を作成することができます。
