...
ルールのグローバル変数は<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" href="/ja-jp/glossary?term=auth0-dashboard" tip="Auth0 Dashboard: サービスを構成するためのAuth0の主製品。" cta="用語集の表示">Auth0 Dashboard</Tooltip>を用いて構成できます。詳細については、「[Auth0ルール](/ja-jp/customize/rules)」をご覧ください。
...
* [ルールを作成する](/ja-jp/customize/rules/create-rules)