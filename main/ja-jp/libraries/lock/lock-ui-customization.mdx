...
アプリケーション用のLockをカスタマイズする際に、より詳細な情報が必要な場合は、[構成オプション](/ja-jp/libraries/lock/lock-configuration)ページまたは[Lock API](/ja-jp/libraries/lock/lock-api-reference)ページをご覧ください。
