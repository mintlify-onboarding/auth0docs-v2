...
<td>スコープ`delete:organization_connections`を持つ<a href="/ja-jp/tokens/management-api-access-tokens">Management APIのアクセストークン</a>。</td>
</tr>
<tr>
<td>`CONNECTION_ID`</td>
