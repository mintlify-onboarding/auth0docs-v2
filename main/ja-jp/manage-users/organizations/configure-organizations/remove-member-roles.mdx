...
<td>`delete:organization_member_roles`のスコープを持つ<a href="/ja-jp/tokens/management-api-access-tokens">Management APIのアクセストークン</a>。</td>
</tr>
<tr>
<td>`USER_ID`</td>
