...
---
Auth0.Android is a client-side library you can use with your Android app to authenticate users and access [Auth0 APIs](/api).
...
Create a new `Auth0` object using your Auth0 <Tooltip tip="Client ID: Identification value given to your registered resource from Auth0." cta="View Glossary" href="/glossary?term=client+ID">client ID</Tooltip> and domain value. Objects will later use this when interacting with Auth0's endpoints.
...
[Log users in and out of your application](/libraries/auth0-android/auth0-android-login-logout-and-user-profiles) using the `WebAuthProvider` class.
...
* [Auth0.Android Configuration Options](/libraries/auth0-android/auth0-android-configuration)
* [Auth0.Android Database Authentication](/auth0-android-database-authentication)
* [Auth0.Android Passwordless Authentication](/auth0-android-passwordless)
* [Auth0.Android Save and Renew Tokens](/auth0-android-save-and-renew-tokens)
