...
See the [Auth0.Android configuration](/libraries/auth0-android/auth0-android-configuration) for more options for the `WebAuthProvider` class.
...
* The <Tooltip tip="Access Token: Authorization credential, in the form of an opaque string or JWT, used to access an API." cta="View Glossary" href="/glossary?term=access+token">access token</Tooltip> as received during the login phase
