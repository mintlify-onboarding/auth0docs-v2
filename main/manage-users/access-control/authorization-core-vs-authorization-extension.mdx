...
Auth0 currently provides two ways of implementing [role-based access control (RBAC)](/manage-users/access-control/rbac): our Core implementation and our Authorization Extension. Our Core implementation improves performance and scalability.
...
| --- | --- | --- |
| Enhanced performance and scalability | Yes - Read [Entity Limit Policy](/troubleshoot/customer-support/operational-policies/entity-limit-policy) | No - Limited to 500KB of data (1000 groups, 3000 users, where each user is a member of 3 groups; or 20 groups, 7000 users, where each user is a member of 3 groups) |
...
* [Authorization Policies](/manage-users/access-control/authorization-policies)
