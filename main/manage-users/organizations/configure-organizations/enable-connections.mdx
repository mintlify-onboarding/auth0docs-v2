...
---
You can enable specific connections for each [organization](/manage-users/organizations/organizations-overview) to provide users with different login options. After you enable a connection, it is added to the organization login prompt, and users can authenticate through that connection to access your applications.

To enable a connection for an organization, the connection **must** already exist in your tenant. Supported connections include [database connections](/authenticate/database-connections), [social connections](/authenticate/identity-providers/social-identity-providers), and [enterprise connections](/authenticate/identity-providers/enterprise-identity-providers).
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        They can also authenticate with this connection if you are using the <a href="/authenticate/login/auth0-universal-login/identifier-first">Identifier First with Home Realm Discovery</a> authentication profile in combination with the <a href="/manage-users/organizations/login-flows-for-organizations#configure-the-login-flow-for-your-application">Prompt for Credentials</a> organization login flow. <br/><br/>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/secure/tokens/access-tokens/management-api-access-tokens">Access Token for the Management API</a> with the scope <code>create:organization_connections</code>.</td>
    </tr>
    <tr>
