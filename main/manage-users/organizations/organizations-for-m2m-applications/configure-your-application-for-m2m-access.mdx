...
2. In cases where the application should only access specific organizations i.e. not all of them, [Authorize M2M Access](/manage-users/organizations/organizations-for-m2m-applications/authorize-m2m-access) for each API you need to access for those specific organizations.
