...
[Actions](/customize/actions) are secure, tenant-specific, versioned functions written in Node.js that execute at certain points within the Auth0 platform. Actions are used to customize and extend Auth0's capabilities with custom logic. They can also be used to [enrich the user profile](/customize/actions/explore-triggers/signup-and-login-triggers/login-trigger).
