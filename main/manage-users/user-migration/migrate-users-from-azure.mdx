...
---
Auth0 supports importing users from Azure using the [Azure AD ROPC flow](https://docs.microsoft.com/en-us/azure/active-directory/develop/v2-oauth-ropc) in Auth0’s [Custom DB login scripts](/authenticate/database-connections/custom-db/templates/login).
