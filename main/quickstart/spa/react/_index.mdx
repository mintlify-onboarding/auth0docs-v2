    ...
    * Have a working React project that you want to integrate with. Alternatively, you can view or download a sample application after logging in.
    ...
    <Section id={sections[1].id} title={sections[1].title} stepNumber="2" isSingleColumn>
      ...
      - `domain`: The domain of your Auth0 tenant. Generally, you can find this in the Auth0 Dashboard
                under your Application's Settings in the Domain field. If you are using a [custom domain](/customize/custom-domains), you should set this to the
    ...
    <Section id={sections[4].id} title={sections[4].title} stepNumber="5" isSingleColumn>
      Now that your users can log in and log out, you will likely want to be able to retrieve the [profile information](/manage-users/user-accounts/user-profiles)
