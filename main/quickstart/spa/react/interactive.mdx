...
<QuickstartButtons githubLink="https://github.com/auth0-samples/auth0-react-samples/tree/master/Sample-01" downloadLink="https://auth0.auth0.com/u/login/identifier?state=hKFo2SA3Q1YzWTBuS1JKemhzdkhCcWxGWXlkaXdfOUFJSGE1baFur3VuaXZlcnNhbC1sb2dpbqN0aWTZIG5scU45Q3BXOTRTd2tfV0wwcThQdF85OTdIa1hfclFOo2NpZNkgU0IzME9XMVMxVmxyWmdqWVdxWkc2NEFRNU5qRm8xd20"/>
    ...
    * Have a working React project that you want to integrate with. Alternatively, you can view or download a sample application after logging in.
    ...
    <Section id={sections[1].id} title={sections[1].title} stepNumber="2">
      ...
      - `domain`: The domain of your Auth0 tenant. Generally, you can find this in the Auth0 Dashboard
                under your Application's Settings in the Domain field. If you are using a [custom domain](/custom-domains), you should set this to the
    ...
    <Section id={sections[4].id} title={sections[4].title} stepNumber="5">
      Now that your users can log in and log out, you will likely want to be able to retrieve the [profile information](/users/concepts/overview-user-profile)
