  ...
  <Content>
    ...
    * Have a working project that you want to integrate with. Alternatively, you can view or download a sample application after logging in.
    ...
    <Section id={sections[5].id} title={sections[5].title} stepNumber="6" isSingleColumn>
      Users who log in to your project will also need [a way to log out](/authenticate/login/logout/log-users-out-of-auth0). The Auth0 client provides a `logout()` method that you can use
