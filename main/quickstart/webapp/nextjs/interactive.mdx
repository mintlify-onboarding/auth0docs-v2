...
<QuickstartButtons githubLink="https://github.com/auth0-samples/auth0-nextjs-samples/tree/main/Sample-01" downloadLink="https://auth0.auth0.com/u/login/"/>
...
<Recipe>
  <Content>
    ...
    <Section id={sections[2].id} title={sections[2].title} stepNumber="3">
      ...
      - `AUTH0_DOMAIN`: The URL of your Auth0 tenant domain. If you are using a [Custom Domain with Auth0](/customize/custom-domains), set this to the value of your Custom Domain instead of the value reflected in the "Settings" tab.
