...
---
Auth0 Continuous Session Protection empowers developers to enhance security and tailor the user experience through customizable session and <Tooltip tip="Refresh Token: Token used to obtain a renewed Access Token without forcing users to log in again." cta="View Glossary" href="/glossary?term=refresh+token">refresh token</Tooltip> management.

Using Continuous Session Protection, developers can leverage [Auth0 Actions](/customize/actions) to safeguard user sessions and refresh tokens by utilizing detailed session information such as IP addresses, expiration dates, device details, and more.
...
<tbody>
<tr>
<td><a href="/secure/tokens/refresh-tokens/manage-refresh-tokens-actions">Refresh Tokens with Actions</a></td>
<td>How to manage refresh tokens with Actions</td>
</tr>
<tr>
<td><a href="/manage-users/sessions/manage-sessions-actions">Sessions with Actions</a></td>
