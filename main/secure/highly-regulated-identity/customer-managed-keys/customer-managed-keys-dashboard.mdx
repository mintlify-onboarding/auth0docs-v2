...
Using Bring Your Own Key, users with the  [Key Management Editor role](/get-started/manage-dashboard-access/add-dashboard-users) can use the <Tooltip tip="Auth0 Dashboard: Auth0's main product to configure your services." cta="View Glossary" href="/glossary?term=Auth0+Dashboard">Auth0 Dashboard</Tooltip> to replace the default Auth0 Environment Root Key with their own Customer provided Root Key.
