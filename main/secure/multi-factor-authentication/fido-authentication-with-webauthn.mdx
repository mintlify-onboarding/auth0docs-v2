...
To learn how to enable roaming authenticators in Auth0, check the [WebAuthn with Security Keys](/secure/multi-factor-authentication/fido-authentication-with-webauthn/configure-webauthn-security-keys-for-mfa) documentation.
...
To learn how to enable platform authenticators, check the [Webauthn with Device Biometrics](/secure/multi-factor-authentication/fido-authentication-with-webauthn/configure-webauthn-device-biometrics-for-mfa) documentation.
...
* Users authenticate with username/password.
* They enroll another <Tooltip tip="Multi-factor authentication (MFA): User authentication process that uses a factor in addition to username and password such as a code via SMS." cta="View Glossary" href="/glossary?term=MFA">MFA</Tooltip> authentication method, like [SMS](/secure/multi-factor-authentication/multi-factor-authentication-factors/configure-sms-voice-notifications-mfa), [Push](/secure/multi-factor-authentication/multi-factor-authentication-factors/configure-push-notifications-for-mfa) or [Time-Based OTP](/secure/multi-factor-authentication/multi-factor-authentication-factors/configure-otp-notifications-for-mfa).
