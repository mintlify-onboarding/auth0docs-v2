...
Auth0 has [attack protection features](/secure/attack-protection) that can shield against certain types of attacks.
...
One way to verify the requests that are being sent is to utilize the <Tooltip tip="OAuth 2.0: Authorization framework that defines authorization protocols and workflows." cta="View Glossary" href="/glossary?term=OAuth+2.0">OAuth 2.0</Tooltip> protocol [state parameter](/secure/attack-protection/state-parameters) to authenticate the response.
