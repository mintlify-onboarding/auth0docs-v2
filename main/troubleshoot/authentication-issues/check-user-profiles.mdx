...
2. Generate and check the [HAR file](/troubleshoot/troubleshooting-tools/generate-and-analyze-har-files), look for an `id_token`.
...
7. Check if you specified the correct [scope](/get-started/apis/scopes) to get an Access Token.
