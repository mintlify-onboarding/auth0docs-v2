...
\*These limits are constrained to 48 hours per month. After 48 hours, these limits revert to product limits. For more information, see [Public Performance Burst](/troubleshoot/customer-support/operational-policies/rate-limit-policy#public-performance).
