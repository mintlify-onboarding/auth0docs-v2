...
Keeping in mind how a sample endpoint "bucket" is configured, let's look at Auth0 <Tooltip tip="Management API: A product to allow customers to perform administrative tasks." cta="View Glossary" href="/glossary?term=Management+API">Management API</Tooltip> burst limits by subscription type:
